 ...
 * @link https://secure.php.net/manual/en/function.mysql-pconnect.php
 * @param string $server [optional] <p>
 * The MySQL server. It can also include a port number. e.g. 
 * "hostname:port" or a path to a local socket e.g. ":/path/to/socket" for 
 * the localhost.
 ...
 * @link https://secure.php.net/manual/en/function.mysql-close.php
 ...
 * @link https://secure.php.net/manual/en/function.mysql-select-db.php
 ...
 * @deprecated 5.5
 * Send a MySQL query
 * @link https://secure.php.net/manual/en/function.mysql-query.php
 ...
 * @link https://secure.php.net/manual/en/function.mysql-unbuffered-query.php
 * @param string $query <p>
 ...
 * @link https://secure.php.net/manual/en/function.mysql-db-query.php
 ...
 * @link https://secure.php.net/manual/en/function.mysql-list-dbs.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-list-tables.php
 * @param string $database <p>
 ...
 * @link https://secure.php.net/manual/en/function.mysql-list-fields.php
 * @param string $database_name <p>
 ...
 * @link https://secure.php.net/manual/en/function.mysql-list-processes.php
 * @param resource $link_identifier [optional] 
 * @return resource A result pointer resource on success or false on failure.
 * @since 4.3.0
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.mysql-error.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-errno.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-affected-rows.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-insert-id.php
 * @param resource $link_identifier [optional] 
 ...
 * @deprecated 5.5
 * Get result data
 * @link https://secure.php.net/manual/en/function.mysql-result.php
 ...
 * @link https://secure.php.net/manual/en/function.mysql-num-rows.php
 ...
 * @link https://secure.php.net/manual/en/function.mysql-num-fields.php
 * @param resource $result 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-fetch-row.php
 * @param resource $result 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-fetch-array.php
 * @param resource $result 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-fetch-assoc.php
 * @param resource $result 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-fetch-object.php
 * @param resource $result 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-data-seek.php
 * @param resource $result 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-fetch-lengths.php
 * @param resource $result 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-fetch-field.php
 * @param resource $result 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-field-seek.php
 * @param resource $result 
 ...
 * @deprecated 5.5
 * Free result memory
 * @link https://secure.php.net/manual/en/function.mysql-free-result.php
 * @param resource $result 
 * @return bool true on success or false on failure.
 * </p>
 * <p>
 ...
 * @link https://secure.php.net/manual/en/function.mysql-field-name.php
 * @param resource $result 
 * @param int $field_offset 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-field-table.php
 * @param resource $result 
 * @param int $field_offset 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-field-len.php
 * @param resource $result 
 * @param int $field_offset 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-field-type.php
 * @param resource $result 
 * @param int $field_offset 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-field-flags.php
 * @param resource $result 
 * @param int $field_offset 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-escape-string.php
 ...
 * @link https://secure.php.net/manual/en/function.mysql-real-escape-string.php
 * @param string $unescaped_string <p>
 * The string that is to be escaped.
 * </p>
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-stat.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-thread-id.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-client-encoding.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-ping.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-get-client-info.php
 ...
 * @deprecated 5.5
 * Get MySQL host info
 * @link https://secure.php.net/manual/en/function.mysql-get-host-info.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-get-proto-info.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-get-server-info.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-info.php
 * @param resource $link_identifier [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.mysql-set-charset.php
 ...
 * @link https://secure.php.net/manual/en/function.mysql-db-name.php
 ...
 * @link https://secure.php.net/manual/en/function.mysql-tablename.php
 * @param resource $result <p>
 ...
 * index.
 * @link https://secure.php.net/manual/en/mysql.constants.php
 * @deprecated 5.5
 */
