 ...
 * @link https://secure.php.net/manual/en/function.getlastmod.php
 ...
 * @link https://secure.php.net/manual/en/function.base64-decode.php
 * @param string $data <p>
 * The encoded data.
 * </p>
...
/**
 * Uuencode a string
 * @link https://secure.php.net/manual/en/function.convert-uuencode.php
 * @param string $data <p>
 ...
 * @link https://secure.php.net/manual/en/function.convert-uudecode.php
 * @param string $data <p>
 * The uuencoded data.
 * </p>
...
/**
 * Absolute value
 * @link https://secure.php.net/manual/en/function.abs.php
...
/**
 * Round fractions up
 * @link https://secure.php.net/manual/en/function.ceil.php
 * @param float $value <p>
 * The value to round
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.floor.php
 * @param float $value <p>
...
/**
 * Sine
 * @link https://secure.php.net/manual/en/function.sin.php
 * @param float $arg <p>
 * A value in radians
 * </p>
...
/**
 * Cosine
 * @link https://secure.php.net/manual/en/function.cos.php
 * @param float $arg <p>
 * An angle in radians 
 * </p>
...
/**
 * Tangent
 * @link https://secure.php.net/manual/en/function.tan.php
 * @param float $arg <p>
...
/**
 * Arc sine
 * @link https://secure.php.net/manual/en/function.asin.php
 * @param float $arg <p>
...
/**
 * Arc cosine
 * @link https://secure.php.net/manual/en/function.acos.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Arc tangent
 * @link https://secure.php.net/manual/en/function.atan.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.atanh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.atan2.php
 * @param float $y <p>
 * Dividend parameter
 * </p>
 * @param float $x <p>
...
/**
 * Hyperbolic sine
 * @link https://secure.php.net/manual/en/function.sinh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Hyperbolic cosine
 * @link https://secure.php.net/manual/en/function.cosh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Hyperbolic tangent
 * @link https://secure.php.net/manual/en/function.tanh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.asinh.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.acosh.php
 * @param float $arg <p>
 ...
 * @link https://secure.php.net/manual/en/function.expm1.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.log1p.php
...
/**
 * Get value of pi
 * @link https://secure.php.net/manual/en/function.pi.php
 ...
 * @link https://secure.php.net/manual/en/function.is-finite.php
 * @param float $val <p>
 * The value to check
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-nan.php
 * @param float $val <p>
 * The value to check
 * </p>
...
/**
 * Integer division
 * @link https://secure.php.net/manual/en/function.intdiv.php
 ...
 * @link https://secure.php.net/manual/en/function.is-infinite.php
 * @param float $val <p>
 * The value to check
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.pow.php
 ...
 * @link https://secure.php.net/manual/en/function.exp.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Natural logarithm
 * @link https://secure.php.net/manual/en/function.log.php
 * @param float $arg <p>
...
/**
 * Base-10 logarithm
 * @link https://secure.php.net/manual/en/function.log10.php
 * @param float $arg <p>
 * The argument to process
 * </p>
...
/**
 * Square root
 * @link https://secure.php.net/manual/en/function.sqrt.php
 * @param float $arg <p>
 * The argument to process
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.hypot.php
 * @param float $x <p>
 ...
 * @link https://secure.php.net/manual/en/function.deg2rad.php
 * @param float $number <p>
 ...
 * @link https://secure.php.net/manual/en/function.rad2deg.php
 * @param float $number <p>
 * A radian value
 * </p>
...
/**
 * Binary to decimal
 * @link https://secure.php.net/manual/en/function.bindec.php
 ...
 * @link https://secure.php.net/manual/en/function.hexdec.php
...
/**
 * Octal to decimal
 * @link https://secure.php.net/manual/en/function.octdec.php
...
/**
 * Decimal to binary
 * @link https://secure.php.net/manual/en/function.decbin.php
 * @param int $number <p>
...
/**
 * Decimal to octal
 * @link https://secure.php.net/manual/en/function.decoct.php
 * @param int $number <p>
 * Decimal value to convert
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.dechex.php
 * @param int $number <p>
 * Decimal value to convert
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.base-convert.php
 ...
 * @link https://secure.php.net/manual/en/function.number-format.php
 * @param float $number <p>
 ...
 * @since 5.0
  of the arguments
 * @link https://secure.php.net/manual/en/function.fmod.php
 * @param float $x <p>
 * The dividend
 * </p>
 * @param float $y <p>
 ...
 * @link https://secure.php.net/manual/en/function.inet-ntop.php
 ...
 * @link https://secure.php.net/manual/en/function.inet-pton.php
 ...
 * @link https://secure.php.net/manual/en/function.ip2long.php
 ...
 * @link https://secure.php.net/manual/en/function.long2ip.php
 ...
 * @link https://secure.php.net/manual/en/function.getenv.php
 ...
 * @link https://secure.php.net/manual/en/function.putenv.php
 ...
 * @link https://secure.php.net/manual/en/function.getopt.php
 ...
 * @link https://secure.php.net/manual/en/function.sys-getloadavg.php
 ...
 * @link https://secure.php.net/manual/en/function.microtime.php
...
/**
 * Get current time
 * @link https://secure.php.net/manual/en/function.gettimeofday.php
 ...
 * @link https://secure.php.net/manual/en/function.getrusage.php
 ...
 * @link https://secure.php.net/manual/en/function.uniqid.php
 ...
 * @link https://secure.php.net/manual/en/function.quoted-printable-decode.php
 * @param string $str <p>
 * The input string.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.quoted-printable-encode.php
 * @param string $str <p>
 * The input string.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.convert-cyr-string.php
 * @param string $str <p>
 ...
 * @link https://secure.php.net/manual/en/function.get-current-user.php
 ...
 * @link https://secure.php.net/manual/en/function.set-time-limit.php
 * @param int $seconds <p>
 ...
 * @link https://secure.php.net/manual/en/function.get-cfg-var.php
 ...
 * @link https://secure.php.net/manual/en/function.magic-quotes-runtime.php
 * @deprecated 5.3.0
 * @param $new_setting
 * @since 4.0
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.set-magic-quotes-runtime.php
 * @deprecated 5.3.0
 ...
 * @link https://secure.php.net/manual/en/function.get-magic-quotes-gpc.php
 ...
 * @link https://secure.php.net/manual/en/function.get-magic-quotes-runtime.php
 ...
 * @link https://secure.php.net/manual/en/function.import-request-variables.php
