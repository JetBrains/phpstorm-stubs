<?php
/**
 * PHPStorm stub file for Original MySQL API(MySql) functions.
 *
 * @link       http://php.net/manual/en/book.mysql.php
 *
 * @deprecated 5.5.0 Entire extension is deprecated in favor of mysqli.
 */
 ...
 *
 * @param resource $result <p>The result resource that is being evaluated. This result comes from a call to
 *                         mysql_query().</p>
 *
