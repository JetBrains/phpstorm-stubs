...
class Memcached
{
     ...
     *                           The key identifying the server to store the value on or retrieve it from. Instead of
     *                           hashing on the actual key for the item, we hash on the server key when deciding which
     *                           memcached server to talk to. This allows related items to be grouped together on a
     *                           single server for efficiency with multi operations.
     *                           </p>
     * @param string $key        <p>
     *                           The key under which to store the value.
     *                           </p>
     ...
     *
     * @param string $server_key    <p>
     *                              The key identifying the server to store the value on or retrieve it from. Instead
     *                              of hashing on the actual key for the item, we hash on the server key when deciding
     *                              which memcached server to talk to. This allows related items to be grouped together
     *                              on a single server for efficiency with multi operations.
     *                              </p>
     * @param string $key           <p>
     *                              The key of the item to decrement.
     *                              </p>
     ...
     * @param string   $server_key <p>
     *                             The key identifying the server to store the value on or retrieve it from. Instead of
     *                             hashing on the actual key for the item, we hash on the server key when deciding
     *                             which memcached server to talk to. This allows related items to be grouped together
     *                             on a single server for efficiency with multi operations.
     *                             </p>
     * @param string   $key        <p>
