<?php
/**
 * PHPStorm stub file for OPcache functions.
 *
 * @link http://php.net/manual/en/book.opcache.php
 */
 ...
 * @param bool   $force  [optional] <p> If set to <b>TRUE</b>, the script will be invalidated regardless of whether
 *                       invalidation is necessary.</p>
 *
 * @return boolean
 * Returns <b>TRUE</b> if the opcode cache for <em>script</em> was
 * invalidated or if there was nothing to invalidate, or <b>FALSE</b> if the opcode
 ...
 * @return boolean Returns <b>TRUE</b> if the opcode cache was reset, or <b>FALSE</b> if the opcode cache is
 *                 disabled.
 */
