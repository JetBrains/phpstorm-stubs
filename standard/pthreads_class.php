<?php
/**
 * PHPStorm stub file for pthreads classes.
 *
...
class Mutex
{
     ...
     *
     * @param boolean $lock [optional] <p>Setting lock to true will lock the Mutex for the caller before returning the
     *                      handle</p>
     *
 ...
 */
class Stackable extends Threaded
{
}
...
class Thread extends Threaded
{
     ...
     *
     * @param integer $options [optional] An optional mask of inheritance constants, by default
     *                         <b>PTHREADS_INHERIT_ALL</b>
     *
     * @return boolean <p>A boolean indication of success</p>
     */
