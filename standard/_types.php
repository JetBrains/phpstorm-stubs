...
namespace {
    ...
    /**
     * Creates an array.
     * @link https://secure.php.net/manual/en/function.array.php
     ...
     * @link https://secure.php.net/manual/en/function.list.php
     ...
     * @link https://secure.php.net/manual/en/function.die.php
     ...
     * @link https://secure.php.net/manual/en/function.exit.php
     * @param int|string $status [optional] <p>
     * If status is a string, this function prints the status just before exiting.
     * </p>
     * <p>
     ...
     * @link https://secure.php.net/manual/en/function.empty.php
     ...
     * @link https://secure.php.net/manual/en/function.isset.php
     ...
     * @link https://secure.php.net/manual/en/function.unset.php
     ...
     * @link https://secure.php.net/manual/en/function.eval.php
     * @param string $code <p>
    ...
    final class Generator implements Iterator {
         ...
         * @link https://secure.php.net/manual/en/generator.wakeup.php
         * @return void
         */
...
class object {
   ...
   *
   * param [ mixed $args [, $... ]]
   * @link https://secure.php.net/manual/en/language.oop5.decon.php
   */
   ...
   * @return mixed
   * @link https://secure.php.net/manual/en/language.oop5.overloading.php#language.oop5.overloading.methods
   */
   ...
   * @param $name string
   * @return mixed
   * @link https://secure.php.net/manual/en/language.oop5.overloading.php#language.oop5.overloading.members
   */
   ...
   *
   * @return string[]
   * @link https://secure.php.net/manual/en/language.oop5.magic.php#language.oop5.magic.sleep
   */
   ...
   *
   * @return string
   * @link https://secure.php.net/manual/en/language.oop5.magic.php#language.oop5.magic.tostring
   */
   ...
   *
   * @return mixed
   * @link https://secure.php.net/manual/en/language.oop5.magic.php#language.oop5.magic.invoke
   */
  public function __invoke() {}
     ...
     *
     * @return array
     * @link https://secure.php.net/manual/en/language.oop5.magic.php#language.oop5.magic.debuginfo
     */
   ...
   * @return mixed
   * @link https://secure.php.net/manual/en/language.oop5.magic.php#language.oop5.magic.set-state
   */
   ...
   *
   * @return mixed
   * @link https://secure.php.net/manual/en/language.oop5.cloning.php
   */
