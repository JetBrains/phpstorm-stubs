<?php
/**
 * PHPStorm stub file for Image Processing (ImageMagick) classes.
 *
 * @link http://php.net/manual/en/book.imagick.php
 */
...
class Imagick implements Iterator, Traversable, Countable
{
     ...
     *                       Provide any channel constant that is valid for your channel mode. To apply to more than
     *                       one channel, combine channel constants using bitwise operators. Defaults to
     *                       <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     *                       </p>
     *
     * @return bool <b>TRUE</b> on success.
     */
     ...
     *
     * @param float $radius  <p>
     *                       The radius of the Gaussian, in pixels, not counting the center pixel. Use 0 for
     *                       auto-select.
     *                       </p>
     * @param float $sigma   <p>
     *                       The standard deviation of the Gaussian, in pixels.
     ...
     *                       </p>
     * @param float $fuzz    <p>
     *                       The amount of fuzz. For example, set fuzz to 10 and the color red at intensities of 100
     ...
     *
     * @param int $channel <p>
     *                     Provide any channel constant that is valid for your channel mode. To apply to more than one
     *                     channel, combine channel constants using bitwise operators. Defaults to
     *                     <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     *                     </p>
     *
     ...
     *                           </p>
     * @param int     $channel   [optional] <p>
     *                           Provide any channel constant that is valid for your channel mode. To apply to more
     *                           than one channel, combine channel constants using bitwise operators. Defaults to
     *                           <b>Imagick::CHANNEL_DEFAULT</b>. Refer to this list of channel constants
     *                           </p>
     *
     ...
     *                           </p>
     * @param bool   $only_names [optional] <p>
     *                           Whether to return only property names. If <b>FALSE</b> then also the values are
     *                           returned
     *                           </p>
     *
     ...
     *                        The value can be any combination or order of R = red, G = green, B = blue, A = alpha (0
     *                        is transparent), O = opacity (0 is opaque), C = cyan, Y = yellow, M = magenta, K = black,
     ...
     *                      </p>
     * @param float $fuzz   <p>
     *                      The amount of fuzz. For example, set fuzz to 10 and the color red at intensities of 100 and
...
class ImagickDraw
{
     ...
     *
     * @param array $coordinates <p>
     *                           multidimensional array like array( array( 'x' => 3, 'y' => 4 ), array( 'x' => 2, 'y'
     *                           => 6 ) );
     *                           </p>
     *
     * @return bool <b>TRUE</b> on success.
     ...
     *
     * @param array $coordinates <p>
     *                           array of x and y coordinates: array( array( 'x' => 4, 'y' => 6 ), array( 'x' => 8, 'y'
     *                           => 10 ) )
     *                           </p>
     *
     * @return bool <b>TRUE</b> on success.
    ...
    /**
     * (PECL imagick 2.0.0)<br/>
     * Indicates that subsequent commands up to a ImagickDraw::opPattern() command comprise the definition of a named
     * pattern
     *
