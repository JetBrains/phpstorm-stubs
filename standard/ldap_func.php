<?php
/**
 * PHPStorm stub file for Lightweight Directory Access Protocol(LDAP) functions.
 *
 * @link http://php.net/manual/en/book.ldap.php
 */
 ...
 *                                  the format described in the LDAP documentation (see the Netscape Directory SDK
