<?php
/**
 * PHPStorm stub file for Standard PHP Library(SPL) functions.
 *
 * @link http://php.net/manual/en/ref.spl.php
 */
 ...
 * @param bool  $autoload Whether to allow this function to load the class automatically through the __autoload()
 *                        magic method.
 *
 ...
 *                                    </p>
 * @param bool     $throw             This parameter specifies whether spl_autoload_register() should throw
 *                                    exceptions when the autoload_function cannot be registered.
 * @param bool     $prepend           If true, spl_autoload_register() will prepend the autoloader on the autoload
