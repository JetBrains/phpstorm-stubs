<?php
/**
 * PHPStorm stub file for Libevent functions.
 *
 * @link http://php.net/manual/en/book.libevent.php
 ...
 *
 * <p>Returns new event base, which can be used later in {@link event_base_set}(), {@link event_base_loop}() and
 * other functions.</p>
 *
 ...
 *    <tr>
 *        <td><b>$events</b></td>
 *        <td>A flag indicating the event. Consists of the following flags: EV_TIMEOUT, EV_SIGNAL, EV_READ,
 *        EV_WRITE and EV_PERSIST.</td>
 *    </tr>
 *    <tr>
 *        <td><b>$arg</b></td>
 ...
 *                               The additional flag EV_PERSIST makes the event to persist until {@link
