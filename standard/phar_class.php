<?php
/**
 * PHPStorm stub file for Phar classes.
 *
 * @link http://php.net/manual/en/book.phar.php
 */
...
class Phar extends RecursiveDirectoryIterator implements Countable, ArrayAccess
{
     ...
     *                            </p>
     *                            <p>
     *                            If you are using fast-cgi or cgi then the parameter passed to the function is the
     *                            value of the
     *                            $_SERVER['PATH_INFO'] variable. Otherwise, the parameter passed to the function is
     *                            the value of the $_SERVER['REQUEST_URI'] variable.
     *                            </p>
     *                            <p>
     *                            If a string is returned it is used as the internal file path. If <b>FALSE</b> is
