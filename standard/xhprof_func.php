<?php
/**
 * PHPStorm stub file for Hierarchical Profiler functions.
 *
 ...
 *                       profiling.</p>
 * @param array $options <p>An array of optional options, namely, the 'ignored_functions' option to pass in
 *                       functions to be ignored during profiling.</p>
 *
 * @return null
 */
...
/**
 * (PHP &gt;= 5.2.0, PECL xhprof &gt;= 0.9.0)<br/>
 * Starts profiling in sample mode, which is a lighter weight version of {@see xhprof_enable()}. The sampling
 * interval is 0.1 seconds, and samples record the full function call stack. The main use case is when lower
 * overhead is required when doing performance monitoring and diagnostics.
 *
