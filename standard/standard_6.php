 ...
 * @link https://secure.php.net/manual/en/function.stream-select.php
 * @param array $read <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-context-create.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-context-set-params.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-context-get-params.php
 * @param resource $stream_or_context <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-context-set-option.php
 * @param resource $stream_or_context <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-context-get-options.php
 * @param resource $stream_or_context <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-context-get-default.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-context-set-default.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-filter-remove.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-client.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-server.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-accept.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-get-name.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-recvfrom.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-sendto.php
 * @param resource $socket <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-enable-crypto.php
 * @param resource $stream <p>
 * The stream resource.
 * </p>
 * @param bool $enable <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-shutdown.php
 * @param resource $stream <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-socket-pair.php
 * @param int $domain <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-copy-to-stream.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-supports-lock.php
 * @param resource $stream <p>
 * The stream to check.
 * </p>
 * @return bool true on success or false on failure.
 ...
 * @link https://secure.php.net/manual/en/function.fgetcsv.php
 * @param resource $handle <p>
 ...
 * @link https://secure.php.net/manual/en/function.fputcsv.php
 ...
 * @link https://secure.php.net/manual/en/function.get-meta-tags.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-set-write-buffer.php
 * @param resource $stream <p>
 * The file pointer.
 * </p>
 * @param int $buffer <p>
...
/**
 * Sets file buffering on the given stream
 * @link https://secure.php.net/manual/en/function.stream-set-read-buffer.php
 * @param resource $stream <p>
 * The file pointer.
 * </p>
 * @param int $buffer <p>
 ...
 * @link https://secure.php.net/manual/en/function.set-file-buffer.php
 ...
 * @link https://secure.php.net/manual/en/function.set-socket-blocking.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-set-blocking.php
 * @param resource $stream <p>
 * The stream.
 * </p>
 * @param int $mode <p>
...
/**
 * &Alias; <function>stream_set_blocking</function>
 * @link https://secure.php.net/manual/en/function.socket-set-blocking.php
 * @param resource $socket <p>
 * The stream.
 * </p>
 * @param int $mode <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-get-line.php
 * @param resource $handle <p>
 * A valid file handle.
 * </p>
 * @param int $length <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-wrapper-register.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-register-wrapper.php
 * @param string $protocol <p>
 * The wrapper name to be registered.
 * </p>
 * @param string $classname <p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-resolve-include-path.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-wrapper-unregister.php
 * @param string $protocol <p>
 * </p>
 * @return bool true on success or false on failure.
 * @since 5.1.0
 ...
 * @link https://secure.php.net/manual/en/function.stream-wrapper-restore.php
 * @param string $protocol <p>
 * </p>
 * @return bool true on success or false on failure.
 * @since 5.1.0
 ...
 * @link https://secure.php.net/manual/en/function.stream-get-transports.php
 ...
 * @link https://secure.php.net/manual/en/function.stream-is-local.php
 ...
 * @link https://secure.php.net/manual/en/function.get-headers.php
 * @param string $url <p>
 * The target URL.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.stream-set-timeout.php
 * @param resource $stream <p>
 * The target stream.
 * </p>
 * @param int $seconds <p>
 ...
 * @link https://secure.php.net/manual/en/function.socket-set-timeout.php
 * @param resource $stream <p>
 * The target stream.
 * </p>
 * @param int $seconds <p>
 ...
 * Retrieves header/meta data from streams/file pointers
 * @link https://secure.php.net/manual/en/function.socket-get-status.php
 * @param resource $stream <p>
 * The stream can be any stream created by fopen,
 * fsockopen and pfsockopen.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.fnmatch.php
