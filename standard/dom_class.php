<?php
/**
 * PHPStorm stub file for DOM classes.
 *
...
class DOMDocument extends DOMNode
{
     ...
     *                        </p>
     *
     * @return bool true on success or false on failure. If called statically, returns a DOMDocument and issues
     *              E_STRICT warning.
     * @since 5.0
     */
     ...
     *                       </p>
     * @param int    $flags  [optional] <p>A bitmask of Libxml schema validation flags. Currently the only supported
     *                       value is <b>LIBXML_SCHEMA_CREATE</b>. Available since PHP 5.5.2 and Libxml 2.6.14.</p>
     *
     * @return bool true on success or false on failure.
     * @since 5.0
     */
...
class DOMDocumentType extends DOMNode
{
     ...
     * @var DOMNamedNodeMap
     * @since 5.0
     * A <classname>DOMNamedNodeMap</classname> containing the general entities, both external and internal, declared
     * in the DTD.
     ...
     * @var string
     * @since 5.0
     * The internal subset as a string, or null if there is none. This is does not contain the delimiting square
     * brackets.
...
class DOMElement extends DOMNode
{
     ...
     *
     * @param $name  string The tag name of the element. When also passing in namespaceURI, the element name may take a
     *               prefix to be associated with the URI.
 ...
 * @property-read $length The number of nodes in the map. The range of valid child node indices is 0 to length - 1
 *                inclusive.
 */
...
class DOMNode
{
     ...
     * @var DOMNamedNodeMap
     * @since 5.0
     * A <classname>DOMNamedNodeMap</classname> containing the attributes of this node (if it is a
     * <classname>DOMElement</classname>) or NULL otherwise.
     ...
     * @var DOMNodeList
     * @since 5.0
     * A <classname>DOMNodeList</classname> that contains all children of this node. If there are no children, this is
     * an empty <classname>DOMNodeList</classname>.
     ...
     *
     * @param bool  $exclusive     [optional] Enable exclusive parsing of only the nodes matched by the provided xpath
     ...
     * @param $exclusive     [optional] Enable exclusive parsing of only the nodes matched by the provided xpath or
     *                       namespace prefixes.
...
class DOMText extends DOMCharacterData
{
    /**
     * @since 5.0
     * Holds all the text of logically-adjacent (not separated by Element, Comment or Processing Instruction) Text
     * nodes.
...
class DOMXPath
{
     ...
     *
     * @param DOMDocument $doc The <classname>DOMDocument</classname> associated with the
