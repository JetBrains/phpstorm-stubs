<?php
/**
 * PHPStorm stub file for SVN functions.
 *
 ...
 *                          Path of item to add.
 *                          </p>
 *                          Relative paths will be resolved as if the current working directory was the one that
 *                          contains the PHP binary. To use the calling script&#x00027;s working directory, use
 *                          <b>realpath</b> or dirname(__FILE__).
...
/**
 * TODO: write actual short description for svn_config_ensure().
 */
function svn_config_ensure() { }

/**
 * TODO: write actual short description for svn_copy().
 */
function svn_copy() { }
 ...
 *                      Relative paths will be resolved as if the current working directory was the one that
 *                      contains the PHP binary. To use the calling script&#x00027;s working directory, use
 *                      <b>realpath</b> or dirname(__FILE__). If a local file path has only backslashes and no
 *                      forward slashes, this extension will fail to find the path. Always replace all backslashes
...
/**
 * TODO: write actual short description for svn_info().
 */
function svn_info() { }

/**
 * TODO: write actual short description for svn_lock().
 */
function svn_lock() { }
...
/**
 * TODO: write actual short description for svn_resolved().
 */
...
/**
 * TODO: write actual short description for svn_switch().
 */
function svn_switch() { }

/**
 * TODO: write actual short description for svn_unlock().
 */
function svn_unlock() { }
