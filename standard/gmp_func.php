<?php
/**
 * PHPStorm stub file for GNU Multiple Precision(GMP) functions.
 *
 ...
 *
 * @param mixed $seed <p>
 *                    The seed to be set for the {@see gmp_random()}, {@see gmp_random_bits()}, and {@see
 *                    gmp_random_range()} functions.
 *                    </p>
 *                    Either a GMP number resource in PHP 5.5 and earlier, a GMP object in PHP 5.6 and later, or a
 *                    numeric string provided that it is possible to convert the latter to a number.
 *
 ...
 *                     and later, or a numeric string provided that it is possible to convert the latter to a
 *                     number.</p>
