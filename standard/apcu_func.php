<?php
/**
 * PHPStorm stub file for APCu functions.
 *
 ...
 * </p>
 *
 * <p>Note: When control enters <i>apcu_entry()</i> the lock for the cache is acquired exclusively, it is released
 * when control leaves apcu_entry(): In effect, this turns the body of generator into a critical section,
 * disallowing two processes from executing the same code paths concurrently. In addition, it prohibits the
 * concurrent execution of any other APCu functions, since they will acquire the same lock.
 * </p>
 *
 ...
 *                            next request). If no ttl is supplied (or if the ttl is 0), the value will persist
 *                            until it is removed from the cache manually, or otherwise fails to exist in the cache
 *                            (clear, restart, etc.).
 *
