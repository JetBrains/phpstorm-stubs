<?php
/**
 * PHPStorm stub file for IBM DB2, Cloudscape and Apache Derby functions.
 *
 ...
 *                             </p>
 *
 * @return int|bool When db2_autocommit receives only the
 ...
 *                                 </p>
 * @param string|null $qualifier   [optional] <p>
 ...
 *                                 or an empty string.
 *                                 </p>
 * @param string|null $table_name  [optional] The name of the table or view. To match all tables in the database, pass
 *                                 NULL or an empty string.
 * @param string|null $column_name [optional] The name of the column. To match all columns in the table, pass NULL or
 *                                 an empty string.
 *
 ...
 *                                 containing _ and % as wildcards.
 *                                 </p>
 * @param string      $table_type  [optional]
 *
 * @return resource a statement resource with a result set containing rows describing
 ...
 *
 * @param resource $stmt [optional] <p>
...
/**
 * @link http://php.net/manual/en/function.db2-last-insert-id.php
