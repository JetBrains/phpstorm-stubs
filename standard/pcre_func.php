<?php
/**
 * PHPStorm stub file for Regular Expressions (Perl-Compatible) functions.
 *
 * @link http://php.net/manual/en/book.pcre.php
 */
 ...
 * @param int   $count [optional]
 *
 * @return array|NUll  <p>preg_replace_callback_array() returns an array if the subject parameter is an array, or a
 *                     string otherwise. On errors the return value is NULL</p>
