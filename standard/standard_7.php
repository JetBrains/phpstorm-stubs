 ...
 * @link https://secure.php.net/manual/en/function.fsockopen.php
 ...
 * @link https://secure.php.net/manual/en/function.pfsockopen.php
 * @see fsockopen
 ...
 * @link https://secure.php.net/manual/en/function.pack.php
 ...
 * @link https://secure.php.net/manual/en/function.unpack.php
 * @param string $format <p>
 ...
 * @link https://secure.php.net/manual/en/function.crypt.php
 * @param string $str <p>
 ...
 * @link https://secure.php.net/manual/en/function.opendir.php
 * @param string $path <p>
 ...
 * @link https://secure.php.net/manual/en/function.closedir.php
...
/**
 * Change directory
 * @link https://secure.php.net/manual/en/function.chdir.php
 ...
 * @link https://secure.php.net/manual/en/function.chroot.php
 * @param string $directory <p>
 * The new directory
 * </p>
 * @return bool true on success or false on failure.
 ...
 * @link https://secure.php.net/manual/en/function.getcwd.php
 ...
 * @link https://secure.php.net/manual/en/function.rewinddir.php
 * @param resource $dir_handle [optional] <p>
 * The directory handle resource previously opened
 * with opendir. If the directory handle is 
 * not specified, the last link opened by opendir 
 ...
 * @link https://secure.php.net/manual/en/function.readdir.php
 * @param resource $dir_handle [optional] <p>
 * The directory handle resource previously opened
 * with opendir. If the directory handle is 
 * not specified, the last link opened by opendir 
 ...
 * @link https://secure.php.net/manual/en/function.dir.php
 * @param string $directory <p>
 * Directory to open
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.scandir.php
 * @param string $directory <p>
 ...
 * @link https://secure.php.net/manual/en/function.glob.php
 ...
 * @link https://secure.php.net/manual/en/function.fileatime.php
 ...
 * @link https://secure.php.net/manual/en/function.filectime.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
...
/**
 * Gets file group
 * @link https://secure.php.net/manual/en/function.filegroup.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
...
/**
 * Gets file inode
 * @link https://secure.php.net/manual/en/function.fileinode.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.filemtime.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
...
/**
 * Gets file owner
 * @link https://secure.php.net/manual/en/function.fileowner.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
...
/**
 * Gets file size
 * @link https://secure.php.net/manual/en/function.filesize.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
...
/**
 * Gets file type
 * @link https://secure.php.net/manual/en/function.filetype.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.file-exists.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.is-writable.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.is-writeable.php
 * @param string $filename <p>
 * The filename being checked.
 * </p>
 * @return bool true if the filename exists and is
 ...
 * @link https://secure.php.net/manual/en/function.is-readable.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @return bool true if the file or directory specified by
 ...
 * @link https://secure.php.net/manual/en/function.is-executable.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-file.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-dir.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.is-link.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.lstat.php
 * @see stat
 * @param string $filename <p>
...
/**
 * Changes file owner
 * @link https://secure.php.net/manual/en/function.chown.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @param mixed $user <p>
...
/**
 * Changes file group
 * @link https://secure.php.net/manual/en/function.chgrp.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @param mixed $group <p>
 ...
 * @link https://secure.php.net/manual/en/function.lchown.php
 * @param string $filename <p>
 * Path to the file.
 * </p>
 * @param mixed $user <p>
 ...
 * @link https://secure.php.net/manual/en/function.lchgrp.php
 * @param string $filename <p>
 * Path to the symlink.
 * </p>
 * @param mixed $group <p>
 ...
 * @link https://secure.php.net/manual/en/function.touch.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.clearstatcache.php
 ...
 * @link https://secure.php.net/manual/en/function.disk-total-space.php
 * @param string $directory <p>
 ...
 * @link https://secure.php.net/manual/en/function.disk-free-space.php
 * @param string $directory <p>
 * A directory of the filesystem or disk partition.
 * </p>
 * <p>
 ...
 * @link https://secure.php.net/manual/en/function.diskfreespace.php
 * @see disk_free_space
 * @param $directory
 * @since 4.0
 * @since 5.0
...
/**
 * Send mail
 * @link https://secure.php.net/manual/en/function.mail.php
 * @param string $to <p>
 ...
 * @link https://secure.php.net/manual/en/function.ezmlm-hash.php
 * @param string $addr <p>
 ...
 * @link https://secure.php.net/manual/en/function.openlog.php
