<?php
/**
 * PHPStorm stub file for PostgreSQL functions.
 *
 ...
 *                              </p>
 *
 * @return mixed <b>TRUE</b> on success or <b>FALSE</b> on failure. Returns string if <b>PGSQL_DML_STRING</b> is
 *               passed via <i>options</i>.
 * @since 4.3.0
 * @since 5.0
 */
 ...
 *                              </p>
 * @param string   $table_name  <p>
 *                              Name of the table into which to insert rows. The table <i>table_name</i> must at
 *                              least have as many columns as <i>assoc_array</i> has elements.
 *                              </p>
 * @param array    $assoc_array <p>
 *                              An array whose keys are field names in the table <i>table_name</i>,
 ...
 *                             </p>
 * @param string   $query      <p>
 *                             The SQL statement or statements to be executed. When multiple statements are passed
 *                             to the function, they are automatically executed as one transaction, unless there
 *                             are explicit BEGIN/COMMIT commands included in the query string. However, using
...
/**
 * Submits a command to the server and waits for the result, with the ability to pass parameters separately from
 ...
 *                            </p>
 *
 * @return string A string containing the contents of the error field, <b>NULL</b> if the field does not exist or
 *                <b>FALSE</b> on failure.
 * @since 5.1.0
 */
 ...
 *                             </p>
 *                             <p>
 *                             The exact list of available encodings depends on your PostgreSQL version, so check
 *                             your PostgreSQL manual for a more specific list.
 *                             </p>
 *
