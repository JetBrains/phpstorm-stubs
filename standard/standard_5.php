 ...
 * @link https://secure.php.net/manual/en/function.floatval.php
 ...
 * @link https://secure.php.net/manual/en/function.doubleval.php
 * @param mixed $var May be any scalar type. should not be used on objects, as doing so will emit an E_NOTICE level error and return 1.
 * @return float value of the given variable. Empty arrays return 0, non-empty arrays return 1.
 */
 ...
 * @link https://secure.php.net/manual/en/function.strval.php
 * @param mixed $var <p>
 ...
 * @link https://secure.php.net/manual/en/function.gettype.php
 * @param mixed $var <p>
 ...
 * @link https://secure.php.net/manual/en/function.settype.php
 * @param mixed $var <p>
 ...
 * @link https://secure.php.net/manual/en/function.is-null.php
 * @param mixed $var <p>
 ...
 * @link https://secure.php.net/manual/en/function.is-resource.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-bool.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-long.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-float.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-int.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 * @return bool true if var is an integer, 
...
/**
 * &Alias; <function>is_int</function>
 * @link https://secure.php.net/manual/en/function.is-integer.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 * @return bool true if var is an integer,
 ...
 * @link https://secure.php.net/manual/en/function.is-double.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 * @return bool true if var is a float,
...
/**
 * &Alias; <function>is_float</function>
 * @link https://secure.php.net/manual/en/function.is-real.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 * @return bool true if var is a float,
 ...
 * @link https://secure.php.net/manual/en/function.is-numeric.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-string.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-array.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-object.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-scalar.php
 * @param mixed $var <p>
 * The variable being evaluated.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.is-callable.php
 ...
 * @link https://secure.php.net/manual/en/function.pclose.php
 ...
 * @link https://secure.php.net/manual/en/function.popen.php
...
/**
 * Outputs a file
 * @link https://secure.php.net/manual/en/function.readfile.php
 ...
 * @link https://secure.php.net/manual/en/function.rewind.php
 * @param resource $handle <p>
...
/**
 * Removes directory
 * @link https://secure.php.net/manual/en/function.rmdir.php
 ...
 * @link https://secure.php.net/manual/en/function.umask.php
 ...
 * @link https://secure.php.net/manual/en/function.fclose.php
 * @param resource $handle <p>
 ...
 * @link https://secure.php.net/manual/en/function.feof.php
 ...
 * @link https://secure.php.net/manual/en/function.fgetc.php
 * @param resource $handle The file pointer must be valid, and must point to a file successfully opened by fopen() or fsockopen() (and not yet closed by fclose()).
 ...
 * @link https://secure.php.net/manual/en/function.fgets.php
 * @param resource $handle The file pointer must be valid, and must point to a file successfully opened by fopen() or fsockopen() (and not yet closed by fclose()).
 ...
 * @link https://secure.php.net/manual/en/function.fgetss.php
 * @param resource $handle The file pointer must be valid, and must point to a file successfully opened by fopen() or fsockopen() (and not yet closed by fclose()).
 * @param int $length [optional] <p>
...
/**
 * Opens file or URL
 * @link https://secure.php.net/manual/en/function.fopen.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.fpassthru.php
 * @param resource $handle The file pointer must be valid, and must point to a file successfully opened by fopen() or fsockopen() (and not yet closed by fclose()).
 ...
 * @link https://secure.php.net/manual/en/function.ftruncate.php
 * @param resource $handle <p>
 * The file pointer.
 * </p>
 * <p>
 ...
 * @link https://secure.php.net/manual/en/function.fstat.php
 * @param resource $handle &fs.file.pointer;
 ...
 * @link https://secure.php.net/manual/en/function.ftell.php
 * @param resource $handle <p>
 * The file pointer must be valid, and must point to a file successfully
 ...
 * @link https://secure.php.net/manual/en/function.fflush.php
 * @param resource $handle The file pointer must be valid, and must point to a file successfully opened by fopen() or fsockopen() (and not yet closed by fclose()).
 * @return bool true on success or false on failure.
 * @since 4.0.1
 * @since 5.0
 ...
 * @see fwrite()
 * @link https://secure.php.net/manual/en/function.fputs.php
 * Binary-safe file write
 ...
 * @link https://secure.php.net/manual/en/function.mkdir.php
 ...
 * @link https://secure.php.net/manual/en/function.rename.php
...
/**
 * Copies file
 * @link https://secure.php.net/manual/en/function.copy.php
 ...
 * @link https://secure.php.net/manual/en/function.tempnam.php
 * @param string $dir <p>
 ...
 * @link https://secure.php.net/manual/en/function.tmpfile.php
 ...
 * @link https://secure.php.net/manual/en/function.file-put-contents.php
 * @param string $filename <p>
