<?php
/**
 * PHPStorm stub file for Date/Time classes.
 *
...
class DateTime implements DateTimeInterface
{
     ...
     *
     * @return DateInterval|boolean The DateInterval object representing the difference between the two dates or FALSE
     *                              on failure.
     ...
     *
     * @param string $modify A date/time string. Valid formats are explained in <a
     *                       href="http://www.php.net/manual/en/datetime.formats.php">Date and Time Formats</a>.
     *
...
class DateTimeImmutable implements DateTimeInterface
{
     ...
     *                               <p>A date/time string. Valid formats are explained in {@link
     *                               www.php.net/manual/en/datetime.formats.php Date and Time Formats}.</p>
     *                               <p>
     ...
     *                               A {@link http://www.php.net/manual/en/class.datetimezone.php DateTimeZone} object
     *                               representing the timezone of <em>$time</em>.
     *                               </p>
     *                               <p>
     ...
     * Returns a new instance of a {@link http://www.php.net/manual/en/class.datetimeimmutable.php DateTimeImmutable}
     * object.
     */
     ...
     *
     * @param DateTime $dateTime The mutable DateTime object that you want to convert to an immutable version. This
     *                           object is not modified, but instead a new DateTimeImmutable object is created
     ...
     *
     * @return static
     * Returns the {@link http://www.php.net/manual/en/class.datetimeimmutable.php DateTimeImmutable} object for method
     * chaining or <b>FALSE</b> on failure.
     */
    public function modify($modify) { }
