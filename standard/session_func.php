<?php
/**
 * PHPStorm stub file for Session Handling functions.
 *
 ...
 *                              Cache-Control: public, max-age=(sometime in the future, according to
 *                              session.cache_expire) Last-Modified: (the timestamp of when the session was last
 *                              saved)
 *                              </pre>
 *                              </td>
 *                              </tr>
 ...
 *                              pre-check=(session.cache_expire in the future) Last-Modified: (the timestamp of
 ...
 *                                                   such as SessionHandler, to register as the session handler.
 * @param bool                    $register_shutdown [optional] Register session_write_close() as a
 ...
 *
 * @param array $options [optional] <p>If provided, this is an associative array of options that will override the
 *                       currently set session configuration directives. The keys should not include the session.
 *                       prefix. In addition to the normal set of configuration directives, a read_and_close option
 *                       may also be provided. If set to TRUE, this will result in the session being closed
