 ...
 * @link https://secure.php.net/manual/en/function.halt-compiler.php
 * @return void
 */
 ...
 *
 * @link https://secure.php.net/manual/en/function.hex2bin.php
 ...
 * @link https://secure.php.net/manual/en/install.fpm.php
 * @since 5.3.3
 */
