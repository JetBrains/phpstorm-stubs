<?php
/**
 * PHPStorm stub file for Redis classes.
 *
 ...
 * @todo Determine if author of extension or just stub?
 * @link   https://github.com/ukko/phpredis-phpdoc
 *
...
class Redis
{
     ...
     *
     * @return  string  If a prefix is set up, the value now prefixed.  If there is no prefix, the value will be
     *                  returned unchanged.
     * @example
     * <pre>
     ...
     * @param   string $key       for `SET`, glob-pattern for `GET`. See http://redis.io/commands/config-get for
     *                            examples.
     ...
     * </pre>
     */
    public function evalSha($scriptSha, array $args = [], $numKeys = 0) { }
     ...
     * @param int    $numKeys
     */
    public function evaluateSha($scriptSha, array $args = [], $numKeys = 0) { }
     ...
     *            a Redis::PIPELINE block is simply transmitted faster to the server, but without any guarantee of
     *            atomicity. discard cancels a transaction.
     *
