<?php
/**
 * PHPStorm stub file for cURL functions.
 *
 ...
 * the descriptor sets. On failure, this function will return -1 on a select failure or timeout (from the
 ...
 *
 * @param resource $ch
 *                          <p>A cURL handle returned by {@link http://www.php.net/manual/en/function.curl-init.php
 *                          curl_init()}.</p>
 ...
 *
 * @param resource $sh <p>
 *                     A cURL share handle returned by  {@link
 *                     http://www.php.net/manual/en/function.curl-share-init.php curl_share_init()}
 *                     </p>
 *
 * @return void
 * @since 5.5.0
