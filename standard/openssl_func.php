<?php
/**
 * PHPStorm stub file for OpenSSL functions.
 *
 * @link http://php.net/manual/en/book.openssl.php
 */
 ...
 * and does this via the optional crypto_strong parameter. It's rare for this to be FALSE, but some systems may be
 * broken or old.
 *
 ...
 *                            previously generated by {@link http://php.net/en/manual/function.openssl-pkey-new.php
 *                            openssl_pkey_new()} (or otherwise obtained from the other openssl_pkey family of
 *                            functions). The corresponding public portion of the key will be used to sign the CSR.
 *                            </p>
