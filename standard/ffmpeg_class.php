<?php
/**
 * PHPStorm stub file for ffmpeg classes.
 */
...
class ffmpeg_animated_gif
{
     ...
     * @param int    $loop_count       - Number of times to loop the animation. Put a zero here to loop forever or omit
     *                                 this parameter to disable looping.
     */
...
class ffmpeg_frame
{
     ...
     * @param int $crop_left   - Remove [cropleft] rows of pixels from the left of the frame.
     * @param int $crop_right  - Remove [cropright] rows of pixels from the right of the frame.
     *                         NOTE: Cropping is always applied to the frame before it is resized. Crop values must be
     *                         even numbers.
     */
...
class ffmpeg_movie
{
     ...
     * @param boolean $persistent    - Whether to open this media as a persistent resource. See the PHP documentation
     *                               for more info about persistent resources
     */
     ...
     *
     * @param int $framenumber - Frame from the movie to return. If no framenumber is specified, returns the next frame
     *                         of the movie.
     *
     * @return ffmpeg_frame
     */
