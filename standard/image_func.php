<?php
/**
 * PHPStorm stub file for Image Processing and GD functions.
 *
 ...
 *                          You can use the iptcparse() function to parse the binary APP13 marker into something
 *                          readable.
 *
 ...
 *                         such as {@link http://www.php.net/manual/en/function.imagecreatetruecolor.php
 *                         imagecreatetruecolor()}.</p>
 ...
 *
 * @param resource $image <p>
 *                        An image resource, returned by one of the image creation functions, such as {@link
 *                        http://www.php.net/manual/en/function.imagecreatetruecolor.php imagecreatetruecolor()}.
 *                        </p>
 ...
 *                            </p>
 *
 * @return array This function returns an array defining the four points of the box, starting in the lower left and
 ...
 *
 * @link  http://php.net/manual/en/function.imagegetclip.php
 *
 * @return array The function returns an indexed array with the coordinates of the clipping rectangle which has the
 *               following entries:
 ...
 *
 * @param resource $image <p>
 *                        An image resource, returnd by one of the image creation functions, such as {@link
 *                        http://www.php.net/manual/en/function.imagecreatetruecolor.php imagecreatetruecolor()}.
 *                        </p>
 *
 * @return bool Returns <b>TRUE</b> if the convertion was complete, or if the source image already is a true color
 *              image, otherwise <b>FALSE</b> is returned.
 * @since 5.5.0
 */
...
/**
 * Set the flag to save full alpha channel information (as opposed to single-color transparency) when saving PNG
 * images
 *
 ...
 * @param int      $mode       [optional] One of <b>IMG_NEAREST_NEIGHBOUR</b>, <b>IMG_BILINEAR_FIXED</b>,
 *                             <b>IMG_BICUBIC</b>, <b>IMG_BICUBIC_FIXED</b> or anything else (will use two pass).
 *
 ...
 *
 * @link  http://php.net/manual/en/function.imagesetclip.php
 *
 ...
 * @param int      $y1    The x-coordinate of the upper left corner.
 ...
 * @since 7.2.0
 */
function imagesetclip($image, $x1, $y1, $x2, $y2) { }
 ...
 *                         (<em>default (also on image creation)</em>).
 *                         </li>
 *                         <li>
 ...
 * @param resource $image   An image resource, returned by one of the image creation functions, such as
 *                          imagecreatetruecolor().
 * @param mixed    $to      The path or an open stream resource (which is automatically being closed after this
 *                          function returns) to save the file to. If not set or NULL, the raw image stream will be
 *                          outputted directly.
 * @param int      $quality The quality ranges from 0 (worst quality, smaller file) to 100 (best quality, biggest
 *                          file).
 *
 * @return bool true on success or false on failure.
 * @since 5.5.0
 * @since 7.0.0
 */
function imagewebp($image, $to, $quality = 80) { }
