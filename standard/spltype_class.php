<?php
/**
 * PHPStorm stub file for SPL Type Handling classes.
 *
 * This is not part of the SPL extension.
 *
 * @link http://php.net/manual/en/book.spl-types.php
 */
...
abstract class SplType
{
     ...
     * @param bool  $strict If set to true then will throw UnexpectedValueException if value of other type will be
