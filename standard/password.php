 ...
 * </p>
 * <p>
 * If omitted, a random salt will be generated by {@link "https://www.php.net/manual/en/function.password-hash.php" password_hash()} for
 ...
 * Examples of these values can be found on the {@link "https://www.php.net/manual/en/function.crypt.php crypt()"} page.
 * </p>
 * <p>
 ...
 * {@link https://www.php.net/manual/en/password.constants.php password algorithm constant}
 * </li>
 * <li>
 ...
 * provided when calling  @link https://www.php.net/manual/en/function.password-hash.php" password_hash()
 * </li>
 * </ul>
 * @since 5.5
 */
 ...
 * @param int|string $algo A <a href="https://www.php.net/manual/en/password.constants.php" class="link">password algorithm constant</a>  denoting the algorithm to use when hashing the password.
 * @param array $options [optional] <p> An associative array containing options. See the <a href="https://www.php.net/manual/en/password.constants.php" class="link">password algorithm constants</a> for documentation on the supported options for each algorithm.
 ...
 * @param string $hash A hash created by password_hash().
 * @param int $algo A <a href="https://www.php.net/manual/en/password.constants.php" class="link">password algorithm constant</a> denoting the algorithm to use when hashing the password.
