<?php
/**
 * PHPStorm stub file for SQLite functions.
 *
 ...
 * @see        http://php.net/manual/en/book.sqlite3.php
 *
 * @param resource $result        <p>The SQLite result resource. This parameter is not required when using the
 *                                object-oriented method.</p>
 ...
 *                                parameter is set to <b>TRUE</b> (the default), PHP will decode the binary
 *                                encoding
 *                                it applied to the data if it was encoded using the
 ...
 * @param resource $result        <p>The SQLite result resource. This parameter is not required when using the
 *                                object-oriented method.</p>
 * @param int      $result_type   [optional] <p>The optional result_type parameter accepts a constant and
 *                                determines how the returned array will be indexed. Using <b>SQLITE_ASSOC</b> will
 *                                return only associative indices (named fields) while <b>SQLITE_NUM</b> will
 *                                return only numerical indices (ordinal field numbers). <b>SQLITE_BOTH</b> will
 *                                return both associative and numerical indices. <b>SQLITE_BOTH</b> is the default
 *                                for this function.</p>
 * @param bool     $decode_binary [optional] <p>When the decode_binary parameter is set to <b>TRUE</b> (the
 *                                default), PHP will decode the binary encoding it applied to the data if it was
 *                                encoded using the sqlite_escape_string(). You should normally leave this value at
 *                                its default, unless you are interoperating with databases created by other sqlite
 ...
 * <p>The column names returned by <b>SQLITE_ASSOC</b> and <b>SQLITE_BOTH</b> will be case-folded according to the
 * value of the
 ...
 *
 * @param resource $dbhandle <p>The SQLite Database resource; returned from
 *                           {@see sqlite_open()} when used procedurally. This parameter is not required when using
 *                           the object-oriented method.</p>
 *
 ...
 *                                     Data inside the query should be properly escaped.
 *                                     </p>
 * @param resource|string $dbhandle    The SQLite Database resource; returned from sqlite_open() when used
