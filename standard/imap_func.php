<?php
/**
 * PHPStorm stub file for IMAP, POP3 and NNTP functions.
 *
 ...
 *                                If this parameter is set, it will set the INTERNALDATE on the appended message.
 *                                The parameter should be a date string that conforms to the rfc2060 specifications
 ...
 *                          <li>FT_INTERNAL - The return string is in internal format, will not canonicalize to
 *                          CRLF.</ul><p>
 *
 ...
 *                          mailboxes; &#x00027;~/mail/&#37;&#x00027; on UW_IMAPD will return every mailbox in the
 *                          ~/mail directory, but none in subfolders of that directory.</p>
 *
 ...
 * @param int      $from_length    [optional] Number of characters for the fetchfrom property. Must be greater than
 *                                 or equal to zero.
 * @param int      $subject_length [optional] Number of characters for the fetchsubject property Must be greater
 ...
 * <dt>to <dd>an array of objects from the To: line, with the following properties: personal, adl, mailbox, and
 * host
 * <dt>fromaddress <dd>full from: line, up to 1024 characters
 * <dt>from <dd>an array of objects from the From: line, with the following properties: personal, adl, mailbox, and
 * host
 * <dt>ccaddress <dd>full cc: line, up to 1024 characters
 * <dt>cc <dd>an array of objects from the Cc: line, with the following properties: personal, adl, mailbox, and
 * host
 * <dt>bccaddress <dd>full bcc: line, up to 1024 characters
 * <dt>bcc <dd>an array of objects from the Bcc: line, with the following properties: personal, adl, mailbox, and
 * host
 * <dt>reply_toaddress <dd>full Reply-To: line, up to 1024 characters
 * <dt>reply_to <dd>an array of objects from the Reply-To: line, with the following properties: personal, adl,
 * mailbox, and host
 * <dt>senderaddress <dd>full sender: line, up to 1024 characters
 * <dt>sender <dd>an array of objects from the Sender: line, with the following properties: personal, adl, mailbox,
 * and host
 * <dt>return_pathaddress <dd>full Return-Path: line, up to 1024 characters
 * <dt>return_path <dd>an array of objects from the Return-Path: line, with the following properties: personal,
 * adl, mailbox, and host
 * <dt>remail -
