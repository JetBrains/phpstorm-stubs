<?php
/**
 * PHPStorm stub file for Date/Time functions.
 *
 * @link http://php.net/manual/en/book.datetime.php
 */
 ...
 *                          <tr valign="top">
 *                          <td>P</td>
 *                          <td>Difference to Greenwich time (GMT) with colon between hours and minutes (added in
 *                          PHP 5.1.3)</td>
 *                          <td>Example: +02:00</td>
 *                          </tr>
 *                          <tr valign="top">
 ...
 *
 * @param string       $format   Format accepted by  <a
 *                               href="http://us.php.net/manual/en/function.date.php">date()</a>.
 *                               <p>If format does not contain the character ! then portions of the generated time
 *                               which are not specified in format will be set to the current system time.
 *                               <p>If format contains the character !, then portions of the generated time not
 *                               provided in format, as well as values to the left-hand side of the !, will be set
 *                               to corresponding values from the Unix epoch.
 ...
 * @param DateTimeZone $timezone [optional] A DateTimeZone object representing the desired time zone.
 *
 * @return DateTimeImmutable|false <p> Returns a new
 * {@see DateTimeImmutable} instance or <b>FALSE</b> on failure.</p>
 * @since 5.5.0
 */
function date_create_immutable_from_format($format, $time, $timezone = null) { }
 ...
 *
 * @return DateInterval|false The DateInterval object representing the difference between the two dates or FALSE on
 *                            failure.
 * @since 5.3.0
 */
 ...
 * @param string   $modify A date/time string. Valid formats are explained in {@link
 *                         http://www.php.net/manual/en/datetime.formats.php Date and Time Formats}.
 *
 ...
 * @return int <p>Returns the current time measured in the number of seconds since the Unix Epoch (January 1 1970
 *             00:00:00 GMT).</p>
 * @since 4.0
 * @since 5.0
 */
 ...
 *
 * @return array|false <p>Returns numerically indexed array containing associative array with all transitions on
