 ...
 * @link https://secure.php.net/manual/en/function.sybase-connect.php
 ...
 * @link https://secure.php.net/manual/en/function.sybase-pconnect.php
 * @param $servername string[optional]
 * @param $username string[optional]
 * @param $password string[optional]
 * @param $charset string[optional]
 ...
 * @link https://secure.php.net/manual/en/function.sybase-close.php
 ...
 * @link https://secure.php.net/manual/en/function.sybase-select-db.php
 ...
 * @link https://secure.php.net/manual/en/function.sybase-query.php
 * @param $query string
 * @param $link_identifier resource[optional]
 ...
 * @link https://secure.php.net/manual/en/function.sybase-unbuffered-query.php
 * @param $query string
...
/**
 * Frees result memory
 * @link https://secure.php.net/manual/en/function.sybase-free-result.php
 ...
 * @link https://secure.php.net/manual/en/function.sybase-get-last-message.php
 ...
 * @link https://secure.php.net/manual/en/function.sybase-num-rows.php
 * @param $result resource
 ...
 * @link https://secure.php.net/manual/en/function.sybase-num-fields.php
 * @param $result resource
 ...
 * @link https://secure.php.net/manual/en/function.sybase-fetch-row.php
 * @param $result resource
...
/**
 * Fetch row as array
 * @link https://secure.php.net/manual/en/function.sybase-fetch-array.php
 * @param $result resource
 * @return array an array that corresponds to the fetched row, or false if there
 */
 ...
 * @link https://secure.php.net/manual/en/function.sybase-fetch-assoc.php
 * @param $result resource
 * @return array an array that corresponds to the fetched row, or false if there
 */
 ...
 * @link https://secure.php.net/manual/en/function.sybase-fetch-object.php
 * @param $result resource
 ...
 * @link https://secure.php.net/manual/en/function.sybase-data-seek.php
 ...
 * @link https://secure.php.net/manual/en/function.sybase-fetch-field.php
 * @param $result resource
...
/**
 * Sets field offset
 * @link https://secure.php.net/manual/en/function.sybase-field-seek.php
 * @param $result resource
...
/**
 * Get result data
 * @link https://secure.php.net/manual/en/function.sybase-result.php
 * @param $result resource
 * @param $row int
 * @param $field mixed
 * @return string 
 ...
 * @link https://secure.php.net/manual/en/function.sybase-affected-rows.php
 * @param $link_identifier resource[optional]
 ...
 * @link https://secure.php.net/manual/en/function.sybase-min-client-severity.php
 * @param $severity int
 * @return void 
 */
 ...
 * @link https://secure.php.net/manual/en/function.sybase-min-server-severity.php
 * @param $severity int
 * @return void 
 */
 ...
 * @link https://secure.php.net/manual/en/function.sybase-set-message-handler.php
 ...
 * @link https://secure.php.net/manual/en/function.sybase-deadlock-retry-count.php
