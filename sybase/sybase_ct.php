 ...
 * @link https://www.php.net/manual/en/function.sybase-connect.php
 ...
 * @link https://www.php.net/manual/en/function.sybase-pconnect.php
 * @param string $servername [optional]
 * @param string $username [optional]
 * @param string $password [optional]
 * @param string $charset [optional]
 ...
 * @link https://www.php.net/manual/en/function.sybase-close.php
 ...
 * @link https://www.php.net/manual/en/function.sybase-select-db.php
 ...
 * @link https://www.php.net/manual/en/function.sybase-query.php
 * @param string $query
 * @param resource $link_identifier [optional]
 ...
 * @link https://www.php.net/manual/en/function.sybase-unbuffered-query.php
 * @param string $query
...
/**
 * Frees result memory
 * @link https://www.php.net/manual/en/function.sybase-free-result.php
 ...
 * @link https://www.php.net/manual/en/function.sybase-get-last-message.php
 ...
 * @link https://www.php.net/manual/en/function.sybase-num-rows.php
 * @param resource $result
 ...
 * @link https://www.php.net/manual/en/function.sybase-num-fields.php
 * @param resource $result
 ...
 * @link https://www.php.net/manual/en/function.sybase-fetch-row.php
 * @param resource $result
...
/**
 * Fetch row as array
 * @link https://www.php.net/manual/en/function.sybase-fetch-array.php
 * @param resource $result
 * @return array|false an array that corresponds to the fetched row, or false if there
 * @removed 7.0
 */
 ...
 * @link https://www.php.net/manual/en/function.sybase-fetch-assoc.php
 * @param resource $result
 * @return array|false an array that corresponds to the fetched row, or false if there
 * @removed 7.0
 */
 ...
 * @link https://www.php.net/manual/en/function.sybase-fetch-object.php
 * @param resource $result
 ...
 * @link https://www.php.net/manual/en/function.sybase-data-seek.php
 ...
 * @link https://www.php.net/manual/en/function.sybase-fetch-field.php
 * @param resource $result
...
/**
 * Sets field offset
 * @link https://www.php.net/manual/en/function.sybase-field-seek.php
 * @param resource $result
...
/**
 * Get result data
 * @link https://www.php.net/manual/en/function.sybase-result.php
 * @param resource $result
 * @param int $row
 * @param mixed $field
 * @return string
 ...
 * @link https://www.php.net/manual/en/function.sybase-affected-rows.php
 * @param resource $link_identifier [optional]
 ...
 * @link https://www.php.net/manual/en/function.sybase-min-client-severity.php
 * @param int $severity
 * @return void
 * @removed 7.0
 */
 ...
 * @link https://www.php.net/manual/en/function.sybase-min-server-severity.php
 * @param int $severity
 * @return void
 * @removed 7.0
 */
 ...
 * @link https://www.php.net/manual/en/function.sybase-set-message-handler.php
 ...
 * @link https://www.php.net/manual/en/function.sybase-deadlock-retry-count.php
