 ...
 * @link https://secure.php.net/manual/en/class.snmp.php
 */
class SNMP  {
    /**
	 ...
	 * @link https://secure.php.net/manual/en/snmp.construct.php
	...
	/**
	 * Close SNMP session
	 * @link https://secure.php.net/manual/en/snmp.close.php
     ...
     * @link https://secure.php.net/manual/en/snmp.setsecurity.php
	 ...
	 * @link https://secure.php.net/manual/en/snmp.get.php
	 ...
	 * @link https://secure.php.net/manual/en/snmp.getnext.php
	 ...
	 * @link https://secure.php.net/manual/en/snmp.walk.php
	 ...
	 * @link https://secure.php.net/manual/en/snmp.set.php
	...
	/**
	 * Get last error code
	 * @link https://secure.php.net/manual/en/snmp.geterrno.php
	 ...
	 * @link https://secure.php.net/manual/en/snmp.geterror.php
 ...
 * @link https://secure.php.net/manual/en/class.snmpexception.php
 */
...
/**
 * Fetch an SNMP object
 * @link https://secure.php.net/manual/en/function.snmpget.php
 ...
 * @link https://secure.php.net/manual/en/function.snmpgetnext.php
 ...
 * @link https://secure.php.net/manual/en/function.snmpwalk.php
 * @param string $hostname <p>
 ...
 * @link https://secure.php.net/manual/en/function.snmprealwalk.php
 * @param string $host <p>The hostname of the SNMP agent (server).</p>
 * @param string $community <p>The read community.</p>
 * @param string $object_id <p>The SNMP object id which precedes the wanted one.</p>
 * @param int $timeout [optional] <p>The number of microseconds until the first timeout.</p>
 ...
 * @link https://secure.php.net/manual/en/function.snmpwalkoid.php
 * @param string $hostname <p>
 * The SNMP agent.
 * </p>
 * @param string $community <p>
...
/**
 * Set the value of an SNMP object
 * @link https://secure.php.net/manual/en/function.snmpset.php
 * @param string $host <p>
 ...
 * @link https://secure.php.net/manual/en/function.snmp-get-quick-print.php
 ...
 * @link https://secure.php.net/manual/en/function.snmp-set-quick-print.php
 ...
 * @link https://secure.php.net/manual/en/function.snmp-set-enum-print.php
 ...
 * @link https://secure.php.net/manual/en/function.snmp-set-oid-output-format.php
...
/**
 * Return all objects including their respective object id within the specified one
 * @link https://secure.php.net/manual/en/function.snmp-set-oid-numeric-print.php
...
/**
 * Fetch an SNMP object
 * @link https://secure.php.net/manual/en/function.snmp2-get.php
 * @param string $host <p>
 * The SNMP agent.
 * </p>
 * @param string $community <p>
...
/**
 * Fetch the SNMP object which follows the given object id
 * @link https://secure.php.net/manual/en/function.snmp2-getnext.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Fetch all the SNMP objects from an agent
 * @link https://secure.php.net/manual/en/function.snmp2-walk.php
 * @param string $host <p>
 * The SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Return all objects including their respective object ID within the specified one
 * @link https://secure.php.net/manual/en/function.snmp2-real-walk.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Set the value of an SNMP object
 * @link https://secure.php.net/manual/en/function.snmp2-set.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $community <p>
...
/**
 * Fetch an SNMP object
 * @link https://secure.php.net/manual/en/function.snmp3-get.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
...
/**
 * Fetch the SNMP object which follows the given object id
 * @link https://secure.php.net/manual/en/function.snmp3-getnext.php
 * @param string $host <p>
 * The hostname of the
 * SNMP agent (server).
 * </p>
...
/**
 * Fetch all the SNMP objects from an agent
 * @link https://secure.php.net/manual/en/function.snmp3-walk.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $sec_name <p>
...
/**
 * Return all objects including their respective object ID within the specified one
 * @link https://secure.php.net/manual/en/function.snmp3-real-walk.php
 * @param string $host <p>
 * The hostname of the
 * SNMP agent (server).
 * </p>
...
/**
 * Set the value of an SNMP object
 * @link https://secure.php.net/manual/en/function.snmp3-set.php
 * @param string $host <p>
 * The hostname of the SNMP agent (server).
 * </p>
 * @param string $sec_name <p>
 ...
 * @link https://secure.php.net/manual/en/function.snmp-set-valueretrieval.php
 ...
 * @link https://secure.php.net/manual/en/function.snmp-get-valueretrieval.php
 ...
 * @link https://secure.php.net/manual/en/function.snmp-read-mib.php
...
/**
 * As of 5.4.0
 * @link https://secure.php.net/manual/en/snmp.constants.php
 */
