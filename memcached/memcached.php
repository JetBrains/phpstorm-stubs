 ...
 * @link https://secure.php.net/manual/en/class.memcached.php
 */
class Memcached  {
	 ...
	 * @link https://secure.php.net/manual/en/memcached.constants.php
	 */
	 ...
	 * @link https://secure.php.net/manual/en/memcached.construct.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getresultcode.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getresultmessage.php
	 ...
	 * (PECL memcached &gt;= 0.1.0)<br/>
	 * Retrieve an item
	 * @link https://secure.php.net/manual/en/memcached.get.php
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getbykey.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getmulti.php
	 * @param array $keys <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getmultibykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param array $keys <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getdelayed.php
	 * @param array $keys <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getdelayedbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param array $keys <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.fetch.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.fetchall.php
	 ...
	 * (PECL memcached &gt;= 0.1.0)<br/>
	 * Store an item
	 * @link https://secure.php.net/manual/en/memcached.set.php
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.setbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.touch.php
	 * @param string $key <p>
	 * The key under which to store the value.
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.touchbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.setmulti.php
	 * @param array $items <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.setmultibykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param array $items <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.cas.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.casbykey.php
	 * @param float $cas_token <p>
	 * Unique value associated with the existing item. Generated by memcache.
	 * </p>
	 * @param string $server_key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.add.php
	 * @param string $key <p>
	 * The key under which to store the value.
	 * </p>
	 * @param mixed $value <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.addbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.append.php
	 * @param string $key <p>
	 * The key under which to store the value.
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.appendbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.prepend.php
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.prependbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.replace.php
	 * @param string $key <p>
	 * The key under which to store the value.
	 * </p>
	 * @param mixed $value <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.replacebykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * (PECL memcached &gt;= 0.1.0)<br/>
	 * Delete an item
	 * @link https://secure.php.net/manual/en/memcached.delete.php
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.deletemulti.php
	 * @param array $keys <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.deletebykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.deletemultibykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param array $keys <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.increment.php
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.decrement.php
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.incrementbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.decrementbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 * @param string $key <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.addserver.php
	 * @param string $host <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.addservers.php
	 * @param array $servers
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getserverlist.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getserverbykey.php
	 * @param string $server_key <p>
	 * The key identifying the server to store the value on or retrieve it from. Instead of hashing on the actual key for the item, we hash on the server key when deciding which memcached server to talk to. This allows related items to be grouped together on a single server for efficiency with multi operations.
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.resetserverlist.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/memcached.quit.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getstats.php
	 * @param string $type
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getversion.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getallkeys.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.flush.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.getoption.php
	 * @param int $option <p>
	 ...
	 * @link https://secure.php.net/manual/en/memcached.setoption.php
	 * @param int $option
	 * @param mixed $value
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/memcached.setoptions.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.ispersistent.php
	 ...
	 * @link https://secure.php.net/manual/en/memcached.ispristine.php
...
/**
 * @link https://secure.php.net/manual/en/class.memcachedexception.php
 */
