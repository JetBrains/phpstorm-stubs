...
class MemcachePool  {
     ...
     * @link https://secure.php.net/manual/en/memcache.connect.php
     * @param string $host <p>
     ...
     * {@link https://secure.php.net/manual/ru/memcache.ini.php#ini.memcache.default-port memcache.default_port}
     ...
     * @link https://secure.php.net/manual/en/memcache.addserver.php
     * @param string $host <p>
     * Point to the host where memcached is listening for connections. This parameter
     ...
     * @link https://secure.php.net/manual/en/memcache.getserverstatus.php
     ...
     * @link https://secure.php.net/manual/en/memcache.getversion.php
     ...
     * @link https://secure.php.net/manual/en/memcache.add.php
     ...
     * @link https://secure.php.net/manual/en/memcache.set.php
     * @param string $key The key that will be associated with the item.
     * @param mixed $var The variable to store. Strings and integers are stored as is, other types are stored serialized.
     ...
     * @link https://secure.php.net/manual/en/memcache.replace.php
     ...
     * @link https://secure.php.net/manual/en/memcache.get.php
     ...
     * flags are the same as the ones given to for example {@link https://secure.php.net/manual/en/memcache.set.php Memcache::set()}.
     ...
     * an array of found key-value pairs when <b>key</b> is an {@link https://secure.php.net/manual/en/language.types.array.php array}.
     * Returns <b>FALSE</b> on failure, <b>key</b> is not found or
     * <b>key</b> is an empty {@link https://secure.php.net/manual/en/language.types.array.php array}.
     * </p>
     */
     ...
     * @link https://secure.php.net/manual/ru/memcache.getstats.php
     ...
     * @link https://secure.php.net/manual/en/memcache.getextendedstats.php
     ...
     * @link https://secure.php.net/manual/en/memcache.setcompressthreshold.php
     ...
     * @link https://secure.php.net/manual/en/memcache.increment.php
     ...
     * @link https://secure.php.net/manual/en/memcache.decrement.php
     ...
     * @link https://secure.php.net/manual/en/memcache.close.php
     * @return boolean Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
     ...
     * @link https://secure.php.net/manual/en/memcache.flush.php
     * @return boolean Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
 ...
 * @link https://secure.php.net/manual/en/class.memcache.php
 */
class Memcache extends MemcachePool  {
	 ...
	 * @link https://secure.php.net/manual/en/memcache.pconnect.php
	 * @param string $host <p>
	 * Point to the host where memcached is listening for connections. This parameter
	 * may also specify other transports like unix:///path/to/memcached.sock
	 * to use UNIX domain sockets, in this case <i>port</i> must also
 ...
 * 
 * @link https://secure.php.net/manual/en/memcache.pconnect.php#example-5242
 * @param      $host
 * @param null $port
 * @param int  $timeout
 * @return Memcache
 ...
 * @link https://secure.php.net/manual/en/function.memcache-debug.php
 * @param bool $on_off <p>
