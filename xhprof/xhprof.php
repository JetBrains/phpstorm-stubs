 ...
 *
 * @link https://www.php.net/manual/en/function.xhprof-enable.php
 *
 ...
 *
 * @link https://www.php.net/manual/en/function.xhprof-disable.php
 ...
 *
 * @link https://www.php.net/manual/en/function.xhprof-sample-enable.php
 * @return null
 */
 ...
 *
 * @link https://www.php.net/manual/en/function.xhprof-sample-disable.php
...
/**
 * @link https://www.php.net/manual/en/xhprof.constants.php#constant.xhprof-flags-no-builtins
 */
const XHPROF_FLAGS_NO_BUILTINS = 1;
/**
 * @link https://www.php.net/manual/en/xhprof.constants.php#constant.xhprof-flags-cpu
 */
const XHPROF_FLAGS_CPU = 2;
/**
 * @link https://www.php.net/manual/en/xhprof.constants.php##constant.xhprof-flags-memory
 */
