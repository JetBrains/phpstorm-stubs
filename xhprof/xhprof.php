 ...
 *
 * @link https://secure.php.net/manual/en/function.xhprof-enable.php
 *
 ...
 *
 * @link https://secure.php.net/manual/en/function.xhprof-disable.php
 ...
 *
 * @link https://secure.php.net/manual/en/function.xhprof-sample-enable.php
 * @return null
 */
 ...
 *
 * @link https://secure.php.net/manual/en/function.xhprof-sample-disable.php
...
/**
 * @type int
 * @link https://secure.php.net/manual/en/xhprof.constants.php#constant.xhprof-flags-no-builtins
 */
const XHPROF_FLAGS_NO_BUILTINS = 1;
/**
 * @type int
 * @link https://secure.php.net/manual/en/xhprof.constants.php#constant.xhprof-flags-cpu
 */
const XHPROF_FLAGS_CPU = 2;
/**
 * @type int
 * @link https://secure.php.net/manual/en/xhprof.constants.php##constant.xhprof-flags-memory
 */
