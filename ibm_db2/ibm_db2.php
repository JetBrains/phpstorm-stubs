 ...
 * @link https://secure.php.net/manual/en/function.db2-connect.php
 ...
 * @link https://secure.php.net/manual/en/function.db2-commit.php
 ...
 * @link https://secure.php.net/manual/en/function.db2-pconnect.php
 * @param database string <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-autocommit.php
 * @param connection resource <p>
 * A valid database connection resource variable as returned from
 * db2_connect or db2_pconnect.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-bind-param.php
 ...
 * @link https://secure.php.net/manual/en/function.db2-close.php
 * @param connection resource <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-column-privileges.php
 * @param connection resource <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-columns.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 * @param qualifier string[optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-foreign-keys.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-primary-keys.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 * @param qualifier string <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-procedure-columns.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 * @param qualifier string <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-procedures.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 * @param qualifier string <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-special-columns.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 * @param qualifier string <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-statistics.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 * @param qualifier string <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-table-privileges.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 * @param qualifier string[optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-tables.php
 * @param connection resource <p>
 * A valid connection to an IBM DB2, Cloudscape, or Apache Derby database.
 * </p>
 * @param qualifier string[optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-exec.php
 * @param connection resource <p>
 * A valid database connection resource variable as returned from
 * db2_connect or db2_pconnect.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-prepare.php
 * @param connection resource <p>
 * A valid database connection resource variable as returned from
 * db2_connect or db2_pconnect.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-execute.php
 * @param stmt resource <p>
 * A prepared statement returned from db2_prepare.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-stmt-errormsg.php
 ...
 * @link https://secure.php.net/manual/en/function.db2-conn-errormsg.php
 ...
 * @link https://secure.php.net/manual/en/function.db2-conn-error.php
 * @param connection resource[optional] <p>
 * A connection resource associated with a connection that initially
 * succeeded, but which over time became invalid.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-stmt-error.php
 * @param stmt resource[optional] <p>
 * A valid statement resource.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-next-result.php
 * @param stmt resource <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-num-fields.php
 * @param stmt resource <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-num-rows.php
 * @param stmt resource <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-field-name.php
 * @param stmt resource <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-field-display-size.php
 * @param stmt resource <p>
 * Specifies a statement resource containing a result set.
 * </p>
 * @param column mixed <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-field-num.php
 * @param stmt resource <p>
 * Specifies a statement resource containing a result set.
 * </p>
 * @param column mixed <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-field-precision.php
 * @param stmt resource <p>
 * Specifies a statement resource containing a result set.
 * </p>
 * @param column mixed <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-field-scale.php
 * @param stmt resource <p>
 * Specifies a statement resource containing a result set.
 * </p>
 * @param column mixed <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-field-type.php
 * @param stmt resource <p>
 * Specifies a statement resource containing a result set.
 * </p>
 * @param column mixed <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-field-width.php
 * @param stmt resource <p>
 * Specifies a statement resource containing a result set.
 * </p>
 * @param column mixed <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-cursor-type.php
 * @param stmt resource <p>
 * A valid statement resource.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-rollback.php
 * @param connection resource <p>
 * A valid database connection resource variable as returned from
 * db2_connect or db2_pconnect.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-free-stmt.php
 * @param stmt resource <p>
 * A valid statement resource.
 * </p>
 * @return bool true on success or false on failure.
 ...
 * @link https://secure.php.net/manual/en/function.db2-result.php
 * @param stmt resource <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-fetch-row.php
 * @param stmt resource <p>
 * A valid stmt resource.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-fetch-assoc.php
 * @param stmt resource <p>
 * A valid stmt resource containing a result set.
 * </p>
 * @param row_number int[optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-fetch-array.php
 * @param stmt resource <p>
 * A valid stmt resource containing a result set.
 * </p>
 * @param row_number int[optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-fetch-both.php
 * @param stmt resource <p>
 * A valid stmt resource containing a result set.
 * </p>
 * @param row_number int[optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-free-result.php
 * @param stmt resource <p>
 * A valid statement resource.
 * </p>
 * @return bool true on success or false on failure.
 ...
 * @link https://secure.php.net/manual/en/function.db2-set-option.php
 ...
 * @link https://secure.php.net/manual/en/function.db2-fetch-object.php
 * @param stmt resource <p>
 * A valid stmt resource containing a result set.
 * </p>
 * @param row_number int[optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-server-info.php
 * @param connection resource <p>
 * Specifies an active DB2 client connection.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-client-info.php
 * @param connection resource <p>
 * Specifies an active DB2 client connection.
 * </p>
 * @return object an object on a successful call. Returns false on failure.
 ...
 * @link https://secure.php.net/manual/en/function.db2-escape-string.php
 ...
 * @link https://secure.php.net/manual/en/function.db2-lob-read.php
 * @param stmt resource <p>
 ...
 * @link https://secure.php.net/manual/en/function.db2-get-option.php
 * @param resource resource <p>
 * A valid statement resource as returned from
 * db2_prepare or a valid connection resource as
 * returned from db2_connect or
...
/**
 * @link https://secure.php.net/manual/en/function.db2-last-insert-id.php
 ...
 * mode.
 * @link https://secure.php.net/manual/en/ibm-db2.constants.php
 */
define ('DB2_BINARY', 1);
