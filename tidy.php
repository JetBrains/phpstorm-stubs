...
final class tidyNode  {
    ...
    /**
     * @var The HTML representation of the node, including the surrounding tags.
     */
    var $value;
    /**
     * @var The name of the HTML node
     */
    var $name;
    /**
     * @var The type of the tag (one of the constants above, e.g. TIDY_NODETYPE_PHP)
     */
    var $type;
    /**
     * @var The line number at which the tags is located in the file
     */
    var $line;
    /**
     * @var The column number at which the tags is located in the file
     */
    var $column;
    /**
     * @var Indicates if the node is a proprietary tag
     */
    var $proprietary;
    /**
     * @var The ID of the tag (one of the constants above, e.g. TIDY_TAG_FRAME)
     */
    var $id;
    /**
     * @var An array of string, representing the attributes names (as keys) of the current node.
     */
    var $attribute;
    /**
     * @var An array of TidyNode, representing the children of the current node.
     */
    var $child;
