 ...
 * @link https://secure.php.net/manual/en/function.textdomain.php
 ...
 * @link https://secure.php.net/manual/en/function.gettext.php
 ...
 * @link https://secure.php.net/manual/en/function.dgettext.php
 ...
 * @link https://secure.php.net/manual/en/function.dcgettext.php
 * @param string $domain <p>
 * The domain
 * </p>
 * @param string $message <p>
 ...
 * @link https://secure.php.net/manual/en/function.bindtextdomain.php
 * @param string $domain <p>
 * The domain
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.ngettext.php
 * @param string $msgid1
 * @param string $msgid2
 * @param int $n
 ...
 * @link https://secure.php.net/manual/en/function.dngettext.php
 * @param string $domain <p>
 * The domain
 * </p>
 * @param string $msgid1
 ...
 * @link https://secure.php.net/manual/en/function.dcngettext.php
 * @param string $domain <p>
 * The domain
 * </p>
 * @param string $msgid1
 ...
 * @link https://secure.php.net/manual/en/function.bind-textdomain-codeset.php
 * @param string $domain <p>
 * The domain
 * </p>
