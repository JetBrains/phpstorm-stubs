 ...
 * @link https://secure.php.net/manual/en/function.pcntl-fork.php
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-waitpid.php
 * @param int $pid <p>
...
/**
 * Waits on or returns the status of a forked child
 * @link https://secure.php.net/manual/en/function.pcntl-wait.php
 * @param int $status <p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-signal.php
 * @param int $signo <p>
 * The signal number.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-signal-dispatch.php
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 5.3.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-wifexited.php
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-wifstopped.php
 * @param int $status The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-wifsignaled.php
 * @param int $status The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-wexitstatus.php
 * @param int $status The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-wtermsig.php
 * @param int $status The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-wstopsig.php
 * @param int $status The <i>status</i>
 * parameter is the status parameter supplied to a successful
 * call to <b>pcntl_waitpid</b>.</p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-exec.php
 * @param string $path <p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-alarm.php
 * @param int $seconds <p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-get-last-error.php
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-errno.php
 * @since 5.3.4
 */
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-strerror.php
 * @param int $errno <p>
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-getpriority.php
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-setpriority.php
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-sigprocmask.php
 * @param int $how <p>
...
/**
 * Waits for signals
 * @link https://secure.php.net/manual/en/function.pcntl-sigwaitinfo.php
 * @param array $set <p>
 ...
 * @link https://secure.php.net/manual/en/function.pcntl-sigtimedwait.php
 * @param array $set <p>
 * Array of signals to wait for.
 * </p>
 * @param array $siginfo [optional] <p>
...
/**
 * @link https://secure.php.net/manual/en/pcntl.constants.php
 * @since 5.3.0
 */
define ('SIG_BLOCK', 0);
