...
//TODO: copy proper descriptions for all constants from https://secure.php.net/manual/en/function.curl-setopt.php
...
/**
 * @link https://secure.php.net/manual/en/curl.constants.php
 * @since 5.3.0
 */
