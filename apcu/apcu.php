...
/**
 * @link https://secure.php.net/manual/en/apcu.constants.php
 */
 ...
 * @link https://secure.php.net/manual/en/function.apcu-clear-cache.php
 *
 ...
 * @link https://secure.php.net/manual/en/function.apcu-sma-info.php
 ...
 * @link https://secure.php.net/manual/en/function.apcu-exists.php
 ...
 *
 * @link https://secure.php.net/manual/en/function.apcu-cas.php
 ...
 * </p>
 *
 * @link https://secure.php.net/manual/en/function.apcu-entry.php
 *
 ...
 *
 * @link https://secure.php.net/manual/en/class.apcuiterator.php
 * @since APCu 5.0.0
 */
class APCUIterator implements Iterator
{
	 ...
	 * @link https://secure.php.net/manual/en/apcuiterator.construct.php
	 ...
	 * @link https://secure.php.net/manual/en/apcuiterator.rewind.php
	 */
	public function rewind(){}

	/**
	 * Checks if the current iterator position is valid
	 * @link https://secure.php.net/manual/en/apcuiterator.valid.php
	 ...
	 * @link https://secure.php.net/manual/en/apcuiterator.current.php
	 ...
	 * @link https://secure.php.net/manual/en/apcuiterator.key.php
	 ...
	 * @link https://secure.php.net/manual/en/apcuiterator.next.php
	 * @return bool Returns TRUE on success or FALSE on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/apcuiterator.gettotalhits.php
	 ...
	 * @link https://secure.php.net/manual/en/apcuiterator.gettotalsize.php
	...
	/**
	 * Get the total count
	 * @link https://secure.php.net/manual/en/apcuiterator.gettotalcount.php
