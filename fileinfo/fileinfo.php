...
class finfo  {
	 ...
	 * @link https://secure.php.net/manual/en/function.finfo-set-flags.php
	 * @param int $options <p>
	 ...
	 * @link https://secure.php.net/manual/en/function.finfo-file.php
	 ...
	 * @link https://secure.php.net/manual/en/function.finfo-buffer.php
 ...
 * @link https://secure.php.net/manual/en/function.finfo-open.php
 * @param int $options [optional] <p>
 * One or disjunction of more Fileinfo
 * constants.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.finfo-close.php
 ...
 * <a href="https://secure.php.net/manual/en/fileinfo.constants.php">Fileinfo</a> constants.
 * @param resource $context [optional] 
 * @return string a textual description of the <i>string</i>
 * argument, or <b>FALSE</b> if an error occurred.
 */
 ...
 * @link https://secure.php.net/manual/en/function.mime-content-type.php
...
/**
 * No special handling.
 * @link https://secure.php.net/manual/en/fileinfo.constants.php
 */
