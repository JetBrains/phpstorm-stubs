<?php
/**
 * @link https://www.php.net/manual/en/gearman.constants.php
 */
...
class GearmanClient
{
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.construct.php
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.returncode.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.error.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.geterrno.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setoptions.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.addoptions.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.removeoptions.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.timeout.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.settimeout.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.context.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setcontext.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.addserver.php
     * @param string $host
     * @param int $port
     * @return bool
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.addservers.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.dohigh.php
     * @param string $function_name
     * @param string $workload
     ...
     * priority tasks in the job queue.
     *
     * @link https://www.php.net/manual/en/gearmanclient.donormal.php
     * @param string $function_name
     * @param string $workload
     * @param string|null $unique
     * @return string A string representing the results of running a task
     ...
     * priority tasks in the job queue.
     *
     * @link https://www.php.net/manual/en/gearmanclient.dolow.php
     ...
     * the task.
     *
     * @link https://www.php.net/manual/en/gearmanclient.dojobhandle.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.dostatus.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.dobackground.php
     * @param string $function
     * @param string $workload
     * @param string|null $unique
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.dohighbackground.php
     * @param string $function
     * @param string $workload
     * @param string|null $unique
     * @return string The job handle for the submitted task
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.dolowbackground.php
     * @param string $function
     * @param string $workload
     * @param string|null $unique
     * @return string The job handle for the submitted task
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.jobstatus.php
     ...
     * parallel.
     *
     * @link https://www.php.net/manual/en/gearmanclient.addtask.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string|null $unique
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.addtaskhigh.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string|null $unique
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.addtasklow.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string|null $unique
     ...
     * perform the work.
     *
     * @link https://www.php.net/manual/en/gearmanclient.addtaskbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string|null $unique
     ...
     * selected from the queue before those of normal or low priority.
     *
     * @link https://www.php.net/manual/en/gearmanclient.addtaskhighbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string|null $unique
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.addtasklowbackground.php
     * @param string $function_name
     * @param string $workload
     * @param mixed $context
     * @param string|null $unique
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.addtaskstatus.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setworkloadcallback.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setcreatedcallback.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setdatacallback.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setwarningcallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setstatuscallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setcompletecallback.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setexceptioncallback.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.setfailcallback.php
     * @param callable $callback A function to call
     * @return bool
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.clearcallbacks.php
     * @return bool Always returns true
     */
     ...
     * parallel.
     *
     * @link https://www.php.net/manual/en/gearmanclient.runtasks.php
     * @return bool
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanclient.ping.php
     * @param string $workload
     * @return bool
     */
...
class GearmanTask
{
     ...
     *
     * @link https://www.php.net/manual/en/gearmantask.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     *
     * @link https://www.php.net/manual/en/gearmantask.functionname.php
     ...
     * server.
     *
     * @link https://www.php.net/manual/en/gearmantask.unique.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmantask.jobhandle.php
     ...
     * server.
     *
     * @link https://www.php.net/manual/en/gearmantask.isknown.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmantask.isrunning.php
     ...
     * as a fraction.
     *
     * @link https://www.php.net/manual/en/gearmantask.tasknumerator.php
     ...
     * as a fraction.
     *
     * @link https://www.php.net/manual/en/gearmantask.taskdenominator.php
     * @return int|false A number between 0 and 100, or false if cannot be determined
     */
     ...
     * .
     *
     * @link https://www.php.net/manual/en/gearmantask.sendworkload.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmantask.data.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmantask.datasize.php
     ...
     * .
     *
     * @link https://www.php.net/manual/en/gearmantask.recvdata.php
...
class GearmanWorker
{
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.construct.php
     */
    public function __construct() {}
     ...
     * Returns the last Gearman return code.
     *
     * @link https://www.php.net/manual/en/gearmanworker.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     * Returns an error string for the last error encountered.
     *
     * @link https://www.php.net/manual/en/gearmanworker.error.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.geterrno.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.options.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.setoptions.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.addoptions.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.removeoptions.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.timeout.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.settimeout.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.setid.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.addserver.php
     * @param string $host
     * @param int $port
     * @return bool
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.addservers.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.wait.php
     * @return bool
     */
    public function wait() {}
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.register.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.unregister.php
     * @param string $function_name The name of a function to register with the job
     *        server
     * @return bool A standard Gearman return value
     */
     ...
     * sent to this worker.
     *
     * @link https://www.php.net/manual/en/gearmanworker.unregisterall.php
     * @return bool A standard Gearman return value
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.addfunction.php
     * @param string $function_name The name of a function to register with the job
     *        server
     ...
     *
     * @link https://www.php.net/manual/en/gearmanworker.work.php
     * @return bool
     */
...
class GearmanJob
{
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.returncode.php
     * @return int A valid Gearman return code
     */
    public function returnCode() {}
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.setreturn.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.senddata.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.sendwarning.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.sendstatus.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.sendcomplete.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.sendexception.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.sendfail.php
     * @return bool
     */
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.handle.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.functionname.php
     ...
     * client.
     *
     * @link https://www.php.net/manual/en/gearmanjob.unique.php
     ...
     *
     * @link https://www.php.net/manual/en/gearmanjob.workload.php
     ...
     * bytes.
     *
     * @link https://www.php.net/manual/en/gearmanjob.workloadsize.php
