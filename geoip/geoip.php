 ...
 * @link https://secure.php.net/manual/en/function.geoip-database-info.php
 ...
 * @link https://secure.php.net/manual/en/function.geoip-country-code-by-name.php
 ...
 * @link https://secure.php.net/manual/en/function.geoip-country-code3-by-name.php
 * @param string $hostname <p>
 * The hostname or IP address whose location is to be looked-up.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.geoip-country-name-by-name.php
 * @param string $hostname <p>
 * The hostname or IP address whose location is to be looked-up.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.geoip-continent-code-by-name.php
 * @param string $hostname <p>
 * The hostname or IP address whose location is to be looked-up.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.geoip-org-by-name.php
 * @param string $hostname <p>
 ...
 * @link https://secure.php.net/manual/en/function.geoip-record-by-name.php
 * @param string $hostname <p>
 ...
 * @link https://secure.php.net/manual/en/function.geoip-id-by-name.php
 * @param string $hostname <p>
 ...
 * @link https://secure.php.net/manual/en/function.geoip-region-by-name.php
 * @param string $hostname <p>
 ...
 * @link https://secure.php.net/manual/en/function.geoip-isp-by-name.php
 * @param string $hostname <p>
 * The hostname or IP address.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.geoip-db-avail.php
 ...
 * @link https://secure.php.net/manual/en/function.geoip-db-get-all-info.php
 ...
 * @link https://secure.php.net/manual/en/function.geoip-db-filename.php
 * @param int $database <p>
 * The database type as an integer. You can use the
 * various constants defined with
 * this extension (ie: GEOIP_*_EDITION).
 ...
 * @link https://secure.php.net/manual/en/function.geoip-region-name-by-code.php
 ...
 * @link https://secure.php.net/manual/en/function.geoip-time-zone-by-country-and-region.php
 * @param string $country_code <p>
 * The two-letter country code (see
 * <b>geoip_country_code_by_name</b>)
 * </p>
