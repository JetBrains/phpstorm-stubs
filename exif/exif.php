 ...
 * @link https://secure.php.net/manual/en/function.exif-read-data.php
 ...
 * @link https://secure.php.net/manual/en/function.read-exif-data.php
 * @param $filename
 ...
 * @link https://secure.php.net/manual/en/function.exif-tagname.php
 * @param int $index <p>
 ...
 * @link https://secure.php.net/manual/en/function.exif-thumbnail.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.exif-imagetype.php
