 ...
 * or non-WSDL mode.
 * @link https://secure.php.net/manual/en/class.soapclient.php
 */
class SoapClient  {

	/**
	 * SoapClient constructor
	 * @link https://secure.php.net/manual/en/soapclient.soapclient.php
	 * @param mixed $wsdl <p>
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.call.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.soapcall.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.getlastrequest.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.getlastresponse.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.getlastrequestheaders.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.getlastresponseheaders.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.getfunctions.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.gettypes.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.dorequest.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.setcookie.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.setlocation.php
	 ...
	 * @link https://secure.php.net/manual/en/soapclient.setsoapheaders.php
 ...
 * @link https://secure.php.net/manual/en/class.soapvar.php
 */
class SoapVar  {

	/**
	 * SoapVar constructor
	 * @link https://secure.php.net/manual/en/soapvar.soapvar.php
	 * @param mixed $data <p>
 ...
 * @link https://secure.php.net/manual/en/class.soapserver.php
 */
class SoapServer  {

	/**
	 * SoapServer constructor
	 * @link https://secure.php.net/manual/en/soapserver.soapserver.php
	 * @param mixed $wsdl <p>
	 ...
	 * @link https://secure.php.net/manual/en/soapserver.setpersistence.php
	 * @param int $mode <p>
	 ...
	 * @link https://secure.php.net/manual/en/soapserver.setclass.php
	 ...
	 * @link https://secure.php.net/manual/en/soapserver.setobject.php
	 ...
	 * @link https://secure.php.net/manual/en/soapserver.addfunction.php
	 ...
	 * @link https://secure.php.net/manual/en/soapserver.getfunctions.php
	 ...
	 * @link https://secure.php.net/manual/en/soapserver.handle.php
	 ...
	 * @link https://secure.php.net/manual/en/soapserver.fault.php
	 * @param string $code <p>
	 ...
	 * @link https://secure.php.net/manual/en/soapserver.addsoapheader.php
 ...
 * @link https://secure.php.net/manual/en/class.soapfault.php
 */
class SoapFault extends Exception  {
	 ...
	 * @link https://secure.php.net/manual/en/soapfault.soapfault.php
	 ...
	 * @link https://secure.php.net/manual/en/soapfault.tostring.php
 ...
 * @link https://secure.php.net/manual/en/class.soapparam.php
 */
class SoapParam  {

	/**
	 * SoapParam constructor
	 * @link https://secure.php.net/manual/en/soapparam.soapparam.php
	 * @param mixed $data <p>
 ...
 * @link https://secure.php.net/manual/en/class.soapheader.php
 */
class SoapHeader  {

	/**
	 * SoapHeader constructor
	 * @link https://secure.php.net/manual/en/soapheader.soapheader.php
 ...
 * @link https://secure.php.net/manual/en/function.use-soap-error-handler.php
 ...
 * @link https://secure.php.net/manual/en/function.is-soap-fault.php
...
/**
 * @link https://secure.php.net/manual/en/soap.constants.php
 * @since 5.5.0
 */
