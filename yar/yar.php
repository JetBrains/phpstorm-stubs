 ...
 * @link https://www.php.net/manual/en/yar.constants.php
 */
 ...
 * @link https://www.php.net/manual/en/class.yar-server.php
 */
class Yar_Server {
     ...
     * @link https://www.php.net/manual/en/yar-server.construct.php
     */
     ...
     * @return bool
     * @link https://www.php.net/manual/en/yar-server.handle.php
     */
...
class Yar_Client {
     ...
     * @link https://www.php.net/manual/en/yar-client.call.php
     */
     ...
     * @link https://www.php.net/manual/en/yar-client.construct.php
     */
     ...
     * @link https://www.php.net/manual/en/yar-client.setopt.php
     */
...
class Yar_Concurrent_Client {
     ...
     * @return int
     * @link https://www.php.net/manual/en/yar-concurrent-client.call.php
     */
     ...
     * @return bool
     * @link https://www.php.net/manual/en/yar-concurrent-client.loop.php
     */
     ...
     * Clean all registered calls
     * @return bool
     * @link https://www.php.net/manual/en/yar-concurrent-client.reset.php
     */
 ...
 * @author weizhimiao001@lianjia.com
 * @link https://www.php.net/manual/en/class.yar-server-exception.php
 */
class Yar_Server_Exception extends Exception {
     ...
     * @return string
     * @link https://www.php.net/manual/en/yar-server-exception.gettype.php
     */
 ...
 * @author weizhimiao001@lianjia.com
 * @link https://www.php.net/manual/en/class.yar-client-exception.php
 */
class Yar_Client_Exception extends Exception {
    /**
     * Retrieve exception's type
     * @return string "Yar_Exception_Client".
     * @link https://www.php.net/manual/en/yar-client-exception.gettype.php
     */
    public function getType (){}
}
