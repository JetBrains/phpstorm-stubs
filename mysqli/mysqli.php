...
/**
 * MySQLi Driver.
 * @link https://secure.php.net/manual/en/class.mysqli-driver.php
 */
 ...
 * @link https://secure.php.net/manual/en/class.mysqli.php
 */
class mysqli  {
	/**
	 * @var int
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.change-user.php
	 * @param string $user <p>
	 * The MySQL user name.
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.character-set-name.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.close.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.commit.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.dump-debug-info.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.debug.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.get-charset.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.get-client-info.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.get-connection-stats.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.get-server-info.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.get-warnings.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.init.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.kill.php
	 * @param int $processid
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.multi-query.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.more-results.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.next-result.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	...
	/**
	 * Set options
	 * @link https://secure.php.net/manual/en/mysqli.options.php
	 * @param int $option <p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.ping.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.prepare.php
	 * @param string $query <p>
	 * The query, as a string.
	 * </p>
	 * <p>
	...
	/**
	 * Poll connections
	 * @link https://secure.php.net/manual/en/mysqli.poll.php
	 * @param array $read <p>
	 * </p>
	 * @param array $error <p>
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.reap-async-query.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.real-query.php
	 * @param string $query <p>
	 * The query, as a string.
	 * </p>
	 * <p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.rollback.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.select-db.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.set-charset.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.stat.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.stmt-init.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.store-result.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.thread-safe.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli.use-result.php
 ...
 * @link https://secure.php.net/manual/en/class.mysqli-warning.php
 */
final class mysqli_warning  {
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-warning.construct.php
	 */
	protected function __construct () {}

	/**
	 * Move to the next warning
	 * @link https://secure.php.net/manual/en/mysqli-warning.next.php
 ...
 * @link https://secure.php.net/manual/en/class.mysqli-result.php
 */
class mysqli_result implements Traversable  {
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-result.free.php
	 * @return void
	 * @since 5.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-result.data-seek.php
	 * @param int $offset <p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-result.fetch-all.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-result.fetch-assoc.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-result.fetch-object.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-result.fetch-row.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-result.field-seek.php
	 * @param int $fieldnr <p>
	 * The field number. This value must be in the range from
	 * 0 to number of fields - 1.
	 * </p>
 ...
 * @link https://secure.php.net/manual/en/class.mysqli-stmt.php
 */
class mysqli_stmt  {
	/**
	 * @var int
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.attr-get.php
	 * @param int $attr <p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.attr-set.php
	 * @param int $attr <p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.bind-param.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.bind-result.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.close.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	public function close () {}
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.data-seek.php
	 * @param int $offset <p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.execute.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.fetch.php
	 * @return bool
	 * @since 5.0
	 */
	...
	/**
	 * Get result of SHOW WARNINGS
	 * @link https://secure.php.net/manual/en/mysqli-stmt.get-warnings.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.result-metadata.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.more-results.php
	 * @return bool
	 */
	public function more_results () {}
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.next-result.php
	 * @return bool
	 */
	public function next_result () {}
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.num-rows.php
	 * @param mysqli_stmt $stmt
	...
	/**
	 * Send data in blocks
	 * @link https://secure.php.net/manual/en/mysqli-stmt.send-long-data.php
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.free-result.php
	 * @return void
	 * @since 5.0
	 */
	public function free_result () {}
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.reset.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	...
	/**
	 * Prepare an SQL statement for execution
	 * @link https://secure.php.net/manual/en/mysqli-stmt.prepare.php
	 * @param string $query <p>
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.store-result.php
	 * @return bool true on success or false on failure.
	 * @since 5.0
	 */
	public function store_result () {}
	 ...
	 * @link https://secure.php.net/manual/en/mysqli-stmt.get-result.php
 ...
 * @link https://secure.php.net/manual/en/mysqli.construct.php
 ...
 * @link https://secure.php.net/manual/en/mysqli.connect-errno.php
 ...
 * @link https://secure.php.net/manual/en/mysqli.connect-error.php
 ...
 * @link https://secure.php.net/manual/en/mysqli.errno.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-execute.php
 * @param mysqli_stmt $stmt
 * @deprecated
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli-result.lengths.php
 * @param mysqli_result $result A result set identifier returned by mysqli_query(),
 * mysqli_store_result() or mysqli_use_result().
 ...
 * @link https://secure.php.net/manual/en/mysqli.field-count.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli-result.current-field.php
 * @param mysqli_result $result A result set identifier returned by mysqli_query(),
 * mysqli_store_result() or mysqli_use_result().
 * @return int
 */
 ...
 * @since 5.3.0
 * Available only with mysqlnd.
 * @link https://secure.php.net/manual/en/mysqli.get-cache-stats.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @since 5.3.0
 * @link https://secure.php.net/manual/en/mysqli.get-client-stats.php
...
/**
 * Returns the MySQL client version as a string
 * @link https://secure.php.net/manual/en/mysqli.get-client-version.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @return string
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli.get-host-info.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli.get-proto-info.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli.get-server-version.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli.info.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli.insert-id.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli.set-local-infile-default.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @return void
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli.set-local-infile-handler.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli-result.field-count.php
 * @param mysqli_result $result A result set identifier returned by mysqli_query(),
 * mysqli_store_result() or mysqli_use_result().
 * @return int
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli-result.num-rows.php
 * @param mysqli_result $result A result set identifier returned by mysqli_query(),
 * mysqli_store_result() or mysqli_use_result().
 ...
 * @since 5.0
 * @link https://secure.php.net/manual/en/function.mysqli-report.php
 * @param int $flags <p>
 * <table>
 * Supported flags
 * <tr valign="top">
 ...
 * @link https://secure.php.net/manual/en/mysqli-stmt.affected-rows.php
 * @param mysqli_stmt $stmt
 ...
 * @link https://secure.php.net/manual/en/mysqli-stmt.field-count.php
 * @param mysqli_stmt $stmt
 * @return int
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli-stmt.insert-id.php
 * @param mysqli_stmt $stmt
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli-stmt.param-count.php
 * @param mysqli_stmt $stmt
 * @return int
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli.sqlstate.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli-stmt.errno.php
 * @param mysqli_stmt $stmt
 * @return bool
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli-stmt.error.php
 * @param mysqli_stmt $stmt
 * @return string
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli-stmt.sqlstate.php
 * @param mysqli_stmt $stmt
 * @return string Returns a string containing the SQLSTATE error code for the last error. The error code consists of five characters. '00000' means no error.
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli.thread-id.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 ...
 * @link https://secure.php.net/manual/en/mysqli.warning-count.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @return int
 */
 ...
 * @link https://secure.php.net/manual/en/mysqli.refresh.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @param int $options
 * @return bool
 */
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-bind-param.php
 * @param mysqli_stmt $stmt
 * @param $types
 * @deprecated 5.3 This function has been DEPRECATED as of PHP 5.3.0 and REMOVED as of PHP 5.4.0.
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-bind-result.php
 * @param mysqli_stmt $stmt
 * @param string $types
 * @param mixed $var1
 * @deprecated 5.3 This function has been DEPRECATED as of PHP 5.3.0 and REMOVED as of PHP 5.4.0.
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-client-encoding.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @return string
 * @deprecated 5.3 This function has been DEPRECATED as of PHP 5.3.0 and REMOVED as of PHP 5.4.0.
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-escape-string.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @param string $query
 * @return string
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-fetch.php
 * @param mysqli_stmt $stmt
 * @return bool
 * @deprecated 5.3 This function has been DEPRECATED as of PHP 5.3.0 and REMOVED as of PHP 5.4.0.
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-param-count.php
 * @param mysqli_stmt $stmt
 * @return int
 * @deprecated 5.3 This function has been DEPRECATED as of PHP 5.3.0 and REMOVED as of PHP 5.4.0.
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-get-metadata.php
 * @param mysqli_stmt $stmt
 * @return mysqli_result|bool Returns a result object or FALSE if an error occurred
 * @deprecated 5.3 This function has been DEPRECATED as of PHP 5.3.0 and REMOVED as of PHP 5.4.0.
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-send-long-data.php
 * @param mysqli_stmt $stmt
 * @param int $param_nr
 * @param string $data
 * @return bool
 ...
 * @link https://secure.php.net/manual/en/function.mysqli-set-opt.php
 * @param mysqli $link A link identifier returned by mysqli_connect() or mysqli_init()
 * @param int $option
 * @param mixed $value
 * @return bool
 ...
 * </p>
 * @link https://secure.php.net/manual/en/mysqli.constants.php
 */
