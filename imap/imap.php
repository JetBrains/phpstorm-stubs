 ...
 * @link https://secure.php.net/manual/en/function.imap-open.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-reopen.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-close.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-num-msg.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-num-recent.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-headers.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-headerinfo.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-rfc822-parse-headers.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-rfc822-write-address.php
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 * information
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-rfc822-parse-adrlist.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-body.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-bodystruct.php
 * @param resource $imap_stream 
 * @param int $msg_number <p>
 * The message number
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-fetchbody.php
 * @param resource $imap_stream 
 * @param int $msg_number <p>
 * The message number
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-fetchmime.php
 * @param resource $imap_stream
 * @param int $msg_number <p>
 * The message number
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-savebody.php
 * @param resource $imap_stream 
 * @param mixed $file <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-fetchheader.php
 * @param resource $imap_stream 
 * @param int $msg_number <p>
 * The message number
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-fetchstructure.php
 * @param resource $imap_stream 
 * @param int $msg_number <p>
 * The message number
 * </p>
...
/**
 * Clears IMAP cache
 * @link https://secure.php.net/manual/en/function.imap-gc.php
 * @param resource $imap_stream 
 * @param int $caches <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-expunge.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-delete.php
 * @param resource $imap_stream 
 * @param int $msg_number <p>
 * The message number
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-undelete.php
 * @param resource $imap_stream 
 * @param int $msg_number <p>
 * The message number
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-check.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-listscan.php
 * @param resource $imap_stream 
 * @param string $ref <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-mail-copy.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-mail-move.php
 * @param resource $imap_stream 
 * @param string $msglist <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-mail-compose.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-createmailbox.php
 * @param resource $imap_stream 
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 ...
 * @link https://secure.php.net/manual/en/function.imap-renamemailbox.php
 * @param resource $imap_stream 
...
/**
 * Delete a mailbox
 * @link https://secure.php.net/manual/en/function.imap-deletemailbox.php
 * @param resource $imap_stream 
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 * information
 ...
 * @link https://secure.php.net/manual/en/function.imap-subscribe.php
 * @param resource $imap_stream 
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 * information
 ...
 * @link https://secure.php.net/manual/en/function.imap-unsubscribe.php
 * @param resource $imap_stream 
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 * information
 ...
 * @link https://secure.php.net/manual/en/function.imap-append.php
 * @param resource $imap_stream 
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 * information
 ...
 * @link https://secure.php.net/manual/en/function.imap-ping.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-base64.php
 * @param string $text <p>
 * The encoded text
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-qprint.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-8bit.php
 * @param string $string <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-binary.php
 * @param string $string <p>
 * The 8bit string
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-utf8.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-status.php
 * @param resource $imap_stream 
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 * information
 ...
 * @link https://secure.php.net/manual/en/function.imap-mailboxmsginfo.php
 * @param resource $imap_stream 
 * @return object the information in an object with following properties:
 * <table>
 * Mailbox properties
 ...
 * @link https://secure.php.net/manual/en/function.imap-setflag-full.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-clearflag-full.php
 * @param resource $imap_stream 
 * @param string $sequence <p>
 * A sequence of message numbers. You can enumerate desired messages
 * with the X,Y syntax, or retrieve all messages 
 ...
 * @link https://secure.php.net/manual/en/function.imap-sort.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-uid.php
 * @param resource $imap_stream 
 * @param int $msg_number <p>
 * The message number.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-msgno.php
 * @param resource $imap_stream 
 * @param int $uid <p>
 * The message UID
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-list.php
 * @param resource $imap_stream 
 * @param string $ref <p>
 * <i>ref</i> should normally be just the server
 * specification as described in <b>imap_open</b>.
 ...
 * @link https://secure.php.net/manual/en/function.imap-lsub.php
 * @param resource $imap_stream 
 * @param string $ref <p>
 * <i>ref</i> should normally be just the server
 * specification as described in <b>imap_open</b>
 ...
 * @link https://secure.php.net/manual/en/function.imap-fetch-overview.php
 * @param resource $imap_stream 
 * @param string $sequence <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-alerts.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-errors.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-last-error.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-utf7-decode.php
 * @param string $text <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-utf7-encode.php
 * @param string $data <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-mime-header-decode.php
 * @param string $text <p>
 * The MIME text
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-thread.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-timeout.php
 ...
 * @link https://secure.php.net/manual/en/function.imap-get-quota.php
 * @param resource $imap_stream 
 ...
 * @link https://secure.php.net/manual/en/function.imap-get-quotaroot.php
 * @param resource $imap_stream 
 * @param string $quota_root <p>
 * <i>quota_root</i> should normally be in the form of
 ...
 * @link https://secure.php.net/manual/en/function.imap-set-quota.php
 * @param resource $imap_stream 
 * @param string $quota_root <p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-setacl.php
 * @param resource $imap_stream 
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 * information
 ...
 * @link https://secure.php.net/manual/en/function.imap-getacl.php
 * @param resource $imap_stream 
 * @param string $mailbox <p>
 * The mailbox name, see <b>imap_open</b> for more
 * information
 ...
 * @link https://secure.php.net/manual/en/function.imap-mail.php
 * @param string $to <p>
 * The receiver
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.imap-header.php
 * @param resource $stream_id An IMAP stream returned by imap_open().
 * @param int $msg_no The message number
 * @param int $from_length [optional] Number of characters for the fetchfrom property. Must be greater than or equal to zero.
 * @param int $subject_length [optional] Number of characters for the fetchsubject property Must be greater than or equal to zero.
 ...
 * @link https://secure.php.net/manual/en/function.imap-listmailbox.php
 * @param $stream_id
 * @param $ref
 * @param $pattern
 * @since 4.0
 ...
 * @link https://secure.php.net/manual/en/function.imap-getmailboxes.php
 * @param resource $imap_stream 
 * @param string $ref <p>
 * <i>ref</i> should normally be just the server
 * specification as described in <b>imap_open</b>
 ...
 * @link https://secure.php.net/manual/en/function.imap-scanmailbox.php
 * @param $stream_id
 * @param $ref
 * @param $pattern
 * @param $content
 ...
 * @link https://secure.php.net/manual/en/function.imap-listsubscribed.php
 * @param $stream_id
 * @param $ref
 * @param $pattern
 * @since 4.0
...
/**
 * List all the subscribed mailboxes
 * @link https://secure.php.net/manual/en/function.imap-getsubscribed.php
 * @param resource $imap_stream 
 * @param string $ref <p>
 * <i>ref</i> should normally be just the server
 * specification as described in <b>imap_open</b>
...
/**
 * Alias of <b>imap_listscan</b>
 * @link https://secure.php.net/manual/en/function.imap-scan.php
 * @param $stream_id
 * @param $ref
 * @param $pattern
 * @param $content
 ...
 * @link https://secure.php.net/manual/en/function.imap-create.php
 * @param $stream_id
 * @param $mailbox
 * @since 4.0
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.imap-rename.php
 * @param $stream_id
 * @param $old_name
 * @param $new_name
 * @since 4.0
 ...
 * @link https://secure.php.net/manual/en/imap.constants.php
 */
