 ...
 * @see https://secure.php.net/manual/en/language.exceptions.php Exceptions in PHP
 * @link https://secure.php.net/manual/en/class.pdoexception.php
 */
 ...
 * @link https://secure.php.net/manual/en/class.pdo.php
 */
class PDO  {

	/**
	 * Represents a boolean data type.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-bool
	 */
	const PARAM_BOOL = 5;

	/**
	 * Represents the SQL NULL data type.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-null
	 */
	const PARAM_NULL = 0;

	/**
	 * Represents the SQL INTEGER data type.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-int
	 */
	const PARAM_INT = 1;

	/**
	 * Represents the SQL CHAR, VARCHAR, or other string data type.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-str
	 */
	const PARAM_STR = 2;
	 ...
	 * @since 7.2
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-str-natl
	 */
	 ...
	 * @since 7.2
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-str-char
	 */
	 ...
	 * @since 7.2
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-default-str-param
	 */
	 ...
	 * @since 7.1.4
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.sqlite-deterministic
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-lob
	 */
	const PARAM_LOB = 3;

	/**
	 * Represents a recordset type. Not currently supported by any drivers.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-stmt
	 */
	const PARAM_STMT = 4;
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-input-output
	 */
	const PARAM_INPUT_OUTPUT = 2147483648;

	/**
	 * Allocation event
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-evt-alloc
	 */
	const PARAM_EVT_ALLOC = 0;

	/**
	 * Deallocation event
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-evt-free
	 */
	const PARAM_EVT_FREE = 1;

	/**
	 * Event triggered prior to execution of a prepared statement.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-evt-exec-pre
	 */
	const PARAM_EVT_EXEC_PRE = 2;

	/**
	 * Event triggered subsequent to execution of a prepared statement.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-evt-exec-post
	 */
	const PARAM_EVT_EXEC_POST = 3;

	/**
	 * Event triggered prior to fetching a result from a resultset.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-evt-fetch-pre
	 */
	const PARAM_EVT_FETCH_PRE = 4;

	/**
	 * Event triggered subsequent to fetching a result from a resultset.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-evt-fetch-post
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.param-evt-normalize
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-lazy
	 */
	const FETCH_LAZY = 1;
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-assoc
	 */
	const FETCH_ASSOC = 2;
	 ...
	 * column 0.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-num
	 */
	const FETCH_NUM = 3;
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-both
	 */
	const FETCH_BOTH = 4;
	 ...
	 * set.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-obj
	 */
	const FETCH_OBJ = 5;
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-bound
	 */
	const FETCH_BOUND = 6;
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-column
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-class
	 */
	const FETCH_CLASS = 8;
	 ...
	 * requested class, mapping the columns to named properties in the class.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-into
	 */
	const FETCH_INTO = 9;
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-func
	 */
	const FETCH_FUNC = 10;
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-group
	 */
	const FETCH_GROUP = 65536;

	/**
	 * Fetch only the unique values.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-unique
	 */
	 ...
	 * is the value.
	 * @since 5.2.3
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-key-pair
	 */
	const FETCH_KEY_PAIR = 12;

	/**
	 * Determine the class name from the value of first column.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-classtype
	 */
	 ...
	 * flag is set.
	 * @since 5.1 Available
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-serialize
	 */
	 ...
	 * @since 5.2.0
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-props-late
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-named
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-autocommit
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-prefetch
	 */
	const ATTR_PREFETCH = 1;

	/**
	 * Sets the timeout value in seconds for communications with the database.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-timeout
	 */
	const ATTR_TIMEOUT = 2;

	/**
	 * @see https://secure.php.net/manual/en/pdo.error-handling.php Errors and error handling
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-errmode
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-client-version
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-server-info
	 */
	 ...
	 * constants.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-case
	 */
	const ATTR_CASE = 8;
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-cursor-name
	 */
	 ...
	 * scrollable cursor.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-cursor
	 */
	const ATTR_CURSOR = 10;

	/**
	 * Convert empty strings to SQL NULL values on data fetches.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-oracle-nulls
	 */
	const ATTR_ORACLE_NULLS = 11;

	/**
	 * Request a persistent connection, rather than creating a new connection.
	 * @see https://secure.php.net/manual/en/pdo.connections.php Connections and Connection Management
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-persistent
	 */
	const ATTR_PERSISTENT = 12;

	/**
	 * Sets the class name of which statements are returned as.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-statement-class
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-fetch-table-names
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-fetch-catalog-names
	 */
	 ...
	 * </code>
	 * </p>
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-driver-name
	 */
	const ATTR_DRIVER_NAME = 16;

	/**
	 * Forces all values fetched to be treated as strings.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-stringify-fetches
	 */
	const ATTR_STRINGIFY_FETCHES = 17;

	/**
	 * Sets the maximum column name length.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-max-column-len
	 */
	const ATTR_MAX_COLUMN_LEN = 18;

	/**
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-emulate-prepares
	 * @since 5.1.3
	 */
	const ATTR_EMULATE_PREPARES = 20;

	/**
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.attr-default-fetch-mode
	 * @since 5.2.0
	 */
	 ...
	 * @see https://secure.php.net/manual/en/pdo.error-handling.php  Errors and Error Handling
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.errmode-silent
	 */
	 ...
	 * @see https://secure.php.net/manual/en/pdo.error-handling.php  Errors and Error Handling
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.errmode-warning
	 */
	 ...
	 * @see https://secure.php.net/manual/en/pdo.error-handling.php  Errors and Error Handling
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.errmode-exception
	 */
	const ERRMODE_EXCEPTION = 2;

	/**
	 * Leave column names as returned by the database driver.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.case-natural
	 */
	const CASE_NATURAL = 0;

	/**
	 * Force column names to lower case.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.case-lower
	 */
	const CASE_LOWER = 2;

	/**
	 * Force column names to upper case.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.case-upper
	 */
	const CASE_UPPER = 1;

	/**
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.null-natural
	 */
	const NULL_NATURAL = 0;

	/**
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.null-empty-string
	 */
	const NULL_EMPTY_STRING = 1;

	/**
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.null-to-string
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.err-none
	 */
	const ERR_NONE = 00000;

	/**
	 * Fetch the next row in the result set. Valid only for scrollable cursors.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-ori-next
	 */
	 ...
	 * cursors.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-ori-prior
	 */
	const FETCH_ORI_PRIOR = 1;

	/**
	 * Fetch the first row in the result set. Valid only for scrollable cursors.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-ori-first
	 */
	const FETCH_ORI_FIRST = 2;

	/**
	 * Fetch the last row in the result set. Valid only for scrollable cursors.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-ori-last
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-ori-abs
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.fetch-ori-rel
	 */
	 ...
	 * pattern in PHP.
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.cursor-fwdonly
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.constants.php#pdo.constants.cursor-scroll
	 */
	 ...
	 * </code>
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-use-buffered-query
	 */
	 ...
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-local-infile
	 */
	 ...
	 * array when constructing a new database handle.
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-init-command
	 */
	 ...
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-max-buffer-size
	 */
	 ...
	 * configuration files.
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-read-default-file
	 */
	 ...
	 * configuration files.
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-read-default-group
	 */
	 ...
	 * compiled against mysqlnd.
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-compress
	 */
	 ...
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-direct-query
	 */
	 ...
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-found-rows
	 */
	 ...
	 * </p>
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-ignore-space
	 */
	 ...
	 * </p>
	 * @since 5.3.7
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-ssl-key
	 */
	 ...
	 * </p>
	 * @since 5.3.7
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-ssl-cert
	 */
	 ...
	 * </p>
	 * @since 5.3.7
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-ssl-ca
	 */
	 ...
	 * </p>
	 * @since 5.3.7
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-ssl-capath
	 */
	 ...
	 * </p>
	 * @since 5.3.7
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-cipher
	 */
	 ...
	 * @link https://secure.php.net/manual/en/ref.pdo-mysql.php#pdo.constants.mysql-attr-multi-statements
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.prepare.php
	 ...
	 * </p>
	 * @link https://secure.php.net/manual/en/pdo.begintransaction.php
	 ...
	 * @link https://secure.php.net/manual/en/pdo.commit.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 ...
	 * @link https://secure.php.net/manual/en/pdo.rollback.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * @throws PDOException if there is no active transaction.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdo.intransaction.php
	 ...
	 * @link https://secure.php.net/manual/en/pdo.exec.php
	 * @param string $statement <p>
	 ...
	 * @link https://secure.php.net/manual/en/pdo.query.php
	 * @param string $statement <p>
	 * The SQL statement to prepare and execute.
	 * </p>
	 * <p>
	 ...
	 * @link https://secure.php.net/manual/en/pdo.lastinsertid.php
	 ...
	 * @link https://secure.php.net/manual/en/pdo.errorcode.php
	 ...
	 * @link https://secure.php.net/manual/en/pdo.errorinfo.php
	 ...
	 * @link https://secure.php.net/manual/en/pdo.quote.php
	 ...
	 * @link https://secure.php.net/manual/en/pdo.getavailabledrivers.php
     ...
     * @link https://secure.php.net/manual/en/pdo.sqlitecreatefunction.php
 ...
 * @link https://secure.php.net/manual/en/class.pdostatement.php
 */
class PDOStatement implements Traversable {
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.execute.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.fetch.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.bindparam.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.bindcolumn.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.bindvalue.php
	 * @param mixed $parameter <p>
	 * Parameter identifier. For a prepared statement using named
	 * placeholders, this will be a parameter name of the form
	 * :name. For a prepared statement using
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.rowcount.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.fetchall.php
	 * @param int $fetch_style [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.fetchobject.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.errorcode.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.errorinfo.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.setattribute.php
	 * @param int $attribute
	 * @param mixed $value
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.getattribute.php
	 * @param int $attribute
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.columncount.php
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.getcolumnmeta.php
	 * @param int $column <p>
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.setfetchmode.php
	 * @param int $mode <p>
	 * The fetch mode must be one of the PDO::FETCH_* constants.
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.nextrowset.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.closecursor.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/pdostatement.debugdumpparams.php
