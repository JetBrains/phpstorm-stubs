 ...
 * @link https://secure.php.net/manual/en/function.hash.php
 * @param string $algo <p>
 ...
 * @link https://secure.php.net/manual/en/function.hash-file.php
 * @param string $algo <p>
 * Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..)
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.hash-hmac.php
 * @param string $algo <p>
 ...
 * @link https://secure.php.net/manual/en/function.hash-hmac-file.php
 * @param string $algo <p>
 * Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..) See <b>hash_algos</b> for a list of supported algorithms.
 * </p>
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.hash-init.php
 * @param string $algo <p>
 ...
 * @link https://secure.php.net/manual/en/function.hash-update.php
 ...
 * @link https://secure.php.net/manual/en/function.hash-update-stream.php
 * @param resource $context <p>
 * Hashing context returned by <b>hash_init</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.hash-update-file.php
 ...
 * @link https://secure.php.net/manual/en/function.hash-final.php
 * @param resource $context <p>
 * Hashing context returned by <b>hash_init</b>.
 * </p>
 * @param bool $raw_output [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.hash-copy.php
 * @param resource $context <p>
 * Hashing context returned by <b>hash_init</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.hash-algos.php
 ...
 * @link https://secure.php.net/manual/en/function.hash-hkdf.php
 ...
 * @link https://secure.php.net/manual/en/function.hash-pbkdf2.php
 * @param $algo
 * @param $password
 * @param $salt
 * @param $iterations
...
/**
 * Generates a key
 * @link https://secure.php.net/manual/en/function.mhash-keygen-s2k.php
 * @param int $hash <p>
 ...
 * @link https://secure.php.net/manual/en/function.mhash-get-block-size.php
 * @param int $hash <p>
 ...
 * @link https://secure.php.net/manual/en/function.mhash-get-hash-name.php
 * @param int $hash <p>
 * The hash ID. One of the <b>MHASH_hashname</b> constants.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mhash-count.php
...
/**
 * Computes hash
 * @link https://secure.php.net/manual/en/function.mhash.php
 * @param int $hash <p>
 * The hash ID. One of the <b>MHASH_hashname</b> constants.
 * </p>
 * @param string $data <p>
 ...
 * @link https://secure.php.net/manual/en/hash.constants.php
 */
define ('HASH_HMAC', 1);
