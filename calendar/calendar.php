 ...
 * @link https://secure.php.net/manual/en/function.jdtogregorian.php
 ...
 * @link https://secure.php.net/manual/en/function.gregoriantojd.php
 * @param int $month <p>
 ...
 * @link https://secure.php.net/manual/en/function.jdtojulian.php
 * @param int $julianday <p>
 * A julian day number as integer
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.juliantojd.php
 * @param int $month <p>
 * The month as a number from 1 (for January) to 12 (for December)
 * </p>
 * @param int $day <p>
 ...
 * @link https://secure.php.net/manual/en/function.jdtojewish.php
 ...
 * @link https://secure.php.net/manual/en/function.jewishtojd.php
 * @param int $month <p>
 ...
 * @link https://secure.php.net/manual/en/function.jdtofrench.php
 * @param int $juliandaycount
 ...
 * @link https://secure.php.net/manual/en/function.frenchtojd.php
 * @param int $month <p>
 ...
 * @link https://secure.php.net/manual/en/function.jddayofweek.php
 * @param int $julianday <p>
 * A julian day number as integer
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.jdmonthname.php
 * @param int $julianday
 * @param int $mode
 ...
 * @link https://secure.php.net/manual/en/function.easter-date.php
 ...
 * @link https://secure.php.net/manual/en/function.easter-days.php
 * @param int $year [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.unixtojd.php
 ...
 * @link https://secure.php.net/manual/en/function.jdtounix.php
 * @param int $jday <p>
 ...
 * @link https://secure.php.net/manual/en/function.cal-to-jd.php
 ...
 * @link https://secure.php.net/manual/en/function.cal-from-jd.php
 * @param int $jd <p>
 ...
 * @link https://secure.php.net/manual/en/function.cal-days-in-month.php
 * @param int $calendar <p>
 ...
 * @link https://secure.php.net/manual/en/function.cal-info.php
