 ...
 * @param string $file The path to the binary patch created by xdiff_string_bdiff() or xdiff_string_rabdiff() functio
 ...
 * @return mixed true if merge was successful, string with rejected chunks if it was not or false if an internal
 * error happened.
 */
 ...
 * @return mixed false if an internal error happened, string with rejected chunks if patch couldn't be applied
 ...
 * @return string string with binary diff containing differences between "old" and "new" data or false
 ...
 * @return string the patched string, or false on error.
 */
 ...
 * @param string $old_data First string with binary data. It acts as "old" data.
 * @param string $new_data Second string with binary data. It acts as "new" data.
 * @return string string with result or false if an internal error happened.
 */
 ...
 * @return string string with resulting diff or false if an internal error happened.
 */
 ...
 * @return mixed the merged string, false if an internal error happened, or true if merged string is empty.
 */
 ...
 * @param string $old_data First string with binary data. It acts as "old" data.
 * @param string $new_data Second string with binary data. It acts as "new" data.
 * @return string string with binary diff containing differences between "old" and "new" data or false if an internal error occurred.
 */
