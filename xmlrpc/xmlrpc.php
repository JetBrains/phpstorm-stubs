 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-encode.php
 * @param mixed $value
 * @return string
 * @since 4.1.0
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-decode.php
 * @param string $xml <p>
...
/**
 * Decodes XML into native PHP types
 * @link https://secure.php.net/manual/en/function.xmlrpc-decode-request.php
 * @param string $xml
 * @param string $method
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-encode-request.php
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-get-type.php
 * @param mixed $value <p>
 * PHP value
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-set-type.php
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-is-fault.php
 * @param array $arg <p>
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-server-create.php
 * @return resource
 * @since 4.1.0
 * @since 5.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-server-destroy.php
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-server-register-method.php
 * @param resource $server
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-server-call-method.php
 * @param resource $server
 * @param string $xml
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-parse-method-descriptions.php
 * @param string $xml
 * @return array
 * @since 4.1.0
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-server-add-introspection-data.php
 * @param resource $server
 * @param array $desc
 * @return int
 * @since 4.1.0
 ...
 * @link https://secure.php.net/manual/en/function.xmlrpc-server-register-introspection-callback.php
 * @param resource $server
 * @param string $function
 * @return bool
 * @since 4.1.0
