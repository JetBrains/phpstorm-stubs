...
class ZipArchive  {
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.open.php
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.close.php
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.getstatusstring.php
	 ...
	 * Add a new directory
	 * @link https://secure.php.net/manual/en/ziparchive.addemptydir.php
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.addfromstring.php
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.addfile.php
	 * @param string $filename <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.addglob.php
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.addpattern.php
	 * @param string $pattern <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.renameindex.php
	 * @param int $index <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.renamename.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.setarchivecomment.php
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.getarchivecomment.php
	 * @param int $flags [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.setcommentindex.php
	 * @param int $index <p>
	 * Index of the entry.
	 * </p>
	 * @param string $comment <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.setcommentname.php
	 * @param string $name <p>
	 * Name of the entry.
	 * </p>
	 * @param string $comment <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.setcompressionindex.php
     ...
     * @link https://secure.php.net/manual/en/ziparchive.setencryptionindex.php
     * @param int $index Index of the entry.
     ...
     * @link https://secure.php.net/manual/en/ziparchive.setencryptionname.php
     * @param string $name Name of the entry.
     * @param string $method The encryption method defined by one of the ZipArchive::EM_ constants.
     * @param string $password [optional] Optional password, default used when missing.
     * @return bool Returns TRUE on success or FALSE on failure.
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.getcommentindex.php
	 * @param int $index <p>
	 * Index of the entry
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.getcommentname.php
	 * @param string $name <p>
	 * Name of the entry
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.deleteindex.php
	 * @param int $index <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.deletename.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.statname.php
	 * @param string $name <p>
	 * Name of the entry
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.statindex.php
	 * @param int $index <p>
	 * Index of the entry
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.locatename.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.getnameindex.php
	 * @param int $index <p>
	 * Index of the entry.
	 * </p>
	 * @param int $flags [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.unchangearchive.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.unchangeall.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.unchangeindex.php
	 * @param int $index <p>
	 * Index of the entry.
	 * </p>
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.unchangename.php
	 * @param string $name <p>
	 * Name of the entry.
	 * </p>
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.extractto.php
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.getfromname.php
	 * @param string $name <p>
	 * Name of the entry
	 * </p>
	 * @param int $length [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.getfromindex.php
	 * @param int $index <p>
	 * Index of the entry
	 * </p>
	 * @param int $length [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/ziparchive.getstream.php
	 * @param string $name <p>
 ...
 * Open a ZIP file archive
 * @link https://secure.php.net/manual/en/function.zip-open.php
 * @param string $filename <p>
 * The file name of the ZIP archive to open.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.zip-close.php
 ...
 * @link https://secure.php.net/manual/en/function.zip-read.php
 * @param resource $zip <p>
 * A ZIP file previously opened with <b>zip_open</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.zip-entry-open.php
 * @param resource $zip <p>
 ...
 * @link https://secure.php.net/manual/en/function.zip-entry-close.php
 * @param resource $zip_entry <p>
 ...
 * @link https://secure.php.net/manual/en/function.zip-entry-read.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 * @param int $length [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.zip-entry-filesize.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.zip-entry-name.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.zip-entry-compressedsize.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.zip-entry-compressionmethod.php
 * @param resource $zip_entry <p>
 * A directory entry returned by <b>zip_read</b>.
 * </p>
