...
/**
 * Frees a private key
 * @link https://secure.php.net/manual/en/function.openssl-pkey-free.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkey-new.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkey-export.php
 * @param mixed $key
 * @param string $out
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkey-export-to-file.php
 * @param mixed $key
...
/**
 * Get a private key
 * @link https://secure.php.net/manual/en/function.openssl-pkey-get-private.php
 * @param $key
 * <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkey-get-public.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkey-get-details.php
 * @param resource $key <p>
 * Resource holding the key.
 * </p>
...
/**
 * Free key resource
 * @link https://secure.php.net/manual/en/function.openssl-free-key.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-get-privatekey.php
 * @param $key
 * <p>
 * <b><em>key</em></b> can be one of the following:
 * <ol>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-get-publickey.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-spki-new.php
 * @param resource $privkey <p>
 * <b>privkey</b> should be set to a private key that was
 * previously generated by {@link https://secure.php.net/en/manual/function.openssl-pkey-new.php openssl_pkey_new()} (or
 ...
 * @link https://secure.php.net/manual/en/function.openssl-spki-verify.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-spki-export-challenge.php
 * @param string $spkac <p>Expects a valid signed public key and challenge</p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-spki-export.php
 * @param string $spkac <p>Expects a valid signed public key and challenge</p>
 ...
 * @since 5.0
it
 * @link https://secure.php.net/manual/en/function.openssl-x509-read.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-x509-free.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-x509-parse.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-x509-checkpurpose.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-x509-check-private-key.php
 * @param mixed $cert <p>
 * The certificate.
 * </p>
 * @param mixed $key <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-x509-export.php
 * @param mixed $x509
 ...
 * @link https://secure.php.net/manual/en/function.openssl-x509-export-to-file.php
 * @param mixed $x509
 * @param string $outfilename <p>
 * Path to the output file.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkcs12-export.php
 * @param mixed $x509
 * @param string $out <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkcs12-export-to-file.php
 * @param mixed $x509
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkcs12-read.php
 * @param string $pkcs12
 * @param array $certs <p>
...
/**
 * Generates a CSR
 * @link https://secure.php.net/manual/en/function.openssl-csr-new.php
 * @param array $dn <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-csr-export.php
 * @param resource $csr
 * @param string $out
 * @param bool $notext [optional] &note.openssl.param-notext;
 * @return bool true on success or false on failure.
 ...
 * @link https://secure.php.net/manual/en/function.openssl-csr-export-to-file.php
 * @param resource $csr
 * @param string $outfilename <p>
 * Path to the output file.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-csr-sign.php
 * @param mixed $csr <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-csr-get-subject.php
 * @param mixed $csr
 ...
 * @link https://secure.php.net/manual/en/function.openssl-csr-get-public-key.php
 * @param mixed $csr
 * @param bool $use_shortnames [optional]
 * @return resource
 * @since 5.2.0
...
/**
 * Computes a digest
 * @link https://secure.php.net/manual/en/function.openssl-digest.php
 * @param string $data <p>
 * The data.
 * </p>
...
/**
 * Encrypts data
 * @link https://secure.php.net/manual/en/function.openssl-encrypt.php
 * @param string $data <p>
 * The data.
 * </p>
 * @param string $method <p>
...
/**
 * Decrypts data
 * @link https://secure.php.net/manual/en/function.openssl-decrypt.php
 * @param string $data <p>
 * The data.
 * </p>
 * @param string $method <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-cipher-iv-length.php
 * @param string $method <p>
 * The method.
 * </p>
...
/**
 * Generate signature
 * @link https://secure.php.net/manual/en/function.openssl-sign.php
 * @param string $data
...
/**
 * Verify signature
 * @link https://secure.php.net/manual/en/function.openssl-verify.php
 * @param string $data
...
/**
 * Seal (encrypt) data
 * @link https://secure.php.net/manual/en/function.openssl-seal.php
 * @param string $data
...
/**
 * Open sealed data
 * @link https://secure.php.net/manual/en/function.openssl-open.php
 * @param string $sealed_data
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkcs7-verify.php
 * @param string $filename <p>
 * Path to the message.
 * </p>
 * @param int $flags <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkcs7-decrypt.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkcs7-sign.php
 * @param string $infilename
 ...
 * @link https://secure.php.net/manual/en/function.openssl-pkcs7-encrypt.php
 * @param string $infile
 ...
 * @link https://secure.php.net/manual/en/function.openssl-private-encrypt.php
 * @param string $data
 ...
 * @link https://secure.php.net/manual/en/function.openssl-private-decrypt.php
 * @param string $data
 ...
 * @link https://secure.php.net/manual/en/function.openssl-public-encrypt.php
 * @param string $data
 ...
 * @link https://secure.php.net/manual/en/function.openssl-public-decrypt.php
 * @param string $data
 * @param string $decrypted
 * @param mixed $key <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-get-md-methods.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-get-cipher-methods.php
 * @param bool $aliases [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-dh-compute-key.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-random-pseudo-bytes.php
 * @param int $length <p>
 ...
 * @link https://secure.php.net/manual/en/function.openssl-error-string.php
 ...
 * @link https://secure.php.net/manual/en/function.openssl-get-cert-locations.php
 ...
 * <b>openssl_verify</b>.
 * @link https://secure.php.net/manual/en/openssl.constants.php
 */
...
/** @link https://secure.php.net/manual/en/openssl.ciphers.php */
