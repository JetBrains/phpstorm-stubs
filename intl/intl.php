...
class Collator {
     ...
     * </p>
     * </p>
     * @link https://secure.php.net/manual/en/intl.collator-constants.php
     */
     ...
     * Create a collator
     * @link https://secure.php.net/manual/en/collator.construct.php
     * @param string $locale
     */
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Create a collator
     * @link https://secure.php.net/manual/en/collator.create.php
     ...
     * @link https://secure.php.net/manual/en/collator.compare.php
     * @param string $str1 <p>
     ...
     * @link https://secure.php.net/manual/en/collator.sort.php
     * @param array $arr <p>
     ...
     * @link https://secure.php.net/manual/en/collator.sortwithsortkeys.php
     ...
     * @link https://secure.php.net/manual/en/collator.asort.php
     * @param array $arr <p>Array of strings to sort.</p>
     * @param int $sort_flag [optional] <p>
     * Optional sorting type, one of the following:
     * <p>
     ...
     * @link https://secure.php.net/manual/en/collator.getattribute.php
     * @param int $attr <p>
     ...
     * @link https://secure.php.net/manual/en/collator.setattribute.php
     ...
     * @link https://secure.php.net/manual/en/collator.getstrength.php
     ...
     * @link https://secure.php.net/manual/en/collator.setstrength.php
     ...
     * @link https://secure.php.net/manual/en/collator.getlocale.php
     ...
     * @link https://secure.php.net/manual/en/collator.geterrorcode.php
     ...
     * @link https://secure.php.net/manual/en/collator.geterrormessage.php
     ...
     * @link https://secure.php.net/manual/en/collator.getsortkey.php
     * @param string $str <p>
...
class NumberFormatter {
     ...
     * @link https://secure.php.net/manual/en/intl.numberformatter-constants.php
     */
     ...
     * @link https://secure.php.net/manual/en/numberformatter.create.php
     * @param string $locale <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Format a number
     * @link https://secure.php.net/manual/en/numberformatter.format.php
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Parse a number
     * @link https://secure.php.net/manual/en/numberformatter.parse.php
     * @param string $value
     * @param int $type [optional] <p>
     * The
     ...
     * @link https://secure.php.net/manual/en/numberformatter.formatcurrency.php
     * @param float $value <p>
     ...
     * @link https://secure.php.net/manual/en/numberformatter.parsecurrency.php
     * @param string $value
     * @param string $currency <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Set an attribute
     * @link https://secure.php.net/manual/en/numberformatter.setattribute.php
     * @param int $attr <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Get an attribute
     * @link https://secure.php.net/manual/en/numberformatter.getattribute.php
     * @param int $attr <p>
     * Attribute specifier - one of the
     * numeric attribute constants.
     * </p>
     ...
     * @link https://secure.php.net/manual/en/numberformatter.settextattribute.php
     * @param int $attr <p>
     * Attribute specifier - one of the
     * text attribute
     * constants.
     ...
     * @link https://secure.php.net/manual/en/numberformatter.gettextattribute.php
     * @param int $attr <p>
     * Attribute specifier - one of the
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Set a symbol value
     * @link https://secure.php.net/manual/en/numberformatter.setsymbol.php
     * @param int $attr <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Get a symbol value
     * @link https://secure.php.net/manual/en/numberformatter.getsymbol.php
     * @param int $attr <p>
     * Symbol specifier, one of the
     * format symbol constants.
     * </p>
     ...
     * @link https://secure.php.net/manual/en/numberformatter.setpattern.php
     ...
     * @link https://secure.php.net/manual/en/numberformatter.getpattern.php
     ...
     * @link https://secure.php.net/manual/en/numberformatter.getlocale.php
     * @param int $type [optional] <p>
     * You can choose between valid and actual locale (
     ...
     * @link https://secure.php.net/manual/en/numberformatter.geterrorcode.php
     ...
     * @link https://secure.php.net/manual/en/numberformatter.geterrormessage.php
...
class Normalizer {
     ...
     * @link https://secure.php.net/manual/en/normalizer.normalize.php
     ...
     * @link https://secure.php.net/manual/en/normalizer.isnormalized.php
     * @param string $input <p>The input string to normalize</p>
...
class Locale {
     ...
     * @link https://secure.php.net/manual/en/intl.locale-constants.php
     */
     ...
     * @link https://secure.php.net/manual/en/locale.getdefault.php
     ...
     * @link https://secure.php.net/manual/en/locale.setdefault.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getprimarylanguage.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getscript.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getregion.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getkeywords.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getdisplayscript.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getdisplayregion.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getdisplayname.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getdisplaylanguage.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getdisplayvariant.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.composelocale.php
     ...
     * @link https://secure.php.net/manual/en/locale.parselocale.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.getallvariants.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/locale.filtermatches.php
     ...
     * @link https://secure.php.net/manual/en/locale.lookup.php
    ...
    /**
     * @link https://secure.php.net/manual/en/locale.canonicalize.php
     * @param string $locale
     * @return string
     */
     ...
     * @link https://secure.php.net/manual/en/locale.acceptfromhttp.php
...
class MessageFormatter {
     ...
     * @link https://secure.php.net/manual/en/messageformatter.create.php
     * @param string $locale <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Format the message
     * @link https://secure.php.net/manual/en/messageformatter.format.php
     * @param array $args <p>
     ...
     * @link https://secure.php.net/manual/en/messageformatter.formatmessage.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/messageformatter.parse.php
     * @param string $value <p>
     * The string to parse
     * </p>
     ...
     * @link https://secure.php.net/manual/en/messageformatter.parsemessage.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/messageformatter.setpattern.php
     * @param string $pattern <p>
     ...
     * @link https://secure.php.net/manual/en/messageformatter.getpattern.php
     ...
     * @link https://secure.php.net/manual/en/messageformatter.getlocale.php
...
class IntlDateFormatter {
     ...
     * @link https://secure.php.net/manual/en/class.intldateformatter.php#intl.intldateformatter-constants
     */
    const FULL = 0;
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.create.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.getdatetype.php
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.gettimetype.php
     * @return int The current date type value of the formatter.
     */
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.getcalendar.php
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.setcalendar.php
     * @param int $which <p>
     * The calendar to use.
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.gettimezoneid.php
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.settimezoneid.php
     * @param string $zone <p>
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.settimezone.php
     * @param mixed $zone <p>
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.setpattern.php
     * @param string $pattern <p>
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.getpattern.php
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.getlocale.php
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.setlenient.php
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.islenient.php
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.format.php
     * @param mixed $value <p>
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.parse.php
     * @param string $value <p>
     ...
     * @link https://secure.php.net/manual/en/intldateformatter.localtime.php
     * @param string $value <p>
     * string to convert to a time
     * </p>
     * @param int $position [optional] <p>
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Get the error code from last operation
     * @link https://secure.php.net/manual/en/intldateformatter.geterrorcode.php
     * @return int The error code, one of UErrorCode values. Initial value is U_ZERO_ERROR.
     */
    public function getErrorCode() { }
     ...
     * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
     * Get the error text from the last operation.
     * @link https://secure.php.net/manual/en/intldateformatter.geterrormessage.php
     * @return string Description of the last error.
     */
    public function getErrorMessage() { }
}
...
class ResourceBundle implements Traversable {
     ...
     * @link https://secure.php.net/manual/en/resourcebundle.create.php
     * @param string $locale <p>
     ...
     * @link https://secure.php.net/manual/en/resourcebundle.get.php
     ...
     * @link https://secure.php.net/manual/en/resourcebundle.count.php
     ...
     * @link https://secure.php.net/manual/en/resourcebundle.locales.php
     * @param string $bundlename <p>
     ...
     * @link https://secure.php.net/manual/en/resourcebundle.geterrorcode.php
     ...
     * @link https://secure.php.net/manual/en/resourcebundle.geterrormessage.php
...
class Transliterator {
     ...
     * @link https://secure.php.net/manual/en/transliterator.construct.php
     */
     ...
     * @link https://secure.php.net/manual/en/transliterator.create.php
     * @param string $id <p>
     * The id.
     * </p>
     ...
     * @link https://secure.php.net/manual/en/transliterator.createfromrules.php
     ...
     * @link https://secure.php.net/manual/en/transliterator.createinverse.php
     * @return Transliterator a <b>Transliterator</b> object on success,
     * or <b>NULL</b> on failure
     */
     ...
     * @link https://secure.php.net/manual/en/transliterator.listids.php
     ...
     * @link https://secure.php.net/manual/en/transliterator.transliterate.php
     ...
     * (PHP &gt;= 5.4.0, PECL intl &gt;= 2.0.0)<br/>
     * Get last error code
     * @link https://secure.php.net/manual/en/transliterator.geterrorcode.php
     ...
     * @link https://secure.php.net/manual/en/transliterator.geterrormessage.php
...
/**
 * @link https://secure.php.net/manual/en/class.spoofchecker.php
 */
class Spoofchecker {
     ...
     * (PHP &gt;= 5.4.0, PECL intl &gt;= 2.0.0)<br/>
     * Constructor
     * @link https://secure.php.net/manual/en/spoofchecker.construct.php
     */
     ...
     * @link https://secure.php.net/manual/en/spoofchecker.issuspicious.php
     * @param string $text <p>
     * </p>
     ...
     * @link https://secure.php.net/manual/en/spoofchecker.areconfusable.php
     * @param string $s1 <p>
     * </p>
     * @param string $s2 <p>
     * </p>
     ...
     * @link https://secure.php.net/manual/en/spoofchecker.setallowedlocales.php
     ...
     * @link https://secure.php.net/manual/en/spoofchecker.setchecks.php
 ...
 * @link https://secure.php.net/manual/en/function.locale-get-default.php
 ...
 * @link https://secure.php.net/manual/en/function.locale-set-default.php
 * @param string $name <p>
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-strlen.php
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-strpos.php
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-stripos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-strrpos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-strripos.php
 * @param string $haystack <p>
 * The string to look in. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-substr.php
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-strstr.php
 * @param string $haystack <p>
 * The input string. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-stristr.php
 * @param string $haystack <p>
 * The input string. Must be valid UTF-8.
 * </p>
 * @param string $needle <p>
 ...
 * @link https://secure.php.net/manual/en/function.grapheme-extract.php
 * @param string $haystack <p>
 * String to search.
 * </p>
 * @param int $size <p>
 ...
 * @link https://secure.php.net/manual/en/function.idn-to-ascii.php
 ...
 * @link https://secure.php.net/manual/en/function.idn-to-utf8.php
 * @param string $domain <p>
 ...
 * @link https://secure.php.net/manual/en/function.intl-get-error-code.php
 ...
 * @link https://secure.php.net/manual/en/function.intl-get-error-message.php
 ...
 * @link https://secure.php.net/manual/en/function.intl-is-failure.php
 ...
 * @link https://secure.php.net/manual/en/function.intl-error-name.php
 * @param int $error_code <p>
 * ICU error code.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/intl.constants.php
 */
...
class UConverter {
     ...
     * @link https://secure.php.net/manual/en/uconverter.construct.php
     ...
     * @link https://secure.php.net/manual/en/uconverter.convert.php
     * @param string $str
     * @param bool $reverse
     * @return string
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.fromucallback.php
     * @param int $reason
     * @param string $source
     ...
     * @link https://secure.php.net/manual/en/uconverter.getaliases.php
     * @param string $name
     * @return array
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.getavailable.php
     * @return array
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.getdestinationencoding.php
     * @return string
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.getdestinationtype.php
     * @return int
     */
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Get last error code on the object
     * @link https://secure.php.net/manual/en/uconverter.geterrorcode.php
     * @return int
     */
    public function getErrorCode() { }
     ...
     * (PHP 5 &gt;=5.5.0)<br/>
     * Get last error message on the object
     * @link https://secure.php.net/manual/en/uconverter.geterrormessage.php
     * @return string
     */
    public function getErrorMessage() { }
     ...
     * @link https://secure.php.net/manual/en/uconverter.getsourceencoding.php
     * @return string
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.getsourcetype.php
     * @return int
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.getstandards.php
     * @return array
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.getsubstchars.php
     * @return string
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.reasontext.php
     * @param int $reason
     * @return string
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.setdestinationencoding.php
     ...
     * @link https://secure.php.net/manual/en/uconverter.setsourceencoding.php
     * @param string $encoding
     * @return void
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.setsubstchars.php
     * @param string $chars
     * @return void
     */
     ...
     * @link https://secure.php.net/manual/en/uconverter.toucallback.php
     * @param int $reason
     * @param string $source
     ...
     * @link https://secure.php.net/manual/en/uconverter.transcode.php
     * @param string $str
