...
/**
 * @link https://www.php.net/manual/en/ref.sqlite.php
 */
class SQLiteDatabase  {

	/**
	 * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
	 * @link https://www.php.net/manual/en/function.sqlite-open.php
	...
	/**
	 * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
	 * @link https://www.php.net/manual/en/function.sqlite-query.php
	 * @param string $query <p>
	 * The query to be executed.
	 * </p>
	 * <p>
	 * Data inside the query should be {@link https://www.php.net/manual/en/function.sqlite-escape-string.php properly escaped}.
	 * </p>
	...
	/**
	 * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
	 * @link https://www.php.net/manual/en/function.sqlite-exec.php
	 * @param string $query <p>
	 * The query to be executed.
	 * </p>
	 * <p>
	 ...
	 * {@link https://www.php.net/manual/en/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration
	 * option.</p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-array-query.php
	 * @param $query <p>
	 * The query to be executed.
	 * </p>
	 * <p>
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-single-query.php
	 * @param string $query
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-unbuffered-query.php
	 * @param string $query  <p>
	 * The query to be executed.
	 * </p>
	 * <p>
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-last-insert-rowid.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-changes.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-create-aggregate.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-create-function.php
	 * @param $function_name <p>The name of the function used in SQL statements.</p>
	 * @param $callback <p>
	 ...
	 * {@link https://www.php.net/manual/en/language.types.intro.php scalar type}).
	 * </p></blockquote>
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-busy-timeout.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-last-error.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-fetch-column-types.php
...
final class SQLiteResult implements Iterator, Countable {
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-fetch-array.php
	 ...
	 * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
	 * it applied to the data if it was encoded using the
	 *{@link https://www.php.net/manual/en/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case}. You should normally leave this
	 * value at its default, unless you are interoperating with databases created by
	 * other sqlite capable applications.</p>
	 * @return array <p>
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-fetch-single.php
	 * @param bool $decode_binary [optional]
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-column.php
	 * @param $index_or_name
	 * @param $decode_binary [optional] <p>When the <i>decode_binary</i>
	 * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
	 * it applied to the data if it was encoded using the
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-num-fields.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-field-name.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-current.php
	 * @param $result_type [optional] <p>The optional <i>result_type</i>
	 * parameter accepts a constant and determines how the returned array will be
	 * indexed. Using <b>SQLITE_ASSOC</b> will return only associative
	 * indices (named fields) while <b>SQLITE_NUM</b> will return
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-next.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-prev.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-has-prev.php
	 * @return bool <p>
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-num-rows.php
	 ...
	 * @link https://www.php.net/manual/en/function.sqlite-seek.php
	 * @param $row
	 * <p>
 ...
 * @link https://www.php.net/manual/en/function.sqlite-popen.php
 * @param string $filename <p>
 * The filename of the SQLite database. If the file does not exist, SQLite
 * will attempt to create it. PHP must have write permissions to the file
 * if data is inserted, the database schema is modified or to create the
 ...
 * @link https://www.php.net/manual/en/function.sqlite-close.php
 ...
 * @link https://www.php.net/manual/en/function.sqlite-fetch-string.php
 * @param resource $result <p>The SQLite result resource. This parameter is not required when using the object-oriented method.</p>
 * @param bool $decode_binary [optional] <p>When the <b>decode_binary</b>
 * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
 * it applied to the data if it was encoded using the
 ...
 * {@link https://www.php.net/manual/en/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration option.</p>
 */
 ...
 * @link https://www.php.net/manual/en/function.sqlite-libversion.php
 ...
 * @link https://www.php.net/manual/en/function.sqlite-libencoding.php
 ...
 * @link https://www.php.net/manual/en/function.sqlite-rewind.php
 * @param resource $result <p>
 * The SQLite result resource.  This parameter is not required when using
 * the object-oriented method.
 * </p>
 ...
 * @link https://www.php.net/manual/en/function.sqlite-valid.php
 * @param resource $result <p>
 * The SQLite result resource.  This parameter is not required when using
 * the object-oriented method.
 * </p>
 ...
 * @link https://www.php.net/manual/en/function.sqlite-has-more.php
 * @param resource $result <p>
 ...
 * @link https://www.php.net/manual/en/function.sqlite-escape-string.php
 * @param string $item <p>
 ...
 * @link https://www.php.net/manual/en/function.sqlite-error-string.php
 ...
 * @link https://www.php.net/manual/en/function.sqlite-factory.php
 * @param string $filename <p>
 ...
 * @link https://www.php.net/manual/en/function.sqlite-udf-encode-binary.php
 * @param string $data <p>
 ...
 * @link https://www.php.net/manual/en/function.sqlite-udf-decode-binary.php
 * @param string $data <p>
 ...
 * @link https://www.php.net/manual/en/sqlite.constants.php
 */
