...
/**
 * @link https://php-legacy-docs.zend.com/manual/php5/en/ref.sqlite
 */
class SQLiteDatabase
{
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-open
    ...
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-query
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     * Data inside the query should be {@link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-escape-string properly escaped}.
     * </p>
    ...
    /**
     * (PHP 5 &lt; 5.4.0, PECL sqlite &gt;= 1.0.0)
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-exec
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * {@link https://php-legacy-docs.zend.com/manual/php5/en/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration
     * option.</p>
     */
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-array-query
     * @param string $query <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-single-query
     * @param string $query
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-unbuffered-query
     * @param string $query  <p>
     * The query to be executed.
     * </p>
     * <p>
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-last-insert-rowid
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-changes
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-create-aggregate
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-create-function
     * @param string $function_name <p>The name of the function used in SQL statements.</p>
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-busy-timeout
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-last-error
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-fetch-column-types
...
final class SQLiteResult implements Iterator, Countable
{
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-fetch-array
     * @param int $result_type [optional]
     * <p>
     ...
     * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
     * it applied to the data if it was encoded using the
     * {@link https://php-legacy-docs.zend.com/manual/php5/en/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case}. You should normally leave this
     * value at its default, unless you are interoperating with databases created by
     * other sqlite capable applications.</p>
     * @return array
     * <p>
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-fetch-single
     * @param bool $decode_binary [optional]
     ...
     * (PHP 5 &lt; 5.4.0)
     * Fetches the next row from a result set as an object
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-fetch-all
     * @param int $result_type [optional] <p>
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-num-fields
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-field-name
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-current
     * @param int $result_type [optional] <p>The optional <i>result_type</i>
     * parameter accepts a constant and determines how the returned array will be
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-next
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-prev
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-num-rows
     ...
     * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-seek
     * @param $row
     * <p>
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-popen
 * @param string $filename <p>
 * The filename of the SQLite database. If the file does not exist, SQLite
 * will attempt to create it. PHP must have write permissions to the file
 * if data is inserted, the database schema is modified or to create the
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-close
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-fetch-string
 * @param resource $result <p>The SQLite result resource. This parameter is not required when using the object-oriented method.</p>
 * @param bool $decode_binary [optional] <p>When the <b>decode_binary</b>
 * parameter is set to <b>TRUE</b> (the default), PHP will decode the binary encoding
 * it applied to the data if it was encoded using the
 ...
 * {@link https://php-legacy-docs.zend.com/manual/php5/en/sqlite.configuration.php#ini.sqlite.assoc-case sqlite.assoc_case} configuration option.</p>
 */
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-libversion
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-libencoding
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-rewind
 * @param resource $result <p>
 * The SQLite result resource.  This parameter is not required when using
 * the object-oriented method.
 * </p>
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-valid
 * @param resource $result <p>
 * The SQLite result resource.  This parameter is not required when using
 * the object-oriented method.
 * </p>
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-has-more
 * @param resource $result <p>
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-escape-string
 * @param string $item <p>
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-error-string
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-factory
 * @param string $filename <p>
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-udf-encode-binary
 * @param string $data <p>
 ...
 * @link https://php-legacy-docs.zend.com/manual/php5/en/function.sqlite-udf-decode-binary
 * @param string $data <p>
