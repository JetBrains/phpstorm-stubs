...
/**
 * Class Judy.
 * @link https://secure.php.net/manual/en/class.judy.php
 */
class Judy implements ArrayAccess {
    /**
     * Define the Judy Array as a Bitset with keys as Integer and Values as a Boolean.
     * @link https://secure.php.net/manual/en/class.judy.php#judy.constants.bitset
     */
    const BITSET = 1;
    /**
     * Define the Judy Array with key/values as Integer, and Integer only.
     * @link https://secure.php.net/manual/en/class.judy.php#judy.constants.int-to-int
     */
    const INT_TO_INT = 2;
    /**
     * Define the Judy Array with keys as Integer and Values of any type.
     * @link https://secure.php.net/manual/en/class.judy.php#judy.constants.int-to-mixed
     */
    const INT_TO_MIXED = 3;
    /**
     * Define the Judy Array with keys as a String and Values as Integer, and Integer only.
     * @link https://secure.php.net/manual/en/class.judy.php#judy.constants.string-to-int
     */
    const STRING_TO_INT = 4;
    /**
     * Define the Judy Array with keys as a String and Values of any type.
     * @link https://secure.php.net/manual/en/class.judy.php#judy.constants.string-to-mixed
     */
     ...
     * @link https://secure.php.net/manual/en/judy.construct.php
     ...
     * @link https://secure.php.net/manual/en/judy.destruct.php
     */
     ...
     * @link https://secure.php.net/manual/en/judy.bycount.php
     ...
     * @link https://secure.php.net/manual/en/judy.count.php
     ...
     * @link https://secure.php.net/manual/en/judy.first.php
     ...
     * @link https://secure.php.net/manual/en/judy.firstempty.php
     * @param mixed $index [optional] <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://secure.php.net/manual/en/judy.free.php
     */
     ...
     * @link https://secure.php.net/manual/en/judy.gettype.php
     ...
     * @link https://secure.php.net/manual/en/judy.last.php
     * @param mixed $index [optional] <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://secure.php.net/manual/en/judy.lastempty.php
     * @param mixed $index [optional] <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://secure.php.net/manual/en/judy.memoryusage.php
     ...
     * @link https://secure.php.net/manual/en/judy.next.php
     ...
     * @link https://secure.php.net/manual/en/judy.nextempty.php
     * @param mixed $index <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://secure.php.net/manual/en/judy.offsetexists.php
     ...
     * @link https://secure.php.net/manual/en/judy.offsetget.php
     * @param mixed $offset <p>An offset to check for.</p>
     ...
     * @link https://secure.php.net/manual/en/judy.offsetset.php
     ...
     * (PECL judy &gt;= 0.1.1)<br/>
     * Unsets an offset.
     * @link https://secure.php.net/manual/en/judy.offsetunset.php
     * @param mixed $offset <p>The offset to assign the value to.</p>
     */
     ...
     * @link https://secure.php.net/manual/en/judy.prev.php
     * @param mixed $index <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://secure.php.net/manual/en/judy.prevempty.php
     * @param mixed $index <p>The index can be an integer or a string corresponding to the index where to start the search.</p>
     * @return mixed <p>Return the corresponding index in the array.</p>
     */
     ...
     * @link https://secure.php.net/manual/en/judy.size.php
     * @param int $index_start [optional] <p>Start counting from the given index. Default is first index.</p>
     * @param int $index_end [optional] <p>Stop counting when reaching this index. Default is last index.</p>
     * @return int <p>Return the number of elements.</p>
     */
