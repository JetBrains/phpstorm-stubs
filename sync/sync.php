 ...
 * @link https://secure.php.net/manual/en/book.sync.php
 */
/**
 * SyncMutex
 *
 ...
 *
 * @link https://secure.php.net/manual/en/class.syncmutex.php
 */
class SyncMutex {
    /**
     ...
     * @link https://secure.php.net/manual/en/syncmutex.construct.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncmutex.lock.php
     */
     ...
     * @see SyncMutex::lock()
     * @link https://secure.php.net/manual/en/syncmutex.unlock.php
     */
 ...
 *
 * @link https://secure.php.net/manual/en/class.syncsemaphore.php
 */
class SyncSemaphore {
    /**
     ...
     * @link https://secure.php.net/manual/en/syncsemaphore.construct.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncsemaphore.lock.php
     */
    public function lock ( int $wait = -1 ) {}
     ...
     * @link https://secure.php.net/manual/en/syncsemaphore.unlock.php
     */
 ...
 *
 * @link https://secure.php.net/manual/en/class.syncevent.php
 */
class SyncEvent {
    /**
     ...
     * @link https://secure.php.net/manual/en/syncevent.construct.php
     */
     ...
     * @see SyncEvent::wait()
     * @link https://secure.php.net/manual/en/syncevent.fire.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncevent.reset.php
     */
     ...
     * @return bool TRUE if the event was fired, FALSE otherwise.
     * @see SyncEvent::fire()
     * @link https://secure.php.net/manual/en/syncevent.wait.php
     */
 ...
 *
 * @link https://secure.php.net/manual/en/class.syncreaderwriter.php
 */
class SyncReaderWriter {
     ...
     * @link https://secure.php.net/manual/en/syncreaderwriter.construct.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncreaderwriter.readlock.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncreaderwriter.readunlock.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncreaderwriter.writelock.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncreaderwriter.writeunlock.php
     */
 ...
 *
 * @since 1.1.0
 * @link https://secure.php.net/manual/en/class.syncsharedmemory.php
 */
class SyncSharedMemory {
     ...
     * @link https://secure.php.net/manual/en/syncsharedmemory.construct.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncsharedmemory.first.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncsharedmemory.read.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncsharedmemory.size.php
     */
     ...
     * @link https://secure.php.net/manual/en/syncsharedmemory.write.php
     */
