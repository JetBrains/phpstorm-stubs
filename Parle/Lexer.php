...
class Lexer
{
     ...
     *
     * @link https://secure.php.net/manual/en/parle-lexer.advance.php
     * @return void
     */
     ...
     *
     * @see Lexer::push()
     * @link https://secure.php.net/manual/en/parle-lexer.build.php
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-lexer.callout.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-lexer.consume.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-lexer.dump.php
     * @return void
     */
     ...
     *
     * @see https://secure.php.net/manual/en/parle-lexer.insertmacro.php
