...
class RLexer
{
     ...
     *
     * @link https://secure.php.net/manual/en/parle-rlexer.advance.php
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-rlexer.build.php
     * @see RLexer::push()
     * @return void
     */
     ...
     *
     * @see https://secure.php.net/manual/en/parle-rlexer.callout.php
     ...
     *
     * @see https://secure.php.net/manual/en/parle-rlexer.consume.php
     ...
     *
     * @see https://secure.php.net/manual/en/parle-rlexer.dump.php
     * @return void
     */
     ...
     * @see RParser::tokenId()
     * @return void
     * @link https://secure.php.net/manual/en/parle-rlexer.push.php
     */
     ...
     *
     * @see RLexer::push()
     * @link https://secure.php.net/manual/en/parle-rlexer.pushstate.php
