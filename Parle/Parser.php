...
class Parser
{
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.advance.php
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.build.php
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.consume.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.dump.php
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.errorinfo.php
     * @return ErrorInfo
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.left.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.nonassoc.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.precedence.php
     * @param string $token
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.push.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.reset.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.right.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.sigil.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.token.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.tokenid.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.trace.php
     ...
     *
     * @link https://secure.php.net/manual/en/parle-parser.validate.php
