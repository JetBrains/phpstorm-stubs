...
class Parser
{
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.advance.php
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.build.php
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.consume.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.dump.php
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.errorinfo.php
     * @return ErrorInfo
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.left.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.nonassoc.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.precedence.php
     * @param string $token
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.push.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.reset.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.right.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.sigil.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.token.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.tokenid.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.trace.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-parser.validate.php
