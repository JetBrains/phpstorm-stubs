...
class RParser
{
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.advance.php
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.build.php
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.consume.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.dump.php
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.errorinfo.php
     * @return ErrorInfo
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.left.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.nonassoc.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.precedence.php
     * @param string $token
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.push.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.reset.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.right.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.sigil.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.token.php
     * @param string $token Token name.
     * @return void
     */
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.tokenid.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.trace.php
     ...
     *
     * @link https://www.php.net/manual/en/parle-rparser.validate.php
