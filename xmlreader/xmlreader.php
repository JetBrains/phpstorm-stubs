 ...
 * on the way.
 * @link https://secure.php.net/manual/en/class.xmlreader.php
 *
...
class XMLReader  {
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.close.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.getattribute.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.getattributeno.php
	 * @param int $index <p>
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.getattributens.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.getparserproperty.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.isvalid.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * @since 5.1.2
	 */
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.lookupnamespace.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.movetoattributeno.php
	 * @param int $index <p>
	 * The position of the attribute.
	 * </p>
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.movetoattribute.php
	 * @param string $name <p>
	 * The name of the attribute.
	 * </p>
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	...
	/**
	 * Move cursor to a named attribute
	 * @link https://secure.php.net/manual/en/xmlreader.movetoattributens.php
	 * @param string $localName <p>
	 * The local name.
	 * </p>
	 * @param string $namespaceURI <p>
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.movetoelement.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.movetofirstattribute.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * @since 5.1.2
	 */
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.movetonextattribute.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * @since 5.1.2
	 */
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.open.php
	 * @param string $URI <p>
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.read.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * @since 5.1.2
	 */
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.next.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.readinnerxml.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.readouterxml.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.readstring.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.setschema.php
	...
	/**
	 * Set parser options
	 * @link https://secure.php.net/manual/en/xmlreader.setparserproperty.php
	 * @param int $property <p>
	 * One of the parser option
	 * constants.
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.setrelaxngschema.php
	 * @param string $filename <p>
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.setrelaxngschemasource.php
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.xml.php
	 * @param string $source <p>
	 ...
	 * @link https://secure.php.net/manual/en/xmlreader.expand.php
