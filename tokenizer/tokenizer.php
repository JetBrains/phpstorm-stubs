...
define('T_ENDIF', 322);
define('T_PUBLIC', 356);
define('T_PROTECTED', 355);
define('T_PRIVATE', 354);
define('T_FINAL', 353);
define('T_ABSTRACT', 352);
define('T_STATIC', 351);
...
define('T_GOTO', 340);
define('T_FUNCTION', 341);
define('T_CONST', 343);
define('T_RETURN', 344);
define('T_TRY', 345);
define('T_CATCH', 346);
define('T_FINALLY', 347);
define('T_THROW', 258);
define('T_USE', 348);
define('T_INSTEADOF', 349);
define('T_GLOBAL', 350);
define('T_VAR', 357);
define('T_UNSET', 358);
define('T_ISSET', 359);
define('T_EMPTY', 360);
define('T_HALT_COMPILER', 361);
define('T_CLASS', 362);
define('T_TRAIT', 363);
define('T_INTERFACE', 364);
define('T_EXTENDS', 365);
define('T_IMPLEMENTS', 366);
define('T_OBJECT_OPERATOR', 381);
define('T_LIST', 368);
define('T_ARRAY', 369);
define('T_CALLABLE', 370);
define('T_LINE', 371);
define('T_FILE', 372);
define('T_DIR', 373);
define('T_CLASS_C', 374);
define('T_TRAIT_C', 375);
define('T_METHOD_C', 376);
define('T_FUNC_C', 377);
define('T_COMMENT', 382);
define('T_DOC_COMMENT', 383);
define('T_OPEN_TAG', 384);
define('T_OPEN_TAG_WITH_ECHO', 385);
define('T_CLOSE_TAG', 386);
define('T_WHITESPACE', 387);
define('T_START_HEREDOC', 388);
define('T_END_HEREDOC', 389);
define('T_DOLLAR_OPEN_CURLY_BRACES', 390);
define('T_CURLY_OPEN', 391);
define('T_PAAMAYIM_NEKUDOTAYIM', 392);
define('T_NAMESPACE', 367);
define('T_NS_C', 378);
define('T_NS_SEPARATOR', 393);
define('T_ELLIPSIS', 394);
define('T_DOUBLE_COLON', 392);
/**
 * @since 7.4
 */
define('T_FN', 342);
