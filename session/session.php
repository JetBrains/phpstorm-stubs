 ...
 * @link https://secure.php.net/manual/en/function.session-name.php
 ...
 * @link https://secure.php.net/manual/en/function.session-module-name.php
 ...
 * @link https://secure.php.net/manual/en/function.session-save-path.php
 ...
 * @link https://secure.php.net/manual/en/function.session-id.php
 ...
 * @link https://secure.php.net/manual/en/function.session-regenerate-id.php
 ...
 * @link https://secure.php.net/manual/en/function.session-decode.php
 * @param string $data <p>
 ...
 * @link https://secure.php.net/manual/en/function.session-register.php
 * @param mixed $name <p>
 ...
 * @link https://secure.php.net/manual/en/function.session-unregister.php
 * @param string $name <p>
 * The variable name.
 * </p>
 * @return bool true on success or false on failure.
 ...
 * @link https://secure.php.net/manual/en/function.session-is-registered.php
 * @param string $name <p>
 * The variable name.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.session-encode.php
 ...
 * @link https://secure.php.net/manual/en/function.session-start.php
 ...
 * @link https://secure.php.net/manual/en/function.session-destroy.php
 * @return bool true on success or false on failure.
 * @since 4.0
 * @since 5.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.session-unset.php
 * @return void
 * @since 4.0
 * @since 5.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.session-cache-limiter.php
 ...
 * @link https://secure.php.net/manual/en/function.session-cache-expire.php
 ...
 * @link https://secure.php.net/manual/en/function.session-set-cookie-params.php
 ...
 * @link https://secure.php.net/manual/en/function.session-get-cookie-params.php
 ...
 * @link https://secure.php.net/manual/en/function.session-write-close.php
 * @return void
 * @since 4.0.4
 * @since 5.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.session-commit.php
 * @since 4.4.0
 * @since 5.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.session-status.php
 ...
 * @link https://secure.php.net/manual/en/function.session-abort.php
 ...
 * @link https://secure.php.net/manual/en/function.session-reset.php
 * @return bool true if a session was successfully reinitialized or false on failure.
 */
