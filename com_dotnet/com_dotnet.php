 ...
 * @link https://secure.php.net/manual/en/class.com.php
 */
class COM {
 ...
 * @link https://secure.php.net/manual/en/class.dotnet.php
 */
class DOTNET {
 ...
 * @link https://secure.php.net/manual/en/class.variant.php
 */
class VARIANT {
 ...
 * @link https://secure.php.net/manual/en/function.com-create-guid.php
 * @return string
 */
 ...
 * @link https://secure.php.net/manual/en/function.com-event-sink.php
 ...
 * @link https://secure.php.net/manual/en/function.com-get-active-object.php
 * @param string $progid
 ...
 * @link https://secure.php.net/manual/en/function.com-message-pump.php
 ...
 * @link https://secure.php.net/manual/en/function.com-print-typeinfo.php
 ...
 * @link https://secure.php.net/manual/en/function.variant-abs.php
 * @param mixed $val
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-and.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-cast.php
 ...
 * @link https://secure.php.net/manual/en/function.variant-cat.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-cmp.php
 * @param mixed $left
 * @param mixed $right
 ...
 * @link https://secure.php.net/manual/en/function.variant-date-from-timestamp.php
 * @param int $timestamp
 * @return \VARIANT
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-date-to-timestamp.php
 * @param \VARIANT $variant
 * @return int
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-div.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-eqv.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-fix.php
 * @param mixed $variant
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-get-type.php
 * @param mixed $variant
 * @return int
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-idiv.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-imp.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * (PHP 5, PHP 7)<br/>
 * Returns the integer portion of a variant
 * @link https://secure.php.net/manual/en/function.variant-int.php
 * @param mixed $variant
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-mod.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-mul.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-neg.php
 * @param mixed $variant
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-not.php
 * @param mixed $variant
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-or.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-pow.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-round.php
 * @param mixed $variant
 * @param int $decimals
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-set-type.php
 * @param mixed $variant
 * @param int $type
 * @return void
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-set.php
 * @param mixed $variant
 * @param mixed $value
 * @return void
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-sub.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
 ...
 * @link https://secure.php.net/manual/en/function.variant-xor.php
 * @param mixed $left
 * @param mixed $right
 * @return mixed
 */
