<?php
/** GNUPG Constants
 * @link https://secure.php.net/manual/en/gnupg.constants.php
 */
 ...
 * @link https://secure.php.net/manual/en/book.gnupg.php
 * Class gnupg
 */
...
class gnupg {
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-adddecryptkey.php
	 * @phpstub
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-verify.php
	 * @phpstub
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-addencryptkey.php
	 * @phpstub
	 *
	 * @param string $fingerprint
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-addsignkey.php
	 * @phpstub
	 *
	 * @param string $fingerprint
	 * @param string $passphrase
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-cleardecryptkeys.php
	 * @phpstub
	 *
	 * @return bool
	 */
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-clearencryptkeys.php
	 * @phpstub
	 *
	 *
	 * @return bool
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-clearsignkeys.php
	 * @phpstub
	 *
	 *
	 * @return bool
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-decrypt.php
	 * @phpstub
	 *
	 * @param string $text
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-decryptverify.php
	 * @phpstub
	 *
	 * @param string $text
	 * @param string $plaintext
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-encrypt.php
	 * @phpstub
	 *
	 * @param string $plaintext
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-encryptsign.php
	 * @phpstub
	 *
	 * @param string $plaintext
	 *
	...
	/**
	 * Exports a key
	 * @link https://secure.php.net/manual/en/function.gnupg-export.php
	 * @phpstub
	 *
	 * @param string $fingerprint
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-geterror.php
	 * @phpstub
	 *
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-getprotocol.php
	 * @phpstub
	 *
	 *
	...
	/**
	 * Imports a key
	 * @link https://secure.php.net/manual/en/function.gnupg-import.php
	 * @phpstub
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-init.php
	 * @phpstub
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-keyinfo.php
	 * @phpstub
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-setarmor.php
	 * @phpstub
	 *
	 * @param int $armor
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-seterrormode.php
	 * @phpstub
	 *
	 * @param int $errormode
	 *
	 ...
	 * @link https://secure.php.net/manual/en/function.gnupg-setsignmode.php
	 * @phpstub
	 *
	 * @param int $signmode
	 *
	...
	/**
	 * Signs a given text
	 * @link https://secure.php.net/manual/en/function.gnupg-sign.php
	 * @phpstub
	 *
	 * @param string $plaintext
	 *
