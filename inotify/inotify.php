 ...
 *
 * @link https://www.php.net/manual/en/function.inotify-add-watch.php
 *
 * @param resource $inotify_instance <p>resource returned by {@link https://www.php.net/manual/en/function.inotify-init.php inotify_init()}</p>
 * @param string   $pathname         <p>File or directory to watch</p>
 * @param int      $mask             <p>Events to watch for. See {@link https://www.php.net/manual/en/inotify.constants.php Predefined Constants}.</p>
 *
 ...
 *
 * @link https://www.php.net/manual/en/function.inotify-init.php
 ...
 *
 * @link https://www.php.net/manual/en/function.inotify-queue-len.php
 *
 * @param resource $inotify_instance <p>resource returned by {@link https://www.php.net/manual/en/function.inotify-init.php inotify_init()}</p>
 *
 ...
 *
 * @link https://www.php.net/manual/en/function.inotify-read.php
 *
 * @param resource $inotify_instance <p>resource returned by {@link https://www.php.net/manual/en/function.inotify-init.php inotify_init()}</p>
 *
...
/**
 * @link https://www.php.net/manual/en/inotify.constants.php
 */
const IN_ACCESS = 1;
/**
 * @link https://www.php.net/manual/en/inotify.constants.php
