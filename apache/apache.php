 ...
 * @link https://secure.php.net/manual/en/function.apache-child-terminate.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-get-modules.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-get-version.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-getenv.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-lookup-uri.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-note.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-request-headers.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-reset-timeout.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-response-headers.php
 ...
 * @link https://secure.php.net/manual/en/function.apache-setenv.php
 * @param string $variable <p>
 ...
 * @link https://secure.php.net/manual/en/function.getallheaders.php
 * @return array|false An associative array of all the HTTP headers in the current request, or <b>FALSE</b> on failure.
 * @since 4.0
 * @since 5.0
 */
 ...
 * This function is supported when PHP is installed as an Apache module or by the NSAPI server module in Netscape/iPlanet/SunONE webservers.
 * @link hhttps://secure.php.net/manual/en/function.virtual.php
 * @param string $filename <p>
