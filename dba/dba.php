...
/**
 * Open database
 * @link https://secure.php.net/manual/en/function.dba-open.php
 * @param string $path <p>
 ...
 * @link https://secure.php.net/manual/en/function.dba-popen.php
 * @param string $path <p>
 * Commonly a regular path in your filesystem.
 * </p>
 * @param string $mode <p>
 ...
 * @link https://secure.php.net/manual/en/function.dba-close.php
 ...
 * @link https://secure.php.net/manual/en/function.dba-delete.php
 * @param string $key <p>
 ...
 * @link https://secure.php.net/manual/en/function.dba-exists.php
 * @param string $key <p>
 ...
 * @link https://secure.php.net/manual/en/function.dba-fetch.php
 * @param string $key <p>
...
/**
 * Insert entry
 * @link https://secure.php.net/manual/en/function.dba-insert.php
 * @param string $key <p>
 ...
 * @link https://secure.php.net/manual/en/function.dba-replace.php
 * @param string $key <p>
...
/**
 * Fetch first key
 * @link https://secure.php.net/manual/en/function.dba-firstkey.php
 * @param resource $handle <p>
 * The database handler, returned by <b>dba_open</b> or
 * <b>dba_popen</b>.
 * </p>
...
/**
 * Fetch next key
 * @link https://secure.php.net/manual/en/function.dba-nextkey.php
 * @param resource $handle <p>
 * The database handler, returned by <b>dba_open</b> or
 * <b>dba_popen</b>.
 * </p>
...
/**
 * Optimize database
 * @link https://secure.php.net/manual/en/function.dba-optimize.php
 * @param resource $handle <p>
 * The database handler, returned by <b>dba_open</b> or
 * <b>dba_popen</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.dba-sync.php
 * @param resource $handle <p>
 * The database handler, returned by <b>dba_open</b> or
 * <b>dba_popen</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.dba-handlers.php
 ...
 * @link https://secure.php.net/manual/en/function.dba-list.php
 ...
 * @link https://secure.php.net/manual/en/function.dba-key-split.php
 * @param mixed $key <p>
