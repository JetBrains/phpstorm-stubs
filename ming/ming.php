...
/**
 * Set cubic threshold
 * @link https://secure.php.net/manual/en/function.ming-setcubicthreshold.php
 ...
 * @link https://secure.php.net/manual/en/function.ming-setscale.php
 * @param $scale int <p>
 * The scale to be set.
 * </p>
 * @return void 
 ...
 * @link https://secure.php.net/manual/en/function.ming-useswfversion.php
 * @param $version int <p>
 * SWF version to use.
 * </p>
 * @return void 
 ...
 * @link https://secure.php.net/manual/en/function.ming-keypress.php
 * @param $char string 
...
/**
 * Use constant pool
 * @link https://secure.php.net/manual/en/function.ming-useconstants.php
 * @param $use int <p>
 * Its description
 * </p>
 * @return void 
 ...
 * @link https://secure.php.net/manual/en/function.ming-setswfcompression.php
 * @param $level int <p>
