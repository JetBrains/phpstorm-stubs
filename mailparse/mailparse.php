 ...
 * @link https://secure.php.net/manual/en/function.mailparse-determine-best-xfer-encoding.php
 * @param resource $fp <p>
 * A valid file pointer, which must be seek-able.
 * </p>
 * @return string Returns one of the character encodings supported by the
 * {@link https://secure.php.net/manual/en/ref.mbstring.php mbstring} module.
 */
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-create.php
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-extract-part-file.php
 * @param resource $mimemail <p>
 * A valid MIME resource, created with {@link https://secure.php.net/manual/en/function.mailparse-msg-create.php mailparse_msg_create()}.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-extract-part.php
 * @param resource $mimemail <p>
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-extract-whole-part-file.php
 * @param resource $mimemail <p>
 * A valid MIME resource
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-free.php
 * @param resource $mimemail <p>
 * A valid MIME resource allocated by
 * {@link https://secure.php.net/manual/en/function.mailparse-msg-create.php mailparse_msg_create()} or
 * {@link https://secure.php.net/manual/en/function.mailparse-msg-parse-file.php mailparse_msg_parse_file()}.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-get-part-data.php
 * @param resource $mimemail <p>
 * A valid MIME resource.
 * </p>
 * @return array
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-get-part.php
 * @param resource $mimemail <p>
 * A valid MIME resource.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-get-structure.php
 * @param resource $mimemail <p>
 * A valid MIME resource.
 * </p>
 * @return array
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-parse-file.php
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-msg-parse.php
 * @param resource $mimemail <p>
 * A valid MIME resource.
 * </p>
 * @param string $data
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-rfc822-parse-addresses.php
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-stream-encode.php
 ...
 * One of the character encodings supported by the {@link https://secure.php.net/manual/en/ref.mbstring.php mbstring} module.
 * </p>
 * @return bool Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
 */
 ...
 * @link https://secure.php.net/manual/en/function.mailparse-uudecode-all.php
 * @param resource $fp <p>
