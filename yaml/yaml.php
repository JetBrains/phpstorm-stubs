 ...
 * @link https://secure.php.net/manual/en/yaml.constants.php
 */
 ...
 * @link https://secure.php.net/manual/en/function.yaml-emit-file.php
...
/**
 * (PHP 5 &gt;= 5.2.0, PECL yaml &gt;= 0.5.0)<br/>
 * @link https://secure.php.net/manual/en/function.yaml-emit.php
 * @param mixed $data The data being encoded. Can be any type except a resource.
 ...
 * @link https://secure.php.net/manual/en/function.yaml-parse-file.php
 * @param string $filename Path to the file.
 ...
 * @link https://secure.php.net/manual/en/function.yaml-parse-url.php
 ...
 * (PHP 5 &gt;= 5.2.0, PECL yaml &gt;= 0.4.0)<br/>
 * Parse a YAML stream
 * @link https://secure.php.net/manual/en/function.yaml-parse.php
