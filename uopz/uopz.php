 ...
 * @link https://www.php.net/manual/en/uopz.constants.php#constant.zend-acc-public
 */
define('ZEND_ACC_PUBLIC', 256);

/**
 * Mark function as protected
 * @link https://www.php.net/manual/en/uopz.constants.php#constant.zend-acc-protected
 */
define('ZEND_ACC_PROTECTED', 512);

/**
 * Mark function as private
 * @link https://www.php.net/manual/en/uopz.constants.php#constant.zend-acc-private
 */
define('ZEND_ACC_PRIVATE', 1024);

/**
 * Mark function as static
 * @link https://www.php.net/manual/en/uopz.constants.php#constant.zend-acc-static
 */
define('ZEND_ACC_STATIC', 1);

/**
 * Mark function as final
 * @link https://www.php.net/manual/en/uopz.constants.php#constant.zend-acc-final
 */
define('ZEND_ACC_FINAL', 4);

/**
 * Mark function as abstract
 * @link https://www.php.net/manual/en/uopz.constants.php#constant.zend-acc-abstract
 */
define('ZEND_ACC_ABSTRACT', 2);

/**
 * Used for getting flags only
 * @link https://www.php.net/manual/en/uopz.constants.php#constant.zend-acc-fetch
 */
 ...
 * @link  https://www.php.net/manual/en/function.uopz-add-function.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-allow-exit.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-del-function.php
 * @param string $class The name of the class
 * @param string $function The name of the method
 * @param bool $all Whether all classes that descend from class will also be affected
 * @return bool TRUE on success or FALSE on failure
 ...
 * @link https://www.php.net/manual/en/function.uopz-extend.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-flags.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-get-exit-status.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-get-hook.php
 * @param string $class The name of the class
 * @param string $function The name of the method
 ...
 * @link https://www.php.net/manual/en/function.uopz-get-mock.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-get-property.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-get-return.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-get-static.php
 * @param string $class The name of the class
 * @param string $function The name of the method
 ...
 * @link https://www.php.net/manual/en/function.uopz-implement.php
 * @param string $class The name of the class
...
/**
 * Redefine a constant
 * @link https://www.php.net/manual/en/function.uopz-redefine.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-set-hook.php
 * @param string $class The name of the class
 * @param string $function The name of the method
 ...
 * @link https://www.php.net/manual/en/function.uopz-set-mock.php
 ...
 * @link https://www.php.net/manual/en/function.uopz-set-property.php
 * @param string|object $class The name of the class or the object instance
 * @param string $property The name of the property
 ...
 * @link https://www.php.net/manual/en/function.uopz-set-return.php
 * @param string $class The name of the class containing the function
 ...
 * @link https://www.php.net/manual/en/function.uopz-set-static.php
 * @param string $class The name of the class
 * @param string $function The name of the method
...
/**
 * Undefine a constant
 * @link https://www.php.net/manual/en/function.uopz-undefine.php
 * @param string $class The name of the class containing the constant
 * @param string $constant The name of the constant
 * @return bool
 * @since 5.4
 ...
 * @link https://www.php.net/manual/en/function.uopz-unset-hook.php
 * @param string $class The name of the class
 * @param string $function The name of the method
 * @return bool TRUE on success or FALSE on failure
 */
 ...
 * @link https://www.php.net/manual/en/function.uopz-unset-mock.php
 * @param string $class The name of the mocked class
 * @return void
 * @since 7.0
 */
 ...
 * @link https://www.php.net/manual/en/function.uopz-unset-return.php
 * @param string $class The name of the class containing the function
 * @param string $function The name of an existing function
 * @return bool
 * @since 7.0
