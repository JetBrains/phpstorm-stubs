 ...
 * @link https://secure.php.net/manual/en/function.pspell-new.php
 ...
 * @link https://secure.php.net/manual/en/function.pspell-new-personal.php
 ...
 * @link https://secure.php.net/manual/en/function.pspell-new-config.php
 * @param int $config <p>
...
/**
 * Check a word
 * @link https://secure.php.net/manual/en/function.pspell-check.php
 ...
 * @link https://secure.php.net/manual/en/function.pspell-suggest.php
 * @param int $dictionary_link
 * @param string $word <p>
 * The tested word.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.pspell-store-replacement.php
 ...
 * @link https://secure.php.net/manual/en/function.pspell-add-to-personal.php
 * @param int $dictionary_link
 * @param string $word <p>
 * The added word.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.pspell-add-to-session.php
 * @param int $dictionary_link
 * @param string $word <p>
 * The added word.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.pspell-clear-session.php
 * @param int $dictionary_link
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 4.0.2
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.pspell-save-wordlist.php
 * @param int $dictionary_link <p>
 * A dictionary link identifier opened with
 * <b>pspell_new_personal</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-create.php
 * @param string $language <p>
 * The language parameter is the language code which consists of the
 * two letter ISO 639 language code and an optional two letter ISO
 * 3166 country code after a dash or underscore.
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-runtogether.php
 * @param int $dictionary_link
 * @param bool $flag <p>
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-mode.php
 * @param int $dictionary_link
 * @param int $mode <p>
 * The mode parameter is the mode in which spellchecker will work.
 * There are several modes available:
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-ignore.php
 * @param int $dictionary_link
 * @param int $n <p>
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-personal.php
 * @param int $dictionary_link
 * @param string $file <p>
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-dict-dir.php
 * @param int $conf
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-data-dir.php
 * @param int $conf
 * @param string $directory
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-repl.php
 * @param int $dictionary_link
 * @param string $file <p>
 * The file should be writable by whoever PHP runs as (e.g. nobody).
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.pspell-config-save-repl.php
 * @param int $dictionary_link
 * @param bool $flag <p>
