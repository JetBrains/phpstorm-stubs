...
class MongoClient
{
     ...
     * @link https://secure.php.net/manual/en/mongo.construct.php
     ...
     *         connection {@link https://secure.php.net/manual/en/mongo.connecting.ssl.php#mongo.connecting.context.ssl context options for SSL}
     *         or {@link https://secure.php.net/manual/en/context.mongodb.php logging callbacks}.
     *         </p><ul>
     *         <li>
     *         <p>
     *         <em>"context"</em>
     ...
     *         {@link https://secure.php.net/manual/en/context.ssl.php SSL context options}. See the
     *         {@link https://secure.php.net/manual/en/mongo.connecting.ssl.php#mongo.connecting.context.ssl Connecting over SSL} tutorial.
     *         </p>
     *         </li>
     *         </ul>
     ...
     * (PECL mongo &gt;= 1.3.0)<br/>
     * Gets a database
     * @link https://secure.php.net/manual/en/mongoclient.get.php
     ...
     * @link https://secure.php.net/manual/en/mongoclient.listdbs.php
...
class Mongo extends MongoClient {
     ...
     * @link https://secure.php.net/manual/en/mongo.getpoolsize.php
     ...
     * @link https://secure.php.net/manual/en/mongo.getslave.php
     ...
     * @link https://secure.php.net/manual/en/mongo.getslaveokay.php
    ...
    */
     ...
     * @link https://secure.php.net/manual/en/mongo.pooldebug.php
     ...
     * @link https://secure.php.net/manual/en/mongo.setslaveokay.php
     ...
     * @link https://secure.php.net/manual/en/mongo.setpoolsize.php
...
class MongoDB {
	/**
	 * Profiling is off.
     * @link https://secure.php.net/manual/en/class.mongodb.php#mongodb.constants.profiling-off
	 */
    const PROFILING_OFF = 0;

	/**
	 * Profiling is on for slow operations (>100 ms).
     * @link https://secure.php.net/manual/en/class.mongodb.php#mongodb.constants.profiling-slow
	 */
    const PROFILING_SLOW = 1;

	/**
	 * Profiling is on for all operations.
     * @link https://secure.php.net/manual/en/class.mongodb.php#mongodb.constants.profiling-on
	 */
     ...
     * Inherited by instances of {@link https://secure.php.net/manual/en/class.mongocollection.php MongoCollection} derived
     ...
     * ( {@link https://secure.php.net/manual/en/mongocollection.insert.php MongoCollection::insert()},
     * {@link https://secure.php.net/manual/en/mongocollection.update.php MongoCollection::update()},
     * {@link https://secure.php.net/manual/en/mongocollection.remove.php MongoCollection::remove()},
     * {@link https://secure.php.net/manual/en/mongocollection.save.php MongoCollection::save()}, and
     * {@link https://secure.php.net/manual/en/mongocollection.ensureindex.php MongoCollection::ensureIndex()} all support this
     ...
     * {@link https://secure.php.net/manual/en/class.mongocursorexception.php MongoCursorException}. It is tempting to set
    ...
    */
     ...
     * @link https://secure.php.net/manual/en/mongodb.setslaveokay.php
    ...
    */
     ...
     * @link https://secure.php.net/manual/en/mongodb.getwriteconcern.php
     * @return array <p>This function returns an array describing the write concern.
     * The array contains the values w for an integer acknowledgement level or string mode,
     * and wtimeout denoting the maximum number of milliseconds to wait for the server to satisfy the write concern.</p>
     */
    ...
    */
    ...
    /**
     * (PECL mongo &gt;= 1.5.0)<br/>
     * @link https://secure.php.net/manual/en/mongodb.setwriteconcern.php
...
class MongoCollection {
     /**
     * @link https://secure.php.net/manual/en/class.mongocollection.php#mongocollection.constants.ascending
     */
    const ASCENDING = 1;

     /**
     * @link https://secure.php.net/manual/en/class.mongocollection.php#mongocollection.constants.descending
     */
    const DESCENDING = -1;
    ...
    */
     ...
     * {@link https://secure.php.net/manual/en/mongocollection.aggregate.php MongoCollection::aggregate()}.
     * This method returns a {@link https://secure.php.net/manual/en/class.mongocommandcursor.php MongoCommandCursor} object.
     * This cursor object implements the {@link https://secure.php.net/manual/en/class.iterator.php Iterator} interface
     * just like the {@link https://secure.php.net/manual/en/class.mongocursor.php MongoCursor} objects that are returned
     * by the {@link https://secure.php.net/manual/en/mongocollection.find.php MongoCollection::find()} method
     * </p>
     *
     * @link https://secure.php.net/manual/en/mongocollection.aggregatecursor.php
     *
     ...
     *
     * @return MongoCommandCursor Returns a {@link https://secure.php.net/manual/en/class.mongocommandcursor.php MongoCommandCursor} object
     */
...
class MongoCursor implements Iterator {
    /**
     * @link https://secure.php.net/manual/en/class.mongocursor.php#mongocursor.props.slaveokay
	 * @static
     * @var bool $slaveOkay
     */
     ...
     * {@link https://secure.php.net/manual/en/class.mongocursortimeoutexception.php MongoCursorTimeoutException} after a set time.
     * </p>
     */
    ...
    */
	 ...
	 * @link https://secure.php.net/manual/en/mongocursor.maxtimems.php
	 * @param int $ms <p>
...
class MongoGridFS extends MongoCollection {
    ...
    /**
     * @link https://secure.php.net/manual/en/class.mongogridfs.php#mongogridfs.props.chunks
     * @var $chunks MongoCollection
     */
    public $chunks;

    /**
     * @link https://secure.php.net/manual/en/class.mongogridfs.php#mongogridfs.props.filesname
     * @var $filesName string
     */
    protected $filesName;

    /**
     * @link https://secure.php.net/manual/en/class.mongogridfs.php#mongogridfs.props.chunksname
     ...
     *
     * @link https://secure.php.net/manual/en/mongogridfs.construct.php
     ...
     * @link https://secure.php.net/manual/en/mongogridfs.drop.php
     * @return array The database response
     */
    public function drop() {}

    /**
     * @link https://secure.php.net/manual/en/mongogridfs.find.php
     ...
     * @link https://secure.php.net/manual/en/mongogridfs.storefile.php
     ...
     * @link https://secure.php.net/manual/en/mongogridfs.storebytes.php
     ...
     * @link https://secure.php.net/manual/en/mongogridfs.delete.php
    ...
    */
    public function get($id) {}
     ...
     /**
     * Stores a file in the database
     * @link https://secure.php.net/manual/en/mongogridfs.put.php
     * @param string $filename The name of the file
     * @param array $extra Other metadata to add to the file saved
     * @return mixed Returns the _id of the saved object
     */
...
class MongoGridFSFile {
    /**
    * @link https://secure.php.net/manual/en/class.mongogridfsfile.php#mongogridfsfile.props.file
    * @var $file
    */
    public $file;

    /**
    * @link https://secure.php.net/manual/en/class.mongogridfsfile.php#mongogridfsfile.props.gridfs
    * @var $gridfs
    */
    protected $gridfs;

    /**
     * @link https://secure.php.net/manual/en/mongogridfsfile.construct.php
     ...
     * @link https://secure.php.net/manual/en/mongogridfsfile.getfilename.php
    ...
    */
     ...
     * @link https://secure.php.net/manual/en/mongogridfsfile.getsize.php
    ...
    */
     ...
     * @link https://secure.php.net/manual/en/mongogridfsfile.write.php
     ...
     * @link https://secure.php.net/manual/en/mongogridfsfile.getbytes.php
     ...
     *
     * @link https://secure.php.net/manual/en/mongogridfsfile.getresource.php
...
class MongoGridFSCursor extends MongoCursor implements Traversable, Iterator {
    ...
    */
    ...
    /**
    * @link https://secure.php.net/manual/en/class.mongogridfscursor.php#mongogridfscursor.props.gridfs
    * @var $gridfs
    */
    protected $gridfs;
    ...
    /**
     * Create a new cursor
     * @link https://secure.php.net/manual/en/mongogridfscursor.construct.php
    ...
    * @link https://secure.php.net/manual/en/mongogridfscursor.getnext.php
    ...
    * @link https://secure.php.net/manual/en/mongogridfscursor.current.php
    ...
    * @link https://secure.php.net/manual/en/mongogridfscursor.key.php
...
class MongoId {
     ...
     * {@link https://secure.php.net/manual/en/language.types.string.php#language.types.string.parsing.complex complex variable parsed syntax} (e.g. $mongoId->{'$id'}).</p>
     */
     public $id = NULL;
     ...
     * @link https://secure.php.net/manual/en/mongoid.isvalid.php
    ...
    */
     ...
     * @link https://secure.php.net/manual/en/mongoid.getinc.php
     ...
     * (PECL mongo &gt;= 1.0.11)
     * Gets the process ID
     * @link https://secure.php.net/manual/en/mongoid.getpid.php
    ...
    */
     ...
     * @link https://secure.php.net/manual/en/mongoid.set-state.php
...
class MongoCode {
    ...
    */
     ...
     * .
     *
     * @link https://secure.php.net/manual/en/mongocode.construct.php
...
class MongoRegex {
    /**
     * @link https://secure.php.net/manual/en/class.mongoregex.php#mongoregex.props.regex
     * @var $regex
     */
    public $regex;

    /**
     * @link https://secure.php.net/manual/en/class.mongoregex.php#mongoregex.props.flags
     * @var $flags
     */
    public $flags;
     ...
     *
     * @link https://secure.php.net/manual/en/mongoregex.construct.php
...
class MongoDate {
    /**
     * @link https://secure.php.net/manual/en/class.mongodate.php#mongodate.props.sec
     * @var int $sec
     */
    public $sec;

    /**
     * @link https://secure.php.net/manual/en/class.mongodate.php#mongodate.props.usec
     * @var int $usec
     */
    public $usec;
     ...
     *
     * @link https://secure.php.net/manual/en/mongodate.construct.php
     ...
     * @link https://secure.php.net/manual/en/mongodate.todatetime.php
     * @return DateTime
     */
...
class MongoBinData {
	/**
	 * Generic binary data.
	 * @link https://secure.php.net/manual/en/class.mongobindata.php#mongobindata.constants.custom
	 */
	const GENERIC = 0x0;

     /**
	  * Function
     * @link https://secure.php.net/manual/en/class.mongobindata.php#mongobindata.constants.func
     */
    const FUNC = 0x1;

     /**
	  * Generic binary data (deprecated in favor of MongoBinData::GENERIC)
     * @link https://secure.php.net/manual/en/class.mongobindata.php#mongobindata.constants.byte-array
     */
    const BYTE_ARRAY = 0x2;

     /**
	  * Universally unique identifier (deprecated in favor of MongoBinData::UUID_RFC4122)
     * @link https://secure.php.net/manual/en/class.mongobindata.php#mongobindata.constants.uuid
     */
    const UUID = 0x3;
	...
	/**
	 * MD5
     * @link https://secure.php.net/manual/en/class.mongobindata.php#mongobindata.constants.md5
     */
    const MD5 = 0x5;
    ...
    /**
     * @link https://secure.php.net/manual/en/class.mongobindata.php#mongobindata.props.bin
     * @var $bin
     */
    public $bin;

    /**
     * @link https://secure.php.net/manual/en/class.mongobindata.php#mongobindata.props.type
     * @var $type
     */
    public $type;
     ...
     *
     * @link https://secure.php.net/manual/en/mongobindata.construct.php
...
class MongoDBRef {
    ...
    */
     ...
     *
     * @link https://secure.php.net/manual/en/mongodbref.create.php
     * @static
     ...
     *
     * @link https://secure.php.net/manual/en/mongodbref.isref.php
     * @static
     ...
     * @link https://secure.php.net/manual/en/mongodbref.get.php
     * @static
...
class MongoWriteBatch
{
	 ...
	 * @link https://secure.php.net/manual/en/mongowritebatch.construct.php
	 * @param MongoCollection $collection The {@see MongoCollection} to execute the batch on.
	 * Its {@link https://secure.php.net/manual/en/mongo.writeconcerns.php write concern}
	 ...
	 * </thead>
	 * <tbody><tr><td>w (int|string)</td><td>{@link https://secure.php.net/manual/en/mongo.writeconcerns.php Write concern} value</td></tr>
	 * <tr><td>wtimeout (int)</td><td>{@link https://secure.php.net/manual/en/mongo.writeconcerns.php Maximum time to wait for replication}</td></tr>
	 ...
	 * @link https://secure.php.net/manual/en/mongowritebatch.add.php
	 * @param array $item <p>
	 ...
	 * @link https://secure.php.net/manual/en/mongowritebatch.execute.php
...
class MongoUpdateBatch extends MongoWriteBatch
{
	 ...
	 * @link https://secure.php.net/manual/en/mongoupdatebatch.construct.php
	 ...
	 * </thead>
	 * <tbody class="tbody"><tr><td>w (int|string)</td><td>{@link https://secure.php.net/manual/en/mongo.writeconcerns.php Write concern} value</td></tr>
	 * <tr><td>wtimeout (int)</td><td>{@link https://secure.php.net/manual/en/mongo.writeconcerns.php Maximum time to wait for replication}</td></tr>
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link https://secure.php.net/manual/en/class.mongowriteconcernexception.php#class.mongowriteconcernexception
 */
class MongoWriteConcernException extends MongoCursorException {
    /**
     * Get the error document
     * @link https://secure.php.net/manual/en/mongowriteconcernexception.getdocument.php
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link https://secure.php.net/manual/en/class.mongoexecutiontimeoutexception.php
 */
...
/**
 * <p>(PECL mongo &gt;= 1.5.0)</p>
 * @link https://secure.php.net/manual/en/class.mongoduplicatekeyexception.php
 */
 ...
 * @link https://secure.php.net/manual/en/class.mongoresultexception.php#mongoresultexception.props.document
 *
 */
...
class MongoTimestamp {
    /**
     * @link https://secure.php.net/manual/en/class.mongotimestamp.php#mongotimestamp.props.sec
     * @var $sec
     */
    public $sec;

    /**
     * @link https://secure.php.net/manual/en/class.mongotimestamp.php#mongotimestamp.props.inc
     * @var $inc
     */
    public $inc;
 ...
 /**
     ...
     *
     * @link https://secure.php.net/manual/en/mongotimestamp.construct.php
...
class MongoInt32 {
    /**
     * @link https://secure.php.net/manual/en/class.mongoint32.php#mongoint32.props.value
     * @var $value
     */
    public $value;
     ...
     *
     * @link https://secure.php.net/manual/en/mongoint32.construct.php
...
class MongoInt64 {
    /**
     * @link https://secure.php.net/manual/en/class.mongoint64.php#mongoint64.props.value
     * @var $value
     */
    public $value;
     ...
     *
     * @link https://secure.php.net/manual/en/mongoint64.construct.php
     * @param string $value A number
     */
    public function __construct($value) {}
...
class MongoLog {
        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.none
     */
    const NONE = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.all
     */
    const ALL = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.warning
     */
    const WARNING = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.info
     */
    const INFO = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.fine
     */
    const FINE = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.rs
     */
    const RS = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.pool
     */
    const POOL = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.io
     */
    const IO = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.server
     */
    const SERVER = 0;

        /**
     * @link https://secure.php.net/manual/en/class.mongolog.php#mongolog.constants.parse
     */
    const PARSE = 0;
     ...
     *
     * @link https://secure.php.net/manual/en/mongolog.setlevel.php
     * @static
     ...
     *
     * @link https://secure.php.net/manual/en/mongolog.getlevel.php
     * @static
     ...
     *
     * @link https://secure.php.net/manual/en/mongolog.setmodule.php
     * @static
     ...
     *
     * @link https://secure.php.net/manual/en/mongolog.getmodule.php
     * @static
...
class MongoPool {
     ...
     *
     * @link https://secure.php.net/manual/en/mongopool.info.php
     * @static
     ...
     *
     * @link https://secure.php.net/manual/en/mongopool.setsize.php
     * @static
     ...
     * .
     *
     * @link https://secure.php.net/manual/en/mongopool.getsize.php
     * @static
     * @return int Returns the current pool size
     */
