 ...
 * @link https://secure.php.net/manual/en/reserved.classes.php
 */
class stdClass {
}
 ...
 * @link https://secure.php.net/manual/en/class.traversable.php
 */
 ...
 * @link https://secure.php.net/manual/en/class.iteratoraggregate.php
 */
 ...
 * @link https://secure.php.net/manual/en/class.iterator.php
 */
 ...
 * @link https://secure.php.net/manual/en/class.serializable.php
 */
 ...
 * @link https://secure.php.net/manual/en/class.throwable.php
 * @since 7.0
 */
interface Throwable
{
    ...
    /**
     * Gets the message
     * @link https://secure.php.net/manual/en/throwable.getmessage.php
     * @return string
     * @since 7.0
     */
     ...
     * @link https://secure.php.net/manual/en/throwable.getcode.php
     * @return int <p>
     ...
     * @link https://secure.php.net/manual/en/throwable.getfile.php
     ...
     * @link https://secure.php.net/manual/en/throwable.getline.php
     ...
     * @link https://secure.php.net/manual/en/throwable.gettrace.php
     * @return array <p>
     ...
     * @link https://secure.php.net/manual/en/throwable.gettraceasstring.php
     ...
     * @link https://secure.php.net/manual/en/throwable.getprevious.php
     ...
     * @link https://secure.php.net/manual/en/throwable.tostring.php
 ...
 * all Exceptions.
 * @link https://secure.php.net/manual/en/class.exception.php
 */
class Exception implements Throwable {
     ...
     * @link https://secure.php.net/manual/en/exception.getmessage.php
    ...
    /**
     * Gets the Exception code
     * @link https://secure.php.net/manual/en/exception.getcode.php
    ...
    /**
     * Gets the file in which the exception occurred
     * @link https://secure.php.net/manual/en/exception.getfile.php
     ...
     * @link https://secure.php.net/manual/en/exception.getline.php
    ...
    /**
     * Gets the stack trace
     * @link https://secure.php.net/manual/en/exception.gettrace.php
     ...
     * @link https://secure.php.net/manual/en/exception.getprevious.php
    ...
    /**
     * Gets the stack trace as a string
     * @link https://secure.php.net/manual/en/exception.gettraceasstring.php
 ...
 * @link https://secure.php.net/manual/en/class.error.php
 * @since 7.0
 */
class Error implements Throwable {
     ...
     * @link https://secure.php.net/manual/en/error.construct.php
     ...
     * @return void
     * @link https://secure.php.net/manual/en/error.clone.php
     */
 ...
 * @link https://secure.php.net/manual/en/class.typeerror.php
 * @since 7.0
 */
 ...
 * @link https://secure.php.net/manual/en/class.parseerror.php
 * @since 7.0
 */
 ...
 * @link https://secure.php.net/manual/en/class.assertionerror.php
 * @since 7.0
 */
 ...
 * @link https://secure.php.net/manual/en/class.arithmeticerror.php
 * @since 7.0
 */
 ...
 * @link https://secure.php.net/manual/en/class.divisionbyzeroerror.php
 * @since 7.0
 */
...
/**
 * An Error Exception.
 * @link https://secure.php.net/manual/en/class.errorexception.php
 */
class ErrorException extends Exception {
     ...
     * @link https://secure.php.net/manual/en/errorexception.getseverity.php
...
final class Closure {
     ...
     * @link https://secure.php.net/manual/en/closure.call.php
