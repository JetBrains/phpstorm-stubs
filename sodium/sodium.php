 ...
 * @link https://secure.php.net/manual/en/function.sodium-crypto-auth-keygen.php
 * @return string
 */
function sodium_crypto_auth_keygen(): string {}

/**
 * @link https://secure.php.net/manual/en/function.sodium-crypto-kx-keypair.php
 * @since 7.2
 * @return string
 */
...
/**
 * @link https://secure.php.net/manual/en/function.sodium-crypto-kx-publickey.php
 * @since 7.2
 * @param string $key
 * @return string
 */
...
/**
 * @link https://secure.php.net/manual/en/function.sodium-crypto-kx-secretkey.php
 * @since 7.2
 * @param string $key
 * @return string
 */
...
/**
 * @link https://secure.php.net/manual/en/function.sodium-crypto-kx-seed-keypair.php
 * @since 7.2
 * @param string $string
 * @return string
 */
...
/**
 * @link https://secure.php.net/manual/en/function.sodium-crypto-kx-server-session-keys.php
 * @since 7.2
...
/**
 * Get random bytes for key
 * @link https://secure.php.net/manual/en/function.sodium-crypto-generichash-keygen.php
 * @since 7.2
 * @return string
 */
...
/**
 * @since 7.2
 * @link https://secure.php.net/manual/en/function.sodium-crypto-kx-client-session-keys.php
...
/**
 * @link https://secure.php.net/manual/en/function.sodium-crypto-kdf-derive-from-key.php
 * @since 7.2
...
/**
 * Get random bytes for key
 * @link https://secure.php.net/manual/en/function.sodium-crypto-kdf-keygen.php
 * @since 7.2
 * @return string
 */
...
/**
 * Get random bytes for key
 * @link https://secure.php.net/manual/en/function.sodium-crypto-shorthash-keygen.php
 * @since 7.2
 * @return string
 */
...
/**
 * Get random bytes for key
 * @link https://secure.php.net/manual/en/function.sodium-crypto-stream-keygen.php
 * @since 7.2
 * @return string
 */
...
/**
 * Add padding data
 * @link https://secure.php.net/manual/en/function.sodium-pad.php
 * @since 7.2
 * @param $string
 * @param $length
 * @return string
...
/**
 * Remove padding data
 * @link https://secure.php.net/manual/en/function.sodium-unpad.php
 * @since 7.2
 * @param $string
 * @param $length
 */
