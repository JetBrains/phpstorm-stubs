 ...
 * @link     https://secure.php.net/manual/en/book.rrd.php
 ...
 * @link https://secure.php.net/manual/en/function.rrd-error.php
 ...
 * @link https://secure.php.net/manual/en/function.rrd-create.php
 ...
 * @link https://secure.php.net/manual/en/function.rrd-fetch.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.rrd-first.php
 * @param string $file <p>
 * RRD database file name.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.rrd-graph.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.rrd-info.php
 * @param string $filename <p>
 * RRD database file name.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.rrd-last.php
 * @param string $filename <p>
 * RRD database file name.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.rrd-lastupdate.php
 * @param string $filename <p>
 * RRD database file name.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.rrd-restore.php
 ...
 * @link https://secure.php.net/manual/en/function.rrd-tune.php
 * @param string $filename <p>
 * RRD database file name.
 * </p>
 * @param array $options <p>
 ...
 * @link https://secure.php.net/manual/en/function.rrd-update.php
 * @param string $filename <p>
 ...
 * @link https://secure.php.net/manual/en/function.rrd-version.php
 ...
 * @link https://secure.php.net/manual/en/function.rrd-xport.php
 * @param array $options <p>
 ...
 * @link https://secure.php.net/manual/en/function.rrdc-disconnect.php
 * @return void
 ...
 * @link https://secure.php.net/manual/en/class.rrdcreator.php
 * @since PECL rrd >= 0.9.0
 */
class RRDCreator {
     ...
     * </p>
     * @link https://secure.php.net/manual/en/rrdcreator.addarchive.php
     ...
     * </p>
     * @link https://secure.php.net/manual/en/rrdcreator.adddatasource.php
     * @param string $description <p>
     ...
     * @link https://secure.php.net/manual/en/rrdcreator.construct.php
     * @param string $path <p>
     ...
     * @link https://secure.php.net/manual/en/rrdcreator.save.php
 ...
 * @link https://secure.php.net/manual/en/class.rrdgraph.php
 * @since PECL rrd >= 0.9.0
 */
class RRDGraph {
     ...
     * @link https://secure.php.net/manual/en/rrdgraph.construct.php
     * @param string $path <p>
     ...
     * @link https://secure.php.net/manual/en/rrdgraph.save.php
     ...
     * </p>
     * @link https://secure.php.net/manual/en/rrdgraph.saveverbose.php
     ...
     * @link https://secure.php.net/manual/en/rrdgraph.setoptions.php
     * @param array $options <p>
 ...
 * @link https://secure.php.net/manual/en/class.rrdupdater.php
 * @since PECL rrd >= 0.9.0
 */
class RRDUpdater {
     ...
     * @link https://secure.php.net/manual/en/rrdupdater.construct.php
     * @param string $path <p>
     ...
     * @link https://secure.php.net/manual/en/rrdupdater.update.php
