...
/**
 * Get a semaphore id
 * @link https://secure.php.net/manual/en/function.sem-get.php
 * @param int $key
...
/**
 * Acquire a semaphore
 * @link https://secure.php.net/manual/en/function.sem-acquire.php
...
/**
 * Release a semaphore
 * @link https://secure.php.net/manual/en/function.sem-release.php
 * @param resource $sem_identifier <p>
...
/**
 * Remove a semaphore
 * @link https://secure.php.net/manual/en/function.sem-remove.php
 * @param resource $sem_identifier <p>
