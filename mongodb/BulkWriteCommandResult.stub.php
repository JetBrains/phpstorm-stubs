...
final class BulkWriteCommandResult
{
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.getinsertedcount.php
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.getmatchedcount.php
     * @throws LogicException if the write was not acknowledged.
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.getmodifiedcount.php
     * @throws LogicException if the write was not acknowledged.
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.getupsertedcount.php
     * @throws LogicException if the write was not acknowledged.
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.getdeletedcount.php
     * @throws LogicException if the write was not acknowledged.
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.getinsertresults.php
     * @throws LogicException if the write was not acknowledged.
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.getupdateresults.php
     * @throws LogicException if the write was not acknowledged.
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.getdeleteresults.php
     ...
     * @link https://www.php.net/manual/en/mongodb-driver-bulkwritecommandresult.isacknowledged.php
