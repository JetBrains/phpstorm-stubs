 ...
 *
 * @link https://secure.php.net/event_base_new
 *
 ...
 *
 * @link https://secure.php.net/event_base_free
 *
 ...
 * </p>
 *
 * @link https://secure.php.net/event_base_loop
 *
 * @param resource $event_base Valid event base resource.
 ...
 *
 * @link https://secure.php.net/event_base_loopbreak
 *
 * @param resource $event_base Valid event base resource.
 *
 ...
 *
 * @link https://secure.php.net/event_base_loopexit
 *
 ...
 *
 * @link https://secure.php.net/event_base_set
 *
 ...
 *
 * @link https://secure.php.net/event_base_priority_init
 *
 * @param resource $event_base Valid event base resource.
 ...
 * <p>(PECL libevent >= 0.0.1)</p>
 *
 * @link https://secure.php.net/event_new
 *
 ...
 * <p>(PECL libevent >= 0.0.1)</p>
 *
 * @link https://secure.php.net/event_free
 *
 * @param resource $event Valid event resource.
 *
 * @return void
 ...
 *
 * @link https://secure.php.net/event_add
 *
 ...
 * </p>
 *
 * @link https://secure.php.net/event_set
 *
 * @param resource $event <p>
 * Valid event resource.
 * </p>
 ...
 *
 * @link https://secure.php.net/event_del
 *
 * @param resource $event Valid event resource.
 *
 * @return bool returns TRUE on success or FALSE on error.
 ...
 * an error occurs.</p>
 *
 * @link https://secure.php.net/event_buffer_new
 *
 ...
 * <p>(PECL libevent >= 0.0.1)</p>
 *
 * @link https://secure.php.net/event_buffer_free
 *
 ...
 *
 * @link https://secure.php.net/event_buffer_base_set
 *
 * @param resource $bevent Valid buffered event resource.
 * @param resource $event_base Valid event base resource.
 *
 ...
 *
 * @link https://secure.php.net/event_buffer_priority_set
 *
 ...
 *
 * @link https://secure.php.net/event_buffer_write
 *
 * @param resource $bevent Valid buffered event resource.
 ...
 * <p>(PECL libevent >= 0.0.1)</p>
 *
 * @link https://secure.php.net/event_buffer_read
 *
 * @param resource $bevent Valid buffered event resource.
 ...
 * <p>(PECL libevent >= 0.0.1)</p>
 *
 * @link https://secure.php.net/event_buffer_enable
 *
 * @param resource $bevent Valid buffered event resource.
 ...
 *
 * @link https://secure.php.net/event_buffer_disable
 *
 * @param resource $bevent Valid buffered event resource.
 * @param int $events Any combination of EV_READ and EV_WRITE.
 *
 ...
 * <p>(PECL libevent >= 0.0.1)</p>
 *
 * @link https://secure.php.net/event_buffer_timeout_set
 *
 * @param resource $bevent Valid buffered event resource.
 ...
 *
 * @link https://secure.php.net/event_buffer_watermark_set
 *
 * @param resource $bevent   Valid buffered event resource.
 * @param int      $events   Any combination of EV_READ and EV_WRITE.
 ...
 * <p>(PECL libevent >= 0.0.1)</p>
 *
 * @link https://secure.php.net/event_buffer_fd_set
 *
 * @param resource $bevent Valid buffered event resource.
 ...
 *
 * @link https://secure.php.net/event_buffer_set_callback
 *
 * @param resource $bevent Valid buffered event resource.
 * @param callback|null $readcb Callback to invoke where there is data to read, or NULL if no callback is desired.
 * @param callback|null $writecb Callback to invoke where the descriptor is ready for writing, or NULL if no callback is desired.
