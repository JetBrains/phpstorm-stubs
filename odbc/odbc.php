 ...
 * @link https://secure.php.net/manual/en/function.odbc-autocommit.php
 ...
 * @link https://secure.php.net/manual/en/function.odbc-binmode.php
 ...
 * @link https://secure.php.net/manual/en/function.odbc-close.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-close-all.php
 * @return void No value is returned.
 * @since 4.0
 * @since 5.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.odbc-columns.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-commit.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 4.0
 ...
 * @link https://secure.php.net/manual/en/function.odbc-connect.php
 * @param string $dsn <p>
...
/**
 * Get cursorname
 * @link https://secure.php.net/manual/en/function.odbc-cursor.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-data-source.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-execute.php
 * @param resource $result_id <p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-error.php
 ...
 * @link https://secure.php.net/manual/en/function.odbc-errormsg.php
 * @param resource $connection_id [optional] The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return string If <i>connection_id</i> is specified, the last state
 * of that connection is returned, else the last state of any connection
 ...
 * @link https://secure.php.net/manual/en/function.odbc-exec.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-fetch-array.php
 ...
 * @link https://secure.php.net/manual/en/function.odbc-fetch-object.php
 * @param resource $result <p>
 * The result resource from <b>odbc_exec</b>.
 * </p>
 * @param int $rownumber [optional] <p>
...
/**
 * Fetch a row
 * @link https://secure.php.net/manual/en/function.odbc-fetch-row.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-fetch-into.php
 * @param resource $result_id <p>
 * The result resource.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-field-len.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-field-scale.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
...
/**
 * Get the columnname
 * @link https://secure.php.net/manual/en/function.odbc-field-name.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
...
/**
 * Datatype of a field
 * @link https://secure.php.net/manual/en/function.odbc-field-type.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $field_number <p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-field-num.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-free-result.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-gettypeinfo.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-longreadlen.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 * @param int $length <p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-next-result.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-num-fields.php
 * @param resource $result_id <p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-num-rows.php
 * @param resource $result_id <p>
 * The result identifier returned by <b>odbc_exec</b>.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-pconnect.php
 * @param string $dsn
 * @param string $user
 ...
 * @link https://secure.php.net/manual/en/function.odbc-prepare.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $query_string <p>
...
/**
 * Get result data
 * @link https://secure.php.net/manual/en/function.odbc-result.php
 * @param resource $result_id <p>
 * The ODBC resource.
 * </p>
 * @param mixed $field <p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-result-all.php
 * @param resource $result_id <p>
 * The result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-rollback.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 4.0
 ...
 * @link https://secure.php.net/manual/en/function.odbc-setoption.php
 * @param resource $id <p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-specialcolumns.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-statistics.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link https://secure.php.net/manual/en/function.odbc-tables.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier [optional] <p>
 * The qualifier.
 ...
 * @link https://secure.php.net/manual/en/function.odbc-primarykeys.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-columnprivileges.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link https://secure.php.net/manual/en/function.odbc-tableprivileges.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 * @param string $qualifier <p>
 * The qualifier.
 ...
 * @link https://secure.php.net/manual/en/function.odbc-foreignkeys.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-procedures.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-procedurecolumns.php
 * @param resource $connection_id The ODBC connection identifier,
 * see <b>odbc_connect</b> for details.</p>
 ...
 * @link https://secure.php.net/manual/en/function.odbc-do.php
 * @param $connection_id
 * @param $query
 ...
 * @link https://secure.php.net/manual/en/function.odbc-field-precision.php
 * @param $result_id
 * @param $field_number
 * @since 4.0
 * @since 5.0
