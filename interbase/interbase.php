 ...
 * @link https://secure.php.net/manual/en/function.ibase-connect.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-pconnect.php
 * @param string $database [optional] <p>
 * The database argument has to be a valid path to
 * database file on the server it resides on. If the server is not local,
 * it must be prefixed with either 'hostname:' (TCP/IP), '//hostname/'
 ...
 * @link https://secure.php.net/manual/en/function.ibase-close.php
...
/**
 * Drops a database
 * @link https://secure.php.net/manual/en/function.ibase-drop-db.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-query.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-fetch-row.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-fetch-assoc.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-fetch-object.php
...
/**
 * Free a result set
 * @link https://secure.php.net/manual/en/function.ibase-free-result.php
 * @param resource $result_identifier <p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-name-result.php
 * @param resource $result <p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-prepare.php
 * @param string $query <p>
 * An InterBase query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-execute.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-free-query.php
 * @param resource $query <p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-gen-id.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-num-fields.php
 * @param resource $result_id <p>
 * An InterBase result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-num-params.php
 * @param resource $query <p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-affected-rows.php
 * @param resource $link_identifier [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-field-info.php
 * @param resource $result <p>
 * An InterBase result identifier.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-param-info.php
 * @param resource $query <p>
...
/**
 * Begin a transaction
 * @link https://secure.php.net/manual/en/function.ibase-trans.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-commit.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-rollback.php
 * @param resource $link_or_trans_identifier [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-commit-ret.php
 * @param resource $link_or_trans_identifier [optional] <p>
 * If called without an argument, this function commits the default
 * transaction of the default link. If the argument is a connection
 * identifier, the default transaction of the corresponding connection
 ...
 * @link https://secure.php.net/manual/en/function.ibase-rollback-ret.php
 * @param resource $link_or_trans_identifier [optional] <p>
 * If called without an argument, this function rolls back the default
 * transaction of the default link. If the argument is a connection
 * identifier, the default transaction of the corresponding connection
 ...
 * @link https://secure.php.net/manual/en/function.ibase-blob-info.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-blob-create.php
 * @param resource $link_identifier [optional] <p>
 * An InterBase link identifier. If omitted, the last opened link is
 * assumed.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-blob-add.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-blob-cancel.php
 * @param resource $blob_handle <p>
 * A BLOB handle opened with ibase_blob_create.
 * </p>
 * @return bool true on success or false on failure.
...
/**
 * Close blob
 * @link https://secure.php.net/manual/en/function.ibase-blob-close.php
 * @param resource $blob_handle <p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-blob-open.php
 * @param resource $link_identifier <p>
 * An InterBase link identifier. If omitted, the last opened link is
 * assumed.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-blob-get.php
 * @param resource $blob_handle <p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-blob-echo.php
 * @param string $blob_id <p>
 * </p>
 * @return bool true on success or false on failure.
 * @since 4.0
 ...
 * @link https://secure.php.net/manual/en/function.ibase-blob-import.php
 * @param resource $link_identifier <p>
 * An InterBase link identifier. If omitted, the last opened link is
 * assumed.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.ibase-errmsg.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-errcode.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-add-user.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-modify-user.php
 * @param resource $service_handle 
 * @param string $user_name 
 * @param string $password 
 * @param string $first_name [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.ibase-delete-user.php
 * @param resource $service_handle 
 * @param string $user_name 
 * @return bool true on success or false on failure.
 * @since 4.2.0
 ...
 * @link https://secure.php.net/manual/en/function.ibase-service-attach.php
 * @param string $host 
 ...
 * @link https://secure.php.net/manual/en/function.ibase-service-detach.php
 * @param resource $service_handle 
 * @return bool true on success or false on failure.
 * @since 5.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.ibase-backup.php
 * @param resource $service_handle 
 ...
 * @link https://secure.php.net/manual/en/function.ibase-restore.php
 * @param resource $service_handle 
 ...
 * @link https://secure.php.net/manual/en/function.ibase-maintain-db.php
 * @param resource $service_handle 
 * @param string $db 
 * @param int $action 
 ...
 * @link https://secure.php.net/manual/en/function.ibase-db-info.php
 * @param resource $service_handle 
 * @param string $db 
 * @param int $action 
 * @param int $argument [optional] 
 ...
 * @link https://secure.php.net/manual/en/function.ibase-server-info.php
 * @param resource $service_handle 
 * @param int $action 
 * @return string 
 * @since 5.0
 ...
 * @link https://secure.php.net/manual/en/function.ibase-wait-event.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-set-event-handler.php
 ...
 * @link https://secure.php.net/manual/en/function.ibase-free-event-handler.php
 ...
 * @link https://secure.php.net/manual/en/ibase.constants.php
 */
