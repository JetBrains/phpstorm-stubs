...
/**
 * @link https://secure.php.net/manual/en/apc.constants.php
 */
 ...
 * @link https://secure.php.net/manual/en/function.apc-cache-info.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-clear-cache.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-sma-info.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-store.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-fetch.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-delete.php
 ...
 *
 * @link https://secure.php.net/manual/en/function.apc-define-constants.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-compile-file.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-load-constants.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-exists.php
 ...
 *
 * @link https://secure.php.net/manual/en/function.apc-delete-file.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-inc.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-dec.php
...
/**
 * @link https://secure.php.net/manual/en/function.apc-cas.php
 * @param string $key
 * @param int $old
 * @param int $new
 * @return bool
 ...
 *
 * @link https://secure.php.net/manual/en/function.apc-bin-dump.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-bin-dumpfile.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-bin-load.php
 ...
 * @link https://secure.php.net/manual/en/function.apc-bin-loadfile.php
 ...
 *
 * @link https://secure.php.net/manual/en/class.apciterator.php
 */
class APCIterator implements Iterator
{
	/**
	 * Constructs an APCIterator iterator object
	 * @link https://secure.php.net/manual/en/apciterator.construct.php
	 ...
	 * @link https://secure.php.net/manual/en/apciterator.rewind.php
	 */
	public function rewind(){}

	/**
	 * Checks if the current iterator position is valid
	 * @link https://secure.php.net/manual/en/apciterator.valid.php
	 ...
	 * @link https://secure.php.net/manual/en/apciterator.current.php
	 ...
	 * @link https://secure.php.net/manual/en/apciterator.key.php
	 ...
	 * @link https://secure.php.net/manual/en/apciterator.next.php
	 * @return bool Returns TRUE on success or FALSE on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/apciterator.gettotalhits.php
	 ...
	 * @link https://secure.php.net/manual/en/apciterator.gettotalsize.php
	...
	/**
	 * Get the total count
	 * @link https://secure.php.net/manual/en/apciterator.gettotalcount.php
