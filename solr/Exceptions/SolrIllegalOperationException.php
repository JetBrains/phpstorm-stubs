 ...
 * @link https://secure.php.net/manual/en/class.solrillegaloperationexception.php
 */
class SolrIllegalOperationException extends SolrException {
	 ...
	 * @link https://secure.php.net/manual/en/solrillegaloperationexception.getinternalinfo.php
	 * @return array <p>
