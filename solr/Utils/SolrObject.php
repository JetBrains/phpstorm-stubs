 ...
 * read-only.
 * @link https://www.php.net/manual/en/class.solrobject.php
 */
final class SolrObject implements ArrayAccess {
	 ...
	 * @link https://www.php.net/manual/en/solrobject.construct.php
	 */
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Destructor
	 * @link https://www.php.net/manual/en/solrobject.destruct.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrobject.getpropertynames.php
	 * @return array <p>
	 * Returns an array.
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrobject.offsetexists.php
	 ...
	 * @link https://www.php.net/manual/en/solrobject.offsetget.php
	 * @param string $property_name <p>
	 * The name of the property.
	 * </p>
	 ...
	 * @link https://www.php.net/manual/en/solrobject.offsetset.php
	 * @param string $property_name <p>
	 * The name of the property.
	 * </p>
	 ...
	 * @link https://www.php.net/manual/en/solrobject.offsetunset.php
	 * @param string $property_name <p>
	 * The name of the property.
	 * </p>
	 * @return bool
