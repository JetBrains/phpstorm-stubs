 ...
 * @link https://www.php.net/manual/en/class.solrpingresponse.php
 */
final class SolrPingResponse extends SolrResponse {
	 ...
	 * @link https://www.php.net/manual/en/solrpingresponse.construct.php
	 */
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Destructor
	 * @link https://www.php.net/manual/en/solrpingresponse.destruct.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrpingresponse.getresponse.php
	 * @return string <p>
