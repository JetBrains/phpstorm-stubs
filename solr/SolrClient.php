 ...
 * not supported.
 * @link https://secure.php.net/manual/en/class.solrclient.php
 */
final class SolrClient {
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.adddocument.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.adddocuments.php
	 * @param array $docs <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.commit.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.construct.php
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Delete by Id
	 * @link https://secure.php.net/manual/en/solrclient.deletebyid.php
	 * @param string $id <p>
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Deletes by Ids
	 * @link https://secure.php.net/manual/en/solrclient.deletebyids.php
	 * @param array $ids <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.deletebyqueries.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.deletebyquery.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.destruct.php
	 */
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.getbyid.php
	 * @param string $id <p>
	 * Document ID
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.getbyids.php
	 * @param array $ids <p>
	 * Document ids
	 * </p>
	 * @return SolrQueryResponse
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.getdebug.php
	 * @return string <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.getoptions.php
	 * @return array <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.optimize.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.ping.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.query.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.request.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.rollback.php
	 * @return SolrUpdateResponse <p>
	 * Returns a SolrUpdateResponse on success and throws an exception on failure.
	 * </p>
	 * @throws SolrClientException <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.setresponsewriter.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.setservlet.php
	 * @param int $type <p>
	 * One of the following :
	 * </p>
	 * <ul>
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.system.php
	 ...
	 * @link https://secure.php.net/manual/en/solrclient.threads.php
	 * @return SolrGenericResponse <p>
	 * Returns a SolrGenericResponse object on success.
	 * </p>
	 * @throws SolrClientException <p>
