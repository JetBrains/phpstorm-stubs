 ...
 * @link https://www.php.net/manual/en/class.solrcollapsefunction.php
 */
class SolrCollapseFunction {
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.construct.php
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.getfield.php
	 * @return string
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.gethint.php
	 * @return string
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.getmax.php
	 * @return string
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.getmin.php
	 * @return string
	 */
	 ...
	 * (PECL solr &gt;= 2.2.0)<br/>
	 * Returns null policy
	 * @link https://www.php.net/manual/en/solrcollapsefunction.getnullpolicy.php
	 * @return string
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.getsize.php
	 * @return int
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.setfield.php
	 ...
	 * (PECL solr &gt;= 2.2.0)<br/>
	 * Sets collapse hint
	 * @link https://www.php.net/manual/en/solrcollapsefunction.sethint.php
	 * @param string $hint <p>
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.setmax.php
	 * @param string $max
	 * @return SolrCollapseFunction
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.setmin.php
	 * @param string $min
	 * @return SolrCollapseFunction
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.setnullpolicy.php
	 ...
	 * (PECL solr &gt;= 2.2.0)<br/>
	 * Sets the initial size of the collapse data structures when collapsing on a numeric field only.
	 * @link https://www.php.net/manual/en/solrcollapsefunction.setsize.php
	 * @param int $size
	 * @return SolrCollapseFunction
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrcollapsefunction.tostring.php
	 * @return string
	 */
