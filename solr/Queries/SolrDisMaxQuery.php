 ...
 * @link https://secure.php.net/manual/en/class.solrdismaxquery.php
 */
class SolrDisMaxQuery extends SolrQuery implements Serializable {
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.addbigramphrasefield.php
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.addboostquery.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @param string $value
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.addphrasefield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @param string $boost [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.addqueryfield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @param string $boost [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.addtrigramphrasefield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @param string $boost [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.adduserfield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.removebigramphrasefield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.removeboostquery.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.removephrasefield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.removequeryfield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.removetrigramphrasefield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * </div>
	 * @link https://secure.php.net/manual/en/solrdismaxquery.removeuserfield.php
	 * @param string $field <p>
	 * Field name
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setbigramphrasefields.php
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setbigramphraseslop.php
	 * @param string $slop <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setboostfunction.php
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setboostquery.php
	 * @param string $q
	 * @return SolrDisMaxQuery
	 */
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setminimummatch.php
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setphrasefields.php
	 * @param string $fields <p>
	 * Fields, boosts [, slops]
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setphraseslop.php
	 * @param string $slop <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setqueryalt.php
	 * @param string $q <p>
	 * Query String
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * parameter)
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setqueryphraseslop.php
	 * @param string $slop <p>
	 * Amount of slop<br/>
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.settiebreaker.php
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.settrigramphrasefields.php
	 * @param string $fields <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.settrigramphraseslop.php
	 * @param string $slop <p>
	 * Phrase slop
	 * </p>
	 * @return SolrDisMaxQuery
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.setuserfields.php
	 * @param string $fields <p>
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.usedismaxqueryparser.php
	 * @return SolrDisMaxQuery
	 */
	 ...
	 * @link https://secure.php.net/manual/en/solrdismaxquery.useedismaxqueryparser.php
	 * @return SolrDisMaxQuery
	 */
