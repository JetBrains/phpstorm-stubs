 ...
 * @link https://www.php.net/manual/en/class.solrmodifiableparams.php
 */
class SolrModifiableParams extends SolrParams implements Serializable {
	 ...
	 * @link https://www.php.net/manual/en/solrmodifiableparams.construct.php
	 */
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Destructor
	 * @link https://www.php.net/manual/en/solrmodifiableparams.destruct.php
	 */
