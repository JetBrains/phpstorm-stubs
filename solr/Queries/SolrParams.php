 ...
 * @link https://www.php.net/manual/en/class.solrparams.php
 */
abstract class SolrParams implements Serializable {
	 ...
	 * @link https://www.php.net/manual/en/solrparams.add.php
	 * @param string $name <p>
	 ...
	 * @link https://www.php.net/manual/en/solrparams.addparam.php
	 * @param string $name <p>
	 * The name of the parameter
	 * </p>
	 * @param string $value <p>
	 ...
	 * @link https://www.php.net/manual/en/solrparams.get.php
	 ...
	 * @link https://www.php.net/manual/en/solrparams.getparam.php
	 * @param string $param_name <p>
	 * The name of the parameter
	 * </p>
	 * @return mixed <p>
	 ...
	 * @link https://www.php.net/manual/en/solrparams.getparams.php
	 * @return array <p>
	 * Returns an array of non URL-encoded parameters
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrparams.getpreparedparams.php
	 * @return array <p>
	 * Returns an array of URL-encoded parameters
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrparams.serialize.php
	 * @return string <p>
	 * Used for custom serialization
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrparams.set.php
	 * @param string $name <p>
	 * The name of the parameter
	 * </p>
	 * @param $value <p>
	 ...
	 * @link https://www.php.net/manual/en/solrparams.setparam.php
	 * @param string $name <p>
	 * The name of the parameter
	 * </p>
	 * @param $value <p>
	 ...
	 * @link https://www.php.net/manual/en/solrparams.tostring.php
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Used for custom serialization
	 * @link https://www.php.net/manual/en/solrparams.unserialize.php
