 ...
 * @link https://www.php.net/manual/en/class.solrdocumentfield.php
 */
final class SolrDocumentField {
	 ...
	 * @link https://www.php.net/manual/en/solrdocumentfield.construct.php
	 */
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Destructor
	 * @link https://www.php.net/manual/en/solrdocumentfield.destruct.php
	 */
