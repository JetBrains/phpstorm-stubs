...
final class SolrInputDocument {
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.addchilddocument.php
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.addchilddocuments.php
	 * @param array &$docs <p>
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.addfield.php
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.clear.php
	 * @return bool <p>
	 * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.clone.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.construct.php
	 */
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Destructor
	 * @link https://www.php.net/manual/en/solrinputdocument.destruct.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.fieldexists.php
	 * @param string $fieldName <p>
	 * Name of the field.
	 * </p>
	 * @return bool <p>
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.getboost.php
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.getchilddocuments.php
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.getchilddocumentscount.php
	 * @return int
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.getfield.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.getfieldboost.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 * @return float|false <p>
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.getfieldcount.php
	 * @return int|false <p>
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.getfieldnames.php
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.haschilddocuments.php
	 * @return bool <p>
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.merge.php
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.reset.php
	 * @return bool <p>
	 * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.setboost.php
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.sort.php
	 ...
	 * @link https://www.php.net/manual/en/solrinputdocument.toarray.php
	 * @return array|false <p>
