 ...
 * @link https://www.php.net/manual/en/class.solrinputdocument.php
 */
final class SolrDocument implements ArrayAccess, Iterator, Serializable {
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.addfield.php
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.clear.php
	 * @return bool <p>
	 * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.clone.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.construct.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.current.php
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.deletefield.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 * @return bool <p>
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Destructor
	 * @link https://www.php.net/manual/en/solrdocument.destruct.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.fieldexists.php
	 * @param string $fieldName <p>
	 * Name of the field.
	 * </p>
	 * @return bool <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.get.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * <p/>
	 * @return SolrDocumentField <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.getchilddocuments.php
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.getchilddocumentscount.php
	 * @return int
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.getfield.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.getfieldcount.php
	 * @return int|false <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.getfieldnames.php
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.getinputdocument.php
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.haschilddocuments.php
	 * @return bool <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.isset.php
	 * @param string $fieldName <p>
	 * Name of the field.
	 * </p>
	 * @return bool <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.key.php
	 * @return string <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.merge.php
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.next.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.offsetexists.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 * @return bool <p>
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Retrieves a field
	 * @link https://www.php.net/manual/en/solrdocument.offsetget.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 * @return SolrDocumentField <p>
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Adds a field to the document
	 * @link https://www.php.net/manual/en/solrdocument.offsetset.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 * @param string $fieldValue <p>
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Removes a field
	 * @link https://www.php.net/manual/en/solrdocument.offsetunset.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.reset.php
	 * @return bool <p>
	 * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * </p>
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.rewind.php
	 */
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.serialize.php
	 * @return string <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.set.php
	 * @param string $fieldName <p>
	 * Name of the field.
	 * </p>
	 * @param string $fieldValue <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.sort.php
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.unserialize.php
	 ...
	 * (PECL solr &gt;= 0.9.2)<br/>
	 * Removes a field from the document
	 * @link https://www.php.net/manual/en/solrdocument.unset.php
	 * @param string $fieldName <p>
	 * The name of the field.
	 * </p>
	 * @return bool <p>
	 ...
	 * @link https://www.php.net/manual/en/solrdocument.valid.php
	 * @return bool <p>
	 * Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * </p>
	 */
