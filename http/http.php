...
/**
 * @link https://secure.php.net/manual/en/class.httpdeflatestream.php
 */
class HttpDeflateStream  {
	 ...
	 * @link https://secure.php.net/manual/en/function.httpdeflatestream-construct.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpdeflatestream-update.php
	 * @param string $data <p>
	 * data to deflate
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httpdeflatestream-flush.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpdeflatestream-finish.php
	 * @param string $data [optional] <p>
	 * data to deflate
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httpdeflatestream-factory.php
	 * @param int $flags [optional] <p>
	 * initialization flags
	 * </p>
...
/**
 * @link https://secure.php.net/manual/en/class.httpinflatestream.php
 */
class HttpInflateStream  {
	 ...
	 * @link https://secure.php.net/manual/en/function.httpinflatestream-construct.php
	 * @param int $flags [optional] <p>
	 * initialization flags
	 * </p>
	 * @return void 
	 ...
	 * @link https://secure.php.net/manual/en/function.httpinflatestream-update.php
	 * @param string $data <p>
	 * data to inflate
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httpinflatestream-flush.php
	 * @param string $data [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httpinflatestream-finish.php
	 * @param string $data [optional] <p>
	 * data to inflate
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httpinflatestream-factory.php
	 * @param int $flags [optional] <p>
	 * initialization flags
	 * </p>
	 * @param string $class_name [optional] <p>
...
/**
 * @link https://secure.php.net/manual/en/class.httpmessage.php
 */
class HttpMessage implements Countable, Serializable, Iterator {
	 ...
	 * @link https://secure.php.net/manual/en/function.httpmessage-construct.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get message body
	 * @link https://secure.php.net/manual/en/function.httpmessage-getbody.php
	 ...
	 * Set message body
	 * @link https://secure.php.net/manual/en/function.httpmessage-setbody.php
	 * @param string $body <p>
	 ...
	 * Get header
	 * @link https://secure.php.net/manual/en/function.httpmessage-getheader.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get message headers
	 * @link https://secure.php.net/manual/en/function.httpmessage-getheaders.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set headers
	 * @link https://secure.php.net/manual/en/function.httpmessage-setheaders.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Add headers
	 * @link https://secure.php.net/manual/en/function.httpmessage-addheaders.php
	 * @param array $headers <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get message type
	 * @link https://secure.php.net/manual/en/function.httpmessage-gettype.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set message type
	 * @link https://secure.php.net/manual/en/function.httpmessage-settype.php
	 * @param int $type <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get response code
	 * @link https://secure.php.net/manual/en/function.httpmessage-getresponsecode.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set response code
	 * @link https://secure.php.net/manual/en/function.httpmessage-setresponsecode.php
	 * @param int $code <p>
	 * HTTP response code
	 * </p>
	 ...
	 * Get response status
	 * @link https://secure.php.net/manual/en/function.httpmessage-getresponsestatus.php
	 ...
	 * (PECL pecl_http &gt;= 0.23.0)<br/>
	 * Set response status
	 * @link https://secure.php.net/manual/en/function.httpmessage-setresponsestatus.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get request method
	 * @link https://secure.php.net/manual/en/function.httpmessage-getrequestmethod.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set request method
	 * @link https://secure.php.net/manual/en/function.httpmessage-setrequestmethod.php
	 ...
	 * (PECL pecl_http &gt;= 0.21.0)<br/>
	 * Get request URL
	 * @link https://secure.php.net/manual/en/function.httpmessage-getrequesturl.php
	 ...
	 * (PECL pecl_http &gt;= 0.21.0)<br/>
	 * Set request URL
	 * @link https://secure.php.net/manual/en/function.httpmessage-setrequesturl.php
	 * @param string $url <p>
	 * the request URL
	 * </p>
	 * @return bool TRUE on success, or FALSE if the message is not of type
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get HTTP version
	 * @link https://secure.php.net/manual/en/function.httpmessage-gethttpversion.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set HTTP version
	 * @link https://secure.php.net/manual/en/function.httpmessage-sethttpversion.php
	 ...
	 * (PECL pecl_http &gt;= 1.0.0)<br/>
	 * Guess content type
	 * @link https://secure.php.net/manual/en/function.httpmessage-guesscontenttype.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get parent message
	 * @link https://secure.php.net/manual/en/function.httpmessage-getparentmessage.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Send message
	 * @link https://secure.php.net/manual/en/function.httpmessage-send.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpmessage-tostring.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpmessage-tomessagetypeobject.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpmessage-factory.php
	 ...
	 * Create HttpMessage from string
	 * @link https://secure.php.net/manual/en/function.httpmessage-fromstring.php
	 * @param string $raw_message [optional] <p>
	 * a single or several consecutive HTTP messages
	 * </p>
	 * @param string $class_name [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httpmessage-fromenv.php
	 ...
	 * (PECL pecl_http &gt;= 0.22.0)<br/>
	 * Detach HttpMessage
	 * @link https://secure.php.net/manual/en/function.httpmessage-detach.php
	 ...
	 * (PECL pecl_http &gt;= 0.22.0)<br/>
	 * Prepend message(s)
	 * @link https://secure.php.net/manual/en/function.httpmessage-prepend.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpmessage-reverse.php
...
/**
 * @link https://secure.php.net/manual/en/class.httpquerystring.php
 */
class HttpQueryString implements Serializable, ArrayAccess {
	 ...
	 * @link https://secure.php.net/manual/en/function.httpquerystring-construct.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpquerystring-toarray.php
	 ...
	 * (PECL pecl_http &gt;= 0.22.0)<br/>
	 * Get query string
	 * @link https://secure.php.net/manual/en/function.httpquerystring-tostring.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpquerystring-get.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpquerystring-set.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpquerystring-mod.php
	 * @param mixed $params <p>
	 * query string params to add
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httpquerystring-singleton.php
	 * @param bool $global [optional] <p>
	 * whether to operate on $_GET and
	 * $_SERVER['QUERY_STRING']
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httpquerystring-xlate.php
	 * @param string $ie <p>
	 * input encoding
	 * </p>
	 * @param string $oe <p>
	 ...
	 * @link https://secure.php.net/manual/en/serializable.serialize.php
	 ...
	 * @link https://secure.php.net/manual/en/serializable.unserialize.php
...
/**
 * @link https://secure.php.net/manual/en/class.httprequest.php
 */
class HttpRequest  {
	const METH_GET = 1;
	const METH_HEAD = 2;
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequest-construct.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set options
	 * @link https://secure.php.net/manual/en/function.httprequest-setoptions.php
	 * @param array $options [optional] <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get options
	 * @link https://secure.php.net/manual/en/function.httprequest-getoptions.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set ssl options
	 * @link https://secure.php.net/manual/en/function.httprequest-setssloptions.php
	 * @param array $options [optional] <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get ssl options
	 * @link https://secure.php.net/manual/en/function.httprequest-getssloptions.php
	 ...
	 * Add ssl options
	 * @link https://secure.php.net/manual/en/function.httprequest-addssloptions.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Add headers
	 * @link https://secure.php.net/manual/en/function.httprequest-addheaders.php
	 * @param array $headers <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get headers
	 * @link https://secure.php.net/manual/en/function.httprequest-getheaders.php
	 ...
	 * (PECL pecl_http &gt;= 0.12.0)<br/>
	 * Set headers
	 * @link https://secure.php.net/manual/en/function.httprequest-setheaders.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Add cookies
	 * @link https://secure.php.net/manual/en/function.httprequest-addcookies.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get cookies
	 * @link https://secure.php.net/manual/en/function.httprequest-getcookies.php
	 ...
	 * (PECL pecl_http &gt;= 0.12.0)<br/>
	 * Set cookies
	 * @link https://secure.php.net/manual/en/function.httprequest-setcookies.php
	 ...
	 * (PECL pecl_http &gt;= 1.0.0)<br/>
	 * Enable cookies
	 * @link https://secure.php.net/manual/en/function.httprequest-enablecookies.php
	 * @return bool true on success or false on failure.
	 */
	 ...
	 * (PECL pecl_http &gt;= 1.0.0)<br/>
	 * Reset cookies
	 * @link https://secure.php.net/manual/en/function.httprequest-resetcookies.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set method
	 * @link https://secure.php.net/manual/en/function.httprequest-setmethod.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get method
	 * @link https://secure.php.net/manual/en/function.httprequest-getmethod.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set URL
	 * @link https://secure.php.net/manual/en/function.httprequest-seturl.php
	 * @param string $url <p>
	 * the request url
	 * </p>
	 * @return bool true on success or false on failure.
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get url
	 * @link https://secure.php.net/manual/en/function.httprequest-geturl.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set content type
	 * @link https://secure.php.net/manual/en/function.httprequest-setcontenttype.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get content type
	 * @link https://secure.php.net/manual/en/function.httprequest-getcontenttype.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set query data
	 * @link https://secure.php.net/manual/en/function.httprequest-setquerydata.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get query data
	 * @link https://secure.php.net/manual/en/function.httprequest-getquerydata.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Add query data
	 * @link https://secure.php.net/manual/en/function.httprequest-addquerydata.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set post fields
	 * @link https://secure.php.net/manual/en/function.httprequest-setpostfields.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get post fields
	 * @link https://secure.php.net/manual/en/function.httprequest-getpostfields.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Add post fields
	 * @link https://secure.php.net/manual/en/function.httprequest-addpostfields.php
	 * @param array $post_data <p>
	 ...
	 * Set raw post data
	 * @link https://secure.php.net/manual/en/function.httprequest-setrawpostdata.php
	 ...
	 * (PECL pecl_http 0.14.0-1.4.1)<br/>
	 * Get raw post data
	 * @link https://secure.php.net/manual/en/function.httprequest-getrawpostdata.php
	 ...
	 * (PECL pecl_http 0.14.0-1.4.1)<br/>
	 * Add raw post data
	 * @link https://secure.php.net/manual/en/function.httprequest-addrawpostdata.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set post files
	 * @link https://secure.php.net/manual/en/function.httprequest-setpostfiles.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Add post file
	 * @link https://secure.php.net/manual/en/function.httprequest-addpostfile.php
	 * @param string $name <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get post files
	 * @link https://secure.php.net/manual/en/function.httprequest-getpostfiles.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set put file
	 * @link https://secure.php.net/manual/en/function.httprequest-setputfile.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get put file
	 * @link https://secure.php.net/manual/en/function.httprequest-getputfile.php
	 ...
	 * (PECL pecl_http &gt;= 0.25.0)<br/>
	 * Set put data
	 * @link https://secure.php.net/manual/en/function.httprequest-setputdata.php
	 ...
	 * (PECL pecl_http &gt;= 0.25.0)<br/>
	 * Get put data
	 * @link https://secure.php.net/manual/en/function.httprequest-getputdata.php
	 ...
	 * (PECL pecl_http &gt;= 0.25.0)<br/>
	 * Add put data
	 * @link https://secure.php.net/manual/en/function.httprequest-addputdata.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Send request
	 * @link https://secure.php.net/manual/en/function.httprequest-send.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get response data
	 * @link https://secure.php.net/manual/en/function.httprequest-getresponsedata.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequest-getresponseheader.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequest-getresponsecookies.php
	 * @param int $flags [optional] <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get response code
	 * @link https://secure.php.net/manual/en/function.httprequest-getresponsecode.php
	 ...
	 * (PECL pecl_http &gt;= 0.23.0)<br/>
	 * Get response status
	 * @link https://secure.php.net/manual/en/function.httprequest-getresponsestatus.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get response body
	 * @link https://secure.php.net/manual/en/function.httprequest-getresponsebody.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get response info
	 * @link https://secure.php.net/manual/en/function.httprequest-getresponseinfo.php
	 * @param string $name [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequest-getresponsemessage.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequest-getrawresponsemessage.php
	 ...
	 * Get request message
	 * @link https://secure.php.net/manual/en/function.httprequest-getrequestmessage.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequest-getrawrequestmessage.php
	 ...
	 * Get history
	 * @link https://secure.php.net/manual/en/function.httprequest-gethistory.php
	 ...
	 * (PECL pecl_http &gt;= 0.15.0)<br/>
	 * Clear history
	 * @link https://secure.php.net/manual/en/function.httprequest-clearhistory.php
	 * @return void 
	 */
...
/**
 * @link https://secure.php.net/manual/en/class.httprequestpool.php
 */
class HttpRequestPool implements Countable, Iterator {
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequestpool-construct.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequestpool-destruct.php
	 * @return void 
	 */
	public function __destruct () {}
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Attach HttpRequest
	 * @link https://secure.php.net/manual/en/function.httprequestpool-attach.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Detach HttpRequest
	 * @link https://secure.php.net/manual/en/function.httprequestpool-detach.php
	 * @param HttpRequest $request <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Send all requests
	 * @link https://secure.php.net/manual/en/function.httprequestpool-send.php
	 * @return bool true on success or false on failure.
	 */
	public function send () {}
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Reset request pool
	 * @link https://secure.php.net/manual/en/function.httprequestpool-reset.php
	 * @return void 
	 */
	public function reset () {}
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequestpool-socketperform.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequestpool-socketselect.php
	 * @return bool true on success or false on failure.
	 */
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequestpool-getattachedrequests.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httprequestpool-getfinishedrequests.php
...
/**
 * @link https://secure.php.net/manual/en/class.httpresponse.php
 */
class HttpResponse  {
	const REDIRECT = 0;
	 ...
	 * (PECL pecl_http &gt;= 0.12.0)<br/>
	 * Set header
	 * @link https://secure.php.net/manual/en/function.httpresponse-setheader.php
	 * @param string $name <p>
	 ...
	 * (PECL pecl_http &gt;= 0.12.0)<br/>
	 * Get header
	 * @link https://secure.php.net/manual/en/function.httpresponse-getheader.php
	 * @param string $name [optional] <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set ETag
	 * @link https://secure.php.net/manual/en/function.httpresponse-setetag.php
	 * @param string $etag <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get ETag
	 * @link https://secure.php.net/manual/en/function.httpresponse-getetag.php
	 ...
	 * (PECL pecl_http &gt;= 0.12.0)<br/>
	 * Set last modified
	 * @link https://secure.php.net/manual/en/function.httpresponse-setlastmodified.php
	 ...
	 * (PECL pecl_http &gt;= 0.12.0)<br/>
	 * Get last modified
	 * @link https://secure.php.net/manual/en/function.httpresponse-getlastmodified.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpresponse-setcontentdisposition.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpresponse-getcontentdisposition.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set content type
	 * @link https://secure.php.net/manual/en/function.httpresponse-setcontenttype.php
	 * @param string $content_type <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get content type
	 * @link https://secure.php.net/manual/en/function.httpresponse-getcontenttype.php
	 ...
	 * Guess content type
	 * @link https://secure.php.net/manual/en/function.httpresponse-guesscontenttype.php
	 * @param string $magic_file <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set cache
	 * @link https://secure.php.net/manual/en/function.httpresponse-setcache.php
	 * @param bool $cache <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get cache
	 * @link https://secure.php.net/manual/en/function.httpresponse-getcache.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set cache control
	 * @link https://secure.php.net/manual/en/function.httpresponse-setcachecontrol.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get cache control
	 * @link https://secure.php.net/manual/en/function.httpresponse-getcachecontrol.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set gzip
	 * @link https://secure.php.net/manual/en/function.httpresponse-setgzip.php
	 * @param bool $gzip <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get gzip
	 * @link https://secure.php.net/manual/en/function.httpresponse-getgzip.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set throttle delay
	 * @link https://secure.php.net/manual/en/function.httpresponse-setthrottledelay.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get throttle delay
	 * @link https://secure.php.net/manual/en/function.httpresponse-getthrottledelay.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set buffer size
	 * @link https://secure.php.net/manual/en/function.httpresponse-setbuffersize.php
	 * @param int $bytes <p>
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get buffer size
	 * @link https://secure.php.net/manual/en/function.httpresponse-getbuffersize.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set data
	 * @link https://secure.php.net/manual/en/function.httpresponse-setdata.php
	 * @param mixed $data <p>
	 * data to send
	 * </p>
	 * @return bool true on success or false on failure.
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get data
	 * @link https://secure.php.net/manual/en/function.httpresponse-getdata.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set file
	 * @link https://secure.php.net/manual/en/function.httpresponse-setfile.php
	 * @param string $file <p>
	 * the path to the file to send
	 * </p>
	 * @return bool true on success or false on failure.
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get file
	 * @link https://secure.php.net/manual/en/function.httpresponse-getfile.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Set stream
	 * @link https://secure.php.net/manual/en/function.httpresponse-setstream.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get Stream
	 * @link https://secure.php.net/manual/en/function.httpresponse-getstream.php
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Send response
	 * @link https://secure.php.net/manual/en/function.httpresponse-send.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpresponse-capture.php
	 * @return void 
	 */
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Redirect
	 * @link https://secure.php.net/manual/en/function.httpresponse-redirect.php
	 ...
	 * @link https://secure.php.net/manual/en/function.httpresponse-status.php
	 * @param int $status 
	 * @return bool 
	 */
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get request headers
	 * @link https://secure.php.net/manual/en/function.httpresponse-getrequestheaders.php
	 * @return array 
	 */
	 ...
	 * (PECL pecl_http &gt;= 0.10.0)<br/>
	 * Get request body
	 * @link https://secure.php.net/manual/en/function.httpresponse-getrequestbody.php
	 * @return string 
	 */
	 ...
	 * @link https://secure.php.net/manual/en/function.httpresponse-getrequestbodystream.php
	 * @return resource 
	 */
 ...
 * @link https://secure.php.net/manual/en/function.http-date.php
 ...
 * (PECL pecl_http &gt;= 0.21.0)<br/>
 * Build an URL
 * @link https://secure.php.net/manual/en/function.http-build-url.php
 ...
 * (PECL pecl_http &gt;= 0.23.0)<br/>
 * Build query string
 * @link https://secure.php.net/manual/en/function.http-build-str.php
 * @param array $query <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-negotiate-language.php
 ...
 * @link https://secure.php.net/manual/en/function.http-negotiate-charset.php
 * @param array $supported <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-negotiate-content-type.php
 * @param array $supported <p>
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Issue HTTP redirect
 * @link https://secure.php.net/manual/en/function.http-redirect.php
 * @param string $url [optional] <p>
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * HTTP throttling
 * @link https://secure.php.net/manual/en/function.http-throttle.php
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send HTTP response status
 * @link https://secure.php.net/manual/en/function.http-send-status.php
 * @param int $status <p>
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send Last-Modified
 * @link https://secure.php.net/manual/en/function.http-send-last-modified.php
 * @param int $timestamp [optional] <p>
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * Send Content-Type
 * @link https://secure.php.net/manual/en/function.http-send-content-type.php
 * @param string $content_type [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-send-content-disposition.php
 * @param string $filename <p>
 * the file name the &quot;Save as...&quot; dialog should display
 * </p>
 * @param bool $inline [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-match-modified.php
 * @param int $timestamp [optional] <p>
 * Unix timestamp; current time, if omitted
 * </p>
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Match ETag
 * @link https://secure.php.net/manual/en/function.http-match-etag.php
 * @param string $etag <p>
 * the ETag to match
 * </p>
 * @param bool $for_range [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-cache-last-modified.php
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Caching by ETag
 * @link https://secure.php.net/manual/en/function.http-cache-etag.php
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send arbitrary data
 * @link https://secure.php.net/manual/en/function.http-send-data.php
 * @param string $data <p>
 * data to send
 * </p>
 * @return bool true on success or false on failure.
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send file
 * @link https://secure.php.net/manual/en/function.http-send-file.php
 * @param string $file <p>
 * the file to send
 * </p>
 * @return bool true on success or false on failure.
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Send stream
 * @link https://secure.php.net/manual/en/function.http-send-stream.php
 * @param resource $stream <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-chunked-decode.php
 ...
 * (PECL pecl_http &gt;= 0.12.0)<br/>
 * Parse HTTP messages
 * @link https://secure.php.net/manual/en/function.http-parse-message.php
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * Parse HTTP headers
 * @link https://secure.php.net/manual/en/function.http-parse-headers.php
 * @param string $header <p>
 ...
 * Parse HTTP cookie
 * @link https://secure.php.net/manual/en/function.http-parse-cookie.php
 ...
 * Build cookie string
 * @link https://secure.php.net/manual/en/function.http-build-cookie.php
 ...
 * @link https://secure.php.net/manual/en/function.http-parse-params.php
 ...
 * @link https://secure.php.net/manual/en/function.http-get-request-headers.php
 ...
 * @link https://secure.php.net/manual/en/function.http-get-request-body.php
 ...
 * @link https://secure.php.net/manual/en/function.http-get-request-body-stream.php
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * Match any header
 * @link https://secure.php.net/manual/en/function.http-match-request-header.php
 * @param string $header <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-persistent-handles-count.php
 ...
 * @link https://secure.php.net/manual/en/function.http-persistent-handles-clean.php
 ...
 * @link https://secure.php.net/manual/en/function.http-persistent-handles-ident.php
 ...
 * (PECL pecl_http &gt;= 0.1.0)<br/>
 * Perform GET request
 * @link https://secure.php.net/manual/en/function.http-get.php
 * @param string $url <p>
 * URL
 * </p>
 * @param array $options [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-head.php
 * @param string $url [optional] <p>
 * URL
 * </p>
 * @param array $options [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-post-data.php
 * @param string $url <p>
 * URL
 * </p>
 * @param string $data [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-post-fields.php
 * @param string $url <p>
 * URL
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.http-put-data.php
 * @param string $url <p>
 * URL
 * </p>
 * @param string $data [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-put-file.php
 * @param string $url <p>
 * URL
 * </p>
 * @param string $file [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-put-stream.php
 * @param string $url <p>
 * URL
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.http-request.php
 * @param int $method <p>
 * Request method
 * </p>
 * @param string $url [optional] <p>
 ...
 * (PECL pecl_http &gt;= 1.0.0)<br/>
 * Encode request body
 * @link https://secure.php.net/manual/en/function.http-request-body-encode.php
 ...
 * @link https://secure.php.net/manual/en/function.http-request-method-register.php
 * @param string $method <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-request-method-unregister.php
 ...
 * @link https://secure.php.net/manual/en/function.http-request-method-exists.php
 * @param mixed $method <p>
 ...
 * @link https://secure.php.net/manual/en/function.http-request-method-name.php
 * @param int $method <p>
 * request method ID
 * </p>
 ...
 * (PECL pecl_http &gt;= 0.10.0)<br/>
 * ETag output handler
 * @link https://secure.php.net/manual/en/function.ob-etaghandler.php
 * @param string $data 
 * @param int $mode 
 * @return string 
 */
 ...
 * (PECL pecl_http &gt;= 0.15.0)<br/>
 * Deflate data
 * @link https://secure.php.net/manual/en/function.http-deflate.php
 * @param string $data <p>
 ...
 * (PECL pecl_http &gt;= 0.15.0)<br/>
 * Inflate data
 * @link https://secure.php.net/manual/en/function.http-inflate.php
 * @param string $data <p>
 ...
 * @link https://secure.php.net/manual/en/function.ob-deflatehandler.php
 * @param string $data 
 * @param int $mode 
 * @return string 
 */
 ...
 * @link https://secure.php.net/manual/en/function.ob-inflatehandler.php
 * @param string $data 
 * @param int $mode 
 * @return string 
 */
 ...
 * @link https://secure.php.net/manual/en/function.http-support.php
 ...
 * @link https://secure.php.net/manual/en/http.constants.php
 */
