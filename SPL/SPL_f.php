 ...
 * @link https://secure.php.net/manual/en/function.spl-classes.php
 * @return array 
 * @since 5.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.spl-autoload.php
 ...
 * @link https://secure.php.net/manual/en/function.spl-autoload-extensions.php
 * @param string $file_extensions [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.spl-autoload-unregister.php
 ...
 * @link https://secure.php.net/manual/en/function.spl-autoload-functions.php
 ...
 * @link https://secure.php.net/manual/en/function.spl-autoload-call.php
 * @param string $class_name <p>
 ...
 * @link https://secure.php.net/manual/en/function.class-parents.php
 * @param mixed $class <p>
 ...
 * @link https://secure.php.net/manual/en/function.class-implements.php
 * @param mixed $class <p>
 * An object (class instance) or a string (class name).
 * </p>
 * @param bool $autoload [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.spl-object-hash.php
 * @param object $obj 
 ...
 * @link https://secure.php.net/manual/en/function.iterator-to-array.php
 ...
 * @link https://secure.php.net/manual/en/function.iterator-count.php
 * @param Traversable $iterator <p>
 ...
 * @link https://secure.php.net/manual/en/function.iterator-apply.php
 * @param Traversable $iterator <p>
 ...
 * @link https://secure.php.net/manual/en/function.class-uses.php
 * @see class_parents()
