 ...
 * @link https://www.php.net/manual/en/class.logicexception.php
 */
 ...
 * @link https://www.php.net/manual/en/class.badfunctioncallexception.php
 */
 ...
 * arguments are missing.
 * @link https://www.php.net/manual/en/class.badmethodcallexception.php
 */
 ...
 * @link https://www.php.net/manual/en/class.domainexception.php
 */
 ...
 * @link https://www.php.net/manual/en/class.lengthexception.php
 */
 ...
 * @link https://www.php.net/manual/en/class.outofrangeexception.php
 */
 ...
 * @link https://www.php.net/manual/en/class.outofboundsexception.php
 */
 ...
 * @link https://www.php.net/manual/en/class.overflowexception.php
 */
 ...
 * <b>DomainException</b>.
 * @link https://www.php.net/manual/en/class.rangeexception.php
 */
 ...
 * @link https://www.php.net/manual/en/class.underflowexception.php
 */
...
class RecursiveCallbackFilterIterator extends CallbackFilterIterator implements RecursiveIterator {
     ...
     * @link https://www.php.net/manual/en/recursiveiterator.haschildren.php
...
interface RecursiveIterator extends Iterator {
    ...
    /**
     * Returns an iterator for the current entry.
     * @link https://www.php.net/manual/en/recursiveiterator.getchildren.php
...
class RecursiveIteratorIterator implements OuterIterator {
     ...
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.construct.php
     ...
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.rewind.php
     * @return void
     */
    public function rewind() { }
     ...
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.valid.php
     ...
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.key.php
     ...
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.current.php
     ...
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.next.php
     * @return void
     */
    public function next() { }
     ...
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.getdepth.php
     ...
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.getsubiterator.php
    ...
    /**
     * Get inner iterator
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.getinneriterator.php
    ...
    /**
     * Begin Iteration
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.beginiteration.php
     * @return void
     */
    ...
    /**
     * End Iteration
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.enditeration.php
     * @return void
     */
    ...
    /**
     * Has children
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.callhaschildren.php
    ...
    /**
     * Get children
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.callgetchildren.php
    ...
    /**
     * Begin children
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.beginchildren.php
     * @return void
     */
    ...
    /**
     * End children
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.endchildren.php
     * @return void
     */
    ...
    /**
     * Next element
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.nextelement.php
     * @return void
     */
    ...
    /**
     * Set max depth
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.setmaxdepth.php
    ...
    /**
     * Get max depth
     * @link https://www.php.net/manual/en/recursiveiteratoriterator.getmaxdepth.php
...
class IteratorIterator implements OuterIterator {
     ...
     * @link https://www.php.net/manual/en/iteratoriterator.rewind.php
     * @return void
     */
    public function rewind() { }
     ...
     * @link https://www.php.net/manual/en/iteratoriterator.valid.php
     ...
     * @link https://www.php.net/manual/en/iteratoriterator.key.php
     ...
     * @link https://www.php.net/manual/en/iteratoriterator.current.php
     ...
     * @link https://www.php.net/manual/en/iteratoriterator.next.php
     * @return void
     */
    public function next() { }
}
 ...
 * @link https://www.php.net/manual/en/class.filteriterator.php
 */
abstract class FilterIterator extends IteratorIterator {

    /**
     * Check whether the current element of the iterator is acceptable
     * @link https://www.php.net/manual/en/filteriterator.accept.php
     * @return bool true if the current element is acceptable, otherwise false.
     */
     ...
     * @link https://www.php.net/manual/en/filteriterator.construct.php
    ...
    /**
     * Rewind the iterator
     * @link https://www.php.net/manual/en/filteriterator.rewind.php
     * @return void
     */
    public function rewind() { }
     ...
     * @link https://www.php.net/manual/en/filteriterator.valid.php
    ...
    /**
     * Get the current key
     * @link https://www.php.net/manual/en/filteriterator.key.php
     * @return string|float|int|bool|null The current key.
     */
    public function key() { }
     ...
     * @link https://www.php.net/manual/en/filteriterator.current.php
     ...
     * @link https://www.php.net/manual/en/filteriterator.next.php
     * @return void
     */
    public function next() { }
    ...
    /**
     * Get the inner iterator
     * @link https://www.php.net/manual/en/filteriterator.getinneriterator.php
 ...
 * @link https://www.php.net/manual/en/class.recursivefilteriterator.php
 */
abstract class RecursiveFilterIterator extends FilterIterator implements RecursiveIterator {

    /**
     * Create a RecursiveFilterIterator from a RecursiveIterator
     * @link https://www.php.net/manual/en/recursivefilteriterator.construct.php
    ...
    /**
     * Check whether the inner iterator's current element has children
     * @link https://www.php.net/manual/en/recursivefilteriterator.haschildren.php
     ...
     * @link https://www.php.net/manual/en/recursivefilteriterator.getchildren.php
 ...
 * @link https://www.php.net/manual/en/class.parentiterator.php
 */
class ParentIterator extends RecursiveFilterIterator {

    /**
     * Determines acceptability
     * @link https://www.php.net/manual/en/parentiterator.accept.php
     * @return bool true if the current element is acceptable, otherwise false.
     */
    public function accept() { }
     ...
     * @link https://www.php.net/manual/en/parentiterator.construct.php
     * @param RecursiveIterator $iterator
     */
    public function __construct(RecursiveIterator $iterator) { }
...
interface SeekableIterator extends Iterator {
    ...
    /**
     * Seeks to a position
     * @link https://www.php.net/manual/en/seekableiterator.seek.php
 ...
 * @link https://www.php.net/manual/en/class.limititerator.php
 */
class LimitIterator extends IteratorIterator {

    /**
     * Construct a LimitIterator
     * @link https://www.php.net/manual/en/limititerator.construct.php
     ...
     * @link https://www.php.net/manual/en/limititerator.rewind.php
     * @return void
     */
    public function rewind() { }
    ...
    /**
     * Check whether the current element is valid
     * @link https://www.php.net/manual/en/limititerator.valid.php
    ...
    /**
     * Get current key
     * @link https://www.php.net/manual/en/limititerator.key.php
    ...
    /**
     * Get current element
     * @link https://www.php.net/manual/en/limititerator.current.php
    ...
    /**
     * Move the iterator forward
     * @link https://www.php.net/manual/en/limititerator.next.php
     * @return void
     */
    public function next() { }
     ...
     * @link https://www.php.net/manual/en/limititerator.seek.php
     * @param int $position <p>
     * The position to seek to.
     * </p>
     ...
     * @link https://www.php.net/manual/en/limititerator.getposition.php
    ...
    /**
     * Get inner iterator
     * @link https://www.php.net/manual/en/limititerator.getinneriterator.php
 ...
 * @link https://www.php.net/manual/en/class.cachingiterator.php
 */
class CachingIterator extends IteratorIterator implements ArrayAccess, Countable, Stringable {
    ...
    /**
     * Rewind the iterator
     * @link https://www.php.net/manual/en/cachingiterator.rewind.php
     * @return void
     */
    public function rewind() { }
    ...
    /**
     * Check whether the current element is valid
     * @link https://www.php.net/manual/en/cachingiterator.valid.php
     * @return bool true on success or false on failure.
     */
    public function valid() { }
    ...
    /**
     * Return the current element
     * @link https://www.php.net/manual/en/cachingiterator.current.php
     * @return mixed
     */
    public function current() { }
     ...
     * @link https://www.php.net/manual/en/cachingiterator.hasnext.php
     * @return bool true on success or false on failure.
     */
     ...
     * @link https://www.php.net/manual/en/cachingiterator.tostring.php
     ...
     * @link https://www.php.net/manual/en/cachingiterator.getinneriterator.php
     ...
     * @link https://www.php.net/manual/en/cachingiterator.setflags.php
     ...
     * @link https://www.php.net/manual/en/cachingiterator.offsetget.php
     ...
     * @link https://www.php.net/manual/en/cachingiterator.offsetset.php
     ...
     * @link https://www.php.net/manual/en/cachingiterator.offsetunset.php
     ...
     * @link https://www.php.net/manual/en/cachingiterator.offsetexists.php
     ...
     * @link https://www.php.net/manual/en/cachingiterator.getcache.php
     ...
     * @link https://www.php.net/manual/en/cachingiterator.count.php
...
/**
 * ...
 * @link https://www.php.net/manual/en/class.recursivecachingiterator.php
 */
class RecursiveCachingIterator extends CachingIterator implements RecursiveIterator {

    /**
     * Constructs a new RecursiveCachingIterator.
     * @link https://www.php.net/manual/en/recursivecachingiterator.construct.php
     * @param Iterator $iterator The iterator to cache.
     * @param int $flags [optional] A bitmask of flags. See CachingIterator class constants for details.
     */
    public function __construct(Iterator $iterator, $flags = self::CALL_TOSTRING) { }
     ...
     * @link https://www.php.net/manual/en/recursivecachingiterator.haschildren.php
     * @return bool true if the inner iterator has children, otherwise false
     */
    public function hasChildren() { }
     ...
     * @link https://www.php.net/manual/en/recursivecachingiterator.getchildren.php
 ...
 * @link https://www.php.net/manual/en/class.norewinditerator.php
 */
class NoRewindIterator extends IteratorIterator {

    /**
     * Construct a NoRewindIterator
     * @link https://www.php.net/manual/en/norewinditerator.construct.php
     * @param Iterator $iterator
     */
    public function __construct(Iterator $iterator) { }
     ...
     * @link https://www.php.net/manual/en/norewinditerator.rewind.php
     * @return void
     */
    public function rewind() { }
     ...
     * @link https://www.php.net/manual/en/norewinditerator.valid.php
     * @return bool true on success or false on failure.
     */
    public function valid() { }
    ...
    /**
     * Get the current key
     * @link https://www.php.net/manual/en/norewinditerator.key.php
     * @return string|float|int|bool|null The current key.
     */
    public function key() { }
    ...
    /**
     * Get the current value
     * @link https://www.php.net/manual/en/norewinditerator.current.php
    ...
    /**
     * Forward to the next element
     * @link https://www.php.net/manual/en/norewinditerator.next.php
     * @return void
     */
    public function next() { }
    ...
    /**
     * Get the inner iterator
     * @link https://www.php.net/manual/en/norewinditerator.getinneriterator.php
 ...
 * @link https://www.php.net/manual/en/class.appenditerator.php
 */
class AppendIterator extends IteratorIterator {
    ...
    /**
     * Appends an iterator
     * @link https://www.php.net/manual/en/appenditerator.append.php
     ...
     * @link https://www.php.net/manual/en/appenditerator.key.php
     ...
     * @link https://www.php.net/manual/en/appenditerator.current.php
     ...
     * @link https://www.php.net/manual/en/appenditerator.next.php
     * @return void
     */
    public function next() { }
     ...
     * @link https://www.php.net/manual/en/appenditerator.getinneriterator.php
     ...
     * @link https://www.php.net/manual/en/appenditerator.getarrayiterator.php
 ...
 * @link https://www.php.net/manual/en/class.infiniteiterator.php
 */
class InfiniteIterator extends IteratorIterator {

    /**
     * Constructs an InfiniteIterator
     * @link https://www.php.net/manual/en/infiniteiterator.construct.php
     * @param Iterator $iterator
     */
    public function __construct(Iterator $iterator) { }
     ...
     * @link https://www.php.net/manual/en/infiniteiterator.next.php
     * @return void
     */
    public function next() { }
}
 ...
 * @link https://www.php.net/manual/en/class.regexiterator.php
 */
class RegexIterator extends FilterIterator {
     ...
     * @link https://www.php.net/manual/en/regexiterator.construct.php
    ...
    /**
     * Get accept status
     * @link https://www.php.net/manual/en/regexiterator.accept.php
     ...
     * @link https://www.php.net/manual/en/regexiterator.getmode.php
     ...
     * @link https://www.php.net/manual/en/regexiterator.setmode.php
     * @param int $mode <p>
     * The operation mode.
     * </p>
     * <p>
    ...
    /**
     * Get flags
     * @link https://www.php.net/manual/en/regexiterator.getflags.php
    ...
    /**
     * Sets the flags.
     * @link https://www.php.net/manual/en/regexiterator.setflags.php
     * @param int $flags <p>
    ...
    */
     ...
     * @link https://www.php.net/manual/en/regexiterator.getpregflags.php
     ...
     * @link https://www.php.net/manual/en/regexiterator.setpregflags.php
 ...
 * @link https://www.php.net/manual/en/class.recursiveregexiterator.php
 */
class RecursiveRegexIterator extends RegexIterator implements RecursiveIterator {
    /**
     * Creates a new RecursiveRegexIterator.
     * @link https://www.php.net/manual/en/recursiveregexiterator.construct.php
     ...
     * @link https://www.php.net/manual/en/recursiveregexiterator.haschildren.php
    ...
    /**
     * Returns an iterator for the current entry.
     * @link https://www.php.net/manual/en/recursiveregexiterator.getchildren.php
 ...
 * @link https://www.php.net/manual/en/class.recursivetreeiterator.php
 */
class RecursiveTreeIterator extends RecursiveIteratorIterator {
     ...
     * @link https://www.php.net/manual/en/recursivetreeiterator.construct.php
    ...
    /**
     * Rewind iterator
     * @link https://www.php.net/manual/en/recursivetreeiterator.rewind.php
     * @return void
     */
    public function rewind() { }
    ...
    /**
     * Check validity
     * @link https://www.php.net/manual/en/recursivetreeiterator.valid.php
     * @return bool true if the current position is valid, otherwise false
     */
    public function valid() { }
    ...
    /**
     * Get the key of the current element
     * @link https://www.php.net/manual/en/recursivetreeiterator.key.php
    ...
    /**
     * Get current element
     * @link https://www.php.net/manual/en/recursivetreeiterator.current.php
     ...
     * @link https://www.php.net/manual/en/recursivetreeiterator.next.php
     * @return void
     */
    public function next() { }
    ...
    /**
     * Begin iteration
     * @link https://www.php.net/manual/en/recursivetreeiterator.beginiteration.php
     * @return RecursiveIterator A <b>RecursiveIterator</b>.
     */
    public function beginIteration() { }
    ...
    /**
     * End iteration
     * @link https://www.php.net/manual/en/recursivetreeiterator.enditeration.php
     * @return void
     */
    public function endIteration() { }
    ...
    /**
     * Has children
     * @link https://www.php.net/manual/en/recursivetreeiterator.callhaschildren.php
    ...
    /**
     * Get children
     * @link https://www.php.net/manual/en/recursivetreeiterator.callgetchildren.php
     * @return RecursiveIterator A <b>RecursiveIterator</b>.
     */
    public function callGetChildren() { }
    ...
    /**
     * Begin children
     * @link https://www.php.net/manual/en/recursivetreeiterator.beginchildren.php
     * @return void
     */
    public function beginChildren() { }
    ...
    /**
     * End children
     * @link https://www.php.net/manual/en/recursivetreeiterator.endchildren.php
     * @return void
     */
    public function endChildren() { }
    ...
    /**
     * Next element
     * @link https://www.php.net/manual/en/recursivetreeiterator.nextelement.php
     * @return void
     */
    public function nextElement() { }
    ...
    /**
     * Get the prefix
     * @link https://www.php.net/manual/en/recursivetreeiterator.getprefix.php
     ...
     * @link https://www.php.net/manual/en/recursivetreeiterator.setprefixpart.php
     * @param int $part <p>
    ...
    /**
     * Get current entry
     * @link https://www.php.net/manual/en/recursivetreeiterator.getentry.php
    ...
    /**
     * Get the postfix
     * @link https://www.php.net/manual/en/recursivetreeiterator.getpostfix.php
...
class ArrayObject implements IteratorAggregate, ArrayAccess, Serializable, Countable {
     ...
     * @link https://www.php.net/manual/en/arrayobject.construct.php
     ...
     * @link https://www.php.net/manual/en/arrayobject.offsetexists.php
     * @param mixed $index <p>
     ...
     * @link https://www.php.net/manual/en/arrayobject.offsetget.php
     * @param mixed $index <p>
     ...
     * @link https://www.php.net/manual/en/arrayobject.offsetset.php
     * @param mixed $index <p>
     * The index being set.
     * </p>
     ...
     * @link https://www.php.net/manual/en/arrayobject.offsetunset.php
     * @param mixed $index <p>
    ...
    /**
     * Appends the value
     * @link https://www.php.net/manual/en/arrayobject.append.php
     * @param mixed $value <p>
     ...
     * @link https://www.php.net/manual/en/arrayobject.getarraycopy.php
     ...
     * @link https://www.php.net/manual/en/arrayobject.count.php
     ...
     * @link https://www.php.net/manual/en/arrayobject.setflags.php
     * @param int $flags <p>
     ...
     * @link https://www.php.net/manual/en/arrayobject.asort.php
     ...
     * @link https://www.php.net/manual/en/arrayobject.ksort.php
     * @param int $sort_flags [optional]
     * @return void
     */
     ...
     * @link https://www.php.net/manual/en/arrayobject.uasort.php
     ...
     * @link https://www.php.net/manual/en/arrayobject.uksort.php
     * @param callback $cmp_function <p>
     ...
     * @link https://www.php.net/manual/en/arrayobject.natsort.php
     * @return void
     */
     ...
     * @link https://www.php.net/manual/en/arrayobject.natcasesort.php
     * @return void
     */
     ...
     * @link https://www.php.net/manual/en/arrayobject.serialize.php
     ...
     * @link https://www.php.net/manual/en/arrayobject.getiterator.php
     ...
     * @link https://www.php.net/manual/en/arrayobject.exchangearray.php
     * @param mixed $input <p>
     ...
     * @link https://www.php.net/manual/en/arrayobject.setiteratorclass.php
     ...
     * @link https://www.php.net/manual/en/arrayobject.getiteratorclass.php
 ...
 * @link https://www.php.net/manual/en/class.arrayiterator.php
 */
class ArrayIterator implements SeekableIterator, ArrayAccess, Serializable, Countable {
     ...
     * @link https://www.php.net/manual/en/arrayiterator.offsetexists.php
     ...
     * @link https://www.php.net/manual/en/arrayiterator.offsetget.php
     * @param string $index <p>
     ...
     * @link https://www.php.net/manual/en/arrayiterator.offsetset.php
     * @param string $index <p>
     ...
     * @link https://www.php.net/manual/en/arrayiterator.offsetunset.php
     * @param string $index <p>
     * The offset to unset.
     * </p>
     * @return void
    ...
    /**
     * Append an element
     * @link https://www.php.net/manual/en/arrayiterator.append.php
     * @param mixed $value <p>
     * The value to append.
     * </p>
     * @return void
    ...
    /**
     * Count elements
     * @link https://www.php.net/manual/en/arrayiterator.count.php
    ...
    /**
     * Set behaviour flags
     * @link https://www.php.net/manual/en/arrayiterator.setflags.php
     ...
     * @link https://www.php.net/manual/en/arrayiterator.asort.php
     * @param int $sort_flags [optional]
     * @return void
     */
    public function asort($sort_flags = SORT_REGULAR) { }
    ...
    /**
     * User defined sort
     * @link https://www.php.net/manual/en/arrayiterator.uasort.php
     ...
     * @link https://www.php.net/manual/en/arrayiterator.natcasesort.php
     * @return void
     */
    public function natcasesort() { }
    ...
    /**
     * Serialize
     * @link https://www.php.net/manual/en/arrayiterator.serialize.php
     ...
     * @link https://www.php.net/manual/en/arrayiterator.rewind.php
     * @return void
     */
    public function rewind() { }
     ...
     * @link https://www.php.net/manual/en/arrayiterator.current.php
     ...
     * @link https://www.php.net/manual/en/arrayiterator.key.php
    ...
    /**
     * Move to next entry
     * @link https://www.php.net/manual/en/arrayiterator.next.php
     * @return void
     */
    public function next() { }
     ...
     * @link https://www.php.net/manual/en/arrayiterator.valid.php
     * @return bool
     */
    public function valid() { }
 ...
 * @link https://www.php.net/manual/en/class.recursivearrayiterator.php
 */
class RecursiveArrayIterator extends ArrayIterator implements RecursiveIterator {
     ...
     * @link https://www.php.net/manual/en/recursivearrayiterator.haschildren.php
     ...
     * @link https://www.php.net/manual/en/recursivearrayiterator.getchildren.php
