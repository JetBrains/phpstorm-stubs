...
/**
 * Radius constants
 * @link https://www.php.net/manual/en/radius.constants.php
 */
...
/**
 * RADIUS Options
 * @link https://www.php.net/manual/en/radius.constants.options.php
 */
...
/**
 * RADIUS Packet Types
 * @link https://www.php.net/manual/en/radius.constants.packets.php
 */
 ...
 * @link https://www.php.net/manual/en/radius.constants.attributes.php
 */
 ...
 * @link https://www.php.net/manual/en/function.radius-acct-open.php
 ...
 * @link https://www.php.net/manual/en/function.radius-add-server.php
 ...
 * @link https://www.php.net/manual/en/function.radius-auth-open.php
 * @return resource|false Returns a handle on success, <b>FALSE</b> on error. This function only fails if insufficient memory is available.
 * @since 1.1.0
 */
 ...
 * @link https://www.php.net/manual/en/function.radius-close.php
 * @param resource $radius_handle
 * @return bool Returns <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 1.1.0
 */
 ...
 * @link https://www.php.net/manual/en/function.radius-config.php
 ...
 * @link https://www.php.net/manual/en/function.radius-create-request.php
 * @param resource $radius_handle
