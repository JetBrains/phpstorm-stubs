...
'apcu_dec' => ['int|false', 'key'=>'string', 'step='=>'int', '&w_success='=>'bool'],
...
'apcu_fetch' => ['mixed|false', 'key'=>'string|string[]', '&w_success='=>'bool'],
'apcu_inc' => ['int|false', 'key'=>'string', 'step='=>'int', '&w_success='=>'bool'],
...
'array_keys' => ['int[]|string[]', 'input'=>'array', 'search_value='=>'mixed', 'strict='=>'bool'],
...
'DateTimeImmutable::createFromFormat' => ['DateTimeImmutable|false', 'format'=>'string', 'time'=>'string', 'timezone='=>'DateTimeZone|null'],
...
'get_class_methods' => ['string[]|null', 'class'=>'mixed'],
...
'MongoDB\Driver\Server::executeCommand' => ['', 'db'=>'string', 'command'=>'MongoDB\Driver\Command'],
...
'mysql_query' => ['resource|false', 'query'=>'string', 'link_identifier='=>'resource'],
...
'register_event_handler' => ['bool', 'event_handler_func'=>'string', 'handler_register_name'=>'string', 'event_type_mask'=>'string'],
...
'SplHeap::top' => ['mixed'],
'SplHeap::valid' => ['bool'],
'split' => ['string[]|false', 'pattern'=>'string', 'string'=>'string', 'limit='=>'int'],
'spliti' => ['string[]|false', 'pattern'=>'string', 'string'=>'string', 'limit='=>'int'],
...
'trait_exists' => ['bool|null', 'traitname'=>'string', 'autoload='=>'bool'],
...
'zend_send_file' => ['bool', 'filename'=>'string', 'mime_type'=>'string', 'custom_headers'=>'custom_headers'],
