 ...
 * @link https://secure.php.net/manual/en/function.mssql-connect.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-pconnect.php
 * @param string $servername [optional] <p>
 * The MS SQL server. It can also include a port number. e.g. 
 * hostname:port.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-close.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-select-db.php
 ...
 * (PHP 4, PHP 5, PECL odbtp &gt;= 1.1.1)<br/>
 * Send MS SQL query
 * @link https://secure.php.net/manual/en/function.mssql-query.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-fetch-batch.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-rows-affected.php
 ...
 * (PHP 4, PHP 5, PECL odbtp &gt;= 1.1.1)<br/>
 * Free result memory
 * @link https://secure.php.net/manual/en/function.mssql-free-result.php
 * @param resource $result <p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-get-last-message.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-num-rows.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-num-fields.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-fetch-field.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-fetch-row.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-fetch-array.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-fetch-assoc.php
 ...
 * (PHP 4, PHP 5, PECL odbtp &gt;= 1.1.1)<br/>
 * Fetch row as object
 * @link https://secure.php.net/manual/en/function.mssql-fetch-object.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-field-length.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-field-name.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-field-type.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-data-seek.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-field-seek.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * (PHP 4, PHP 5, PECL odbtp &gt;= 1.1.1)<br/>
 * Get result data
 * @link https://secure.php.net/manual/en/function.mssql-result.php
 * @param resource $result <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-next-result.php
 * @param resource $result_id <p>
 * The result resource that is being evaluated. This result comes from a
 * call to mssql_query.
 * </p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-min-error-severity.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-min-message-severity.php
 * @param int $severity <p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-init.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-bind.php
 ...
 * @link https://secure.php.net/manual/en/function.mssql-execute.php
 * @param resource $stmt <p>
 ...
 * @link https://secure.php.net/manual/en/function.mssql-free-statement.php
 * @param resource $stmt <p>
 * Statement resource, obtained with mssql_init.
 * </p>
 * @return bool true on success or false on failure.
 ...
 * @link https://secure.php.net/manual/en/function.mssql-guid-string.php
 ...
 * @link https://secure.php.net/manual/en/mssql.constants.php
 */
