...
/**
 * @link https://secure.php.net/manual/en/class.xsltprocessor.php
 */
class XSLTProcessor  {

	/**
	 * Import stylesheet
	 * @link https://secure.php.net/manual/en/xsltprocessor.importstylesheet.php
	 ...
	 * @link https://secure.php.net/manual/en/xsltprocessor.transformtodoc.php
	 * @param DOMNode $doc <p>
	...
	/**
	 * Transform to URI
	 * @link https://secure.php.net/manual/en/xsltprocessor.transformtouri.php
	...
	/**
	 * Transform to XML
	 * @link https://secure.php.net/manual/en/xsltprocessor.transformtoxml.php
	 * @param DOMDocument|SimpleXMLElement $doc <p>
	 ...
	 * @link https://secure.php.net/manual/en/xsltprocessor.setparameter.php
	 ...
	 * @link https://secure.php.net/manual/en/xsltprocessor.getparameter.php
	...
	/**
	 * Remove parameter
	 * @link https://secure.php.net/manual/en/xsltprocessor.removeparameter.php
	 * @param string $namespaceURI <p>
	 * The namespace URI of the XSLT parameter.
	 * </p>
	 * @param string $localName <p>
	 ...
	 * @link https://secure.php.net/manual/en/xsltprocessor.hasexsltsupport.php
	 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
	 * @since 5.0.4
	 */
	 ...
	 * @link https://secure.php.net/manual/en/xsltprocessor.registerphpfunctions.php
	 ...
	 * @link https://secure.php.net/manual/en/xsltprocessor.setprofiling.php
	 ...
	 * @link https://secure.php.net/manual/en/xsltprocessor.setsecurityprefs.php
	 ...
	 * @link https://secure.php.net/manual/en/xsltprocessor.getsecurityprefs.php
	 * @return int
	 * @since 5.4.0
	 */
...
/** @link https://secure.php.net/manual/en/xsl.constants.php */
