 ...
 * @link https://secure.php.net/manual/en/function.xml-parser-create.php
 ...
 * @link https://secure.php.net/manual/en/function.xml-parser-create-ns.php
 * @param string $encoding [optional] <p>
 * The optional <i>encoding</i> specifies the character
 * encoding for the input/output in PHP 4. Starting from PHP 5, the input
 * encoding is automatically detected, so that the
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-object.php
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-element-handler.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-character-data-handler.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-processing-instruction-handler.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-default-handler.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-unparsed-entity-decl-handler.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-notation-decl-handler.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-external-entity-ref-handler.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-start-namespace-decl-handler.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-set-end-namespace-decl-handler.php
 * @param resource $parser <p>
 * A reference to the XML parser.
 * </p>
 * @param callable $handler <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-parse.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-parse-into-struct.php
 * @param resource $parser <p>
 * A reference to the XML parser.
 * </p>
 * @param string $data <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-get-error-code.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-error-string.php
 * @param int $code <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-get-current-line-number.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-get-current-column-number.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-get-current-byte-index.php
 * @param resource $parser <p>
...
/**
 * Free an XML parser
 * @link https://secure.php.net/manual/en/function.xml-parser-free.php
 ...
 * @link https://secure.php.net/manual/en/function.xml-parser-set-option.php
 * @param resource $parser <p>
 ...
 * @link https://secure.php.net/manual/en/function.xml-parser-get-option.php
 ...
 * @link https://secure.php.net/manual/en/xml.constants.php
 */
