 ...
 * @link https://www.php.net/manual/en/class.sqlite3.php
 */
class SQLite3
{
    /** @since 8.0 */
     ...
     * @link https://www.php.net/manual/en/sqlite3.open.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.close.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.exec.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.version.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.lastinsertrowid.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.lasterrorcode.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.lasterrormsg.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.busytimeout.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.loadextension.php
     * @param string $name <p>
     ...
     * @link https://www.php.net/manual/en/sqlite3.changes.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.escapestring.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.prepare.php
     * @param string $query <p>
     ...
     * @link https://www.php.net/manual/en/sqlite3.query.php
     * @param string $query <p>
     ...
     * @link https://www.php.net/manual/en/sqlite3.querysingle.php
     * @param string $query <p>
     * The SQL query to execute.
     * </p>
     ...
     * @link https://www.php.net/manual/en/sqlite3.createfunction.php
     * @param string $name <p>
     ...
     * @link https://www.php.net/manual/en/sqlite3.createaggregate.php
     * @param string $name <p>
     ...
     * @link https://www.php.net/manual/en/sqlite3.createcollation.php
     * @param string $name <p>
     ...
     * @link https://www.php.net/manual/en/sqlite3.openblob.php
     ...
     * @link https://www.php.net/manual/en/sqlite3.construct.php
     * @param string $filename <p>
     * Path to the SQLite database, or :memory: to use in-memory database.
     * </p>
     * @param int $flags <p>
 ...
 * @link https://www.php.net/manual/en/class.sqlite3stmt.php
 */
class SQLite3Stmt
{
    /** @since 8.5 */
     ...
     * @link https://www.php.net/manual/en/sqlite3stmt.paramcount.php
     ...
     * @link https://www.php.net/manual/en/sqlite3stmt.close.php
     ...
     * @link https://www.php.net/manual/en/sqlite3stmt.reset.php
     ...
     * @link https://www.php.net/manual/en/sqlite3stmt.clear.php
     ...
     * @link https://www.php.net/manual/en/sqlite3stmt.execute.php
     ...
     * @link https://www.php.net/manual/en/sqlite3stmt.bindparam.php
 ...
 * @link https://www.php.net/manual/en/class.sqlite3result.php
 */
class SQLite3Result
{
    /**
     * Returns the number of columns in the result set
     * @link https://www.php.net/manual/en/sqlite3result.numcolumns.php
     ...
     * @link https://www.php.net/manual/en/sqlite3result.columnname.php
     * @param int $column <p>
     ...
     * @link https://www.php.net/manual/en/sqlite3result.columntype.php
     * @param int $column <p>
     * The numeric zero-based index of the column.
     * </p>
     ...
     * @link https://www.php.net/manual/en/sqlite3result.fetcharray.php
     ...
     * @link https://www.php.net/manual/en/sqlite3result.reset.php
     ...
     * @link https://www.php.net/manual/en/sqlite3result.finalize.php
     * @return bool <b>TRUE</b>.
     */
    #[LanguageLevelTypeAware(['8.4' => 'true'], default: 'bool')]
    #[TentativeType]
