 ...
 * @link https://secure.php.net/manual/en/class.sqlite3.php
 */
class SQLite3  {

	/**
	 * Opens an SQLite database
	 * @link https://secure.php.net/manual/en/sqlite3.open.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.close.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.exec.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.version.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.lastinsertrowid.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.lasterrorcode.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.lasterrormsg.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.busytimeout.php
	 * @param int $msecs <p>
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.loadextension.php
	 ...
	 * @since 5.3.0
	 * @link https://secure.php.net/manual/en/sqlite3.changes.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.escapestring.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.prepare.php
	 * @param string $query <p>
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.query.php
	 * @param string $query <p>
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.querysingle.php
	 * @param string $query <p>
	 * The SQL query to execute.
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.createfunction.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.createaggregate.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.createcollation.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.openblob.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3.construct.php
	 * @param string $filename <p>
	 * Path to the SQLite database, or :memory: to use in-memory database.
	 * </p>
	 * @param int $flags [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/class.sqlite3stmt.php
 */
class SQLite3Stmt  {

	/**
	 * Returns the number of parameters within the prepared statement
	 * @link https://secure.php.net/manual/en/sqlite3stmt.paramcount.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3stmt.close.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3stmt.reset.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3stmt.clear.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3stmt.execute.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3stmt.bindparam.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3stmt.bindvalue.php
	 * @param string $sql_param <p>
	 * An string identifying the statement variable to which the
 ...
 * @link https://secure.php.net/manual/en/class.sqlite3result.php
 */
class SQLite3Result  {

	/**
	 * Returns the number of columns in the result set
	 * @link https://secure.php.net/manual/en/sqlite3result.numcolumns.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3result.columnname.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3result.columntype.php
	 * @param int $column_number <p>
	 * The numeric zero-based index of the column.
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3result.fetcharray.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3result.reset.php
	 ...
	 * @link https://secure.php.net/manual/en/sqlite3result.finalize.php
	 * @return bool <b>TRUE</b>.
	 * @since 5.3.0
	 */
 ...
 * @link https://secure.php.net/manual/en/sqlite3.constants.php
 */
