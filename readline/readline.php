...
/**
 * Reads a line
 * @link https://secure.php.net/manual/en/function.readline.php
 ...
 * @link https://secure.php.net/manual/en/function.readline-info.php
 ...
 * @link https://secure.php.net/manual/en/function.readline-add-history.php
 * @param string $line <p>
...
/**
 * Clears the history
 * @link https://secure.php.net/manual/en/function.readline-clear-history.php
 * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
 * @since 4.0
 * @since 5.0
 */
...
/**
 * Lists the history
 * @link https://secure.php.net/manual/en/function.readline-list-history.php
...
/**
 * Reads the history
 * @link https://secure.php.net/manual/en/function.readline-read-history.php
...
/**
 * Writes the history
 * @link https://secure.php.net/manual/en/function.readline-write-history.php
 * @param string $filename [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.readline-completion-function.php
 ...
 * @link https://secure.php.net/manual/en/function.readline-callback-handler-install.php
 ...
 * @link https://secure.php.net/manual/en/function.readline-callback-read-char.php
 ...
 * @link https://secure.php.net/manual/en/function.readline-callback-handler-remove.php
...
/**
 * Redraws the display
 * @link https://secure.php.net/manual/en/function.readline-redisplay.php
 * @return void No value is returned.
 * @since 5.1.0
 */
 ...
 * @link https://secure.php.net/manual/en/function.readline-on-new-line.php
 * @return void No value is returned.
 * @since 5.1.0
 */
