...
class SimpleXMLElement implements Traversable, ArrayAccess, Countable {
	 ...
	 * An XPath path
	 * </p>
	 * @return static[]|false an array of SimpleXMLElement (or derived) objects or <b>FALSE</b> in
	 * case of an error.
	 * @since 5.2.0
	 */
...
class SimpleXMLIterator extends SimpleXMLElement implements RecursiveIterator, Countable {
	 ...
	 * @return mixed|false the XML tag name of the element referenced by the current <b>SimpleXMLIterator</b> object or <b>FALSE</b>
	 * @since 5.1.0
	 */
	public function key () {}
