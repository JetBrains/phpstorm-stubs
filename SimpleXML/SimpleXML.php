 ...
 * @link https://secure.php.net/manual/en/class.simplexmlelement.php
 */
class SimpleXMLElement implements Traversable, ArrayAccess, Countable {

	/**
	 * Creates a new SimpleXMLElement object
	 * @link https://secure.php.net/manual/en/simplexmlelement.construct.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.asxml.php
     ...
     * Return a well-formed XML string based on SimpleXML element
	 * @link https://secure.php.net/manual/en/simplexmlelement.savexml.php
     * @param string $filename [optional] <p>
   	 * If specified, the function writes the data to the file rather than
   	 * returning it.
   	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.xpath.php
	 * @param string $path <p>
	 * An XPath path
	 * </p>
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.registerxpathnamespace.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.attributes.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.children.php
	 * @param string $ns [optional] <p>
	 * An XML namespace.
	 * </p>
	 * @param bool $is_prefix [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.getnamespaces.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.getdocnamespaces.php
	 * @param bool $recursive [optional] <p>
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.getname.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.addchild.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.addattribute.php
	 * @param string $name <p>
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.tostring.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmlelement.count.php
 ...
 * @link https://secure.php.net/manual/en/class.simplexmliterator.php
 */
class SimpleXMLIterator extends SimpleXMLElement implements RecursiveIterator, Countable {

	/**
	 * Rewind to the first element
	 * @link https://secure.php.net/manual/en/simplexmliterator.rewind.php
	 * @return void No value is returned.
	 * @since 5.1.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/simplexmliterator.valid.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmliterator.current.php
	...
	/**
	 * Return current key
	 * @link https://secure.php.net/manual/en/simplexmliterator.key.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmliterator.next.php
	 * @return void No value is returned.
	 * @since 5.1.0
	 */
	 ...
	 * @link https://secure.php.net/manual/en/simplexmliterator.haschildren.php
	 ...
	 * @link https://secure.php.net/manual/en/simplexmliterator.getchildren.php
 ...
 * @link https://secure.php.net/manual/en/function.simplexml-load-file.php
 ...
 * @link https://secure.php.net/manual/en/function.simplexml-load-string.php
 * @param string $data <p>
 ...
 * @link https://secure.php.net/manual/en/function.simplexml-import-dom.php
