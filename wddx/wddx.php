 ...
 * @link https://secure.php.net/manual/en/function.wddx-serialize-value.php
 * @param mixed $var <p>
 ...
 * @link https://secure.php.net/manual/en/function.wddx-serialize-vars.php
 ...
 * @link https://secure.php.net/manual/en/function.wddx-packet-start.php
 * @param string $comment [optional] <p>
 ...
 * @link https://secure.php.net/manual/en/function.wddx-packet-end.php
 ...
 * @link https://secure.php.net/manual/en/function.wddx-add-vars.php
 * @param resource $packet_id <p>
 * A WDDX packet, returned by <b>wddx_packet_start</b>.
 * </p>
 * @param mixed $var_name <p>
 ...
 * @link https://secure.php.net/manual/en/function.wddx-deserialize.php
