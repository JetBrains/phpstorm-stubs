...
//should be changed later to map values when map type is supported
  ...
  override(\array_combine(0), type(1));
    ...
    expectedArguments(\idn_to_ascii(), 2, INTL_IDNA_VARIANT_2003 | INTL_IDNA_VARIANT_UTS46);
    ...
    expectedArguments(\idn_to_utf8(), 2, INTL_IDNA_VARIANT_2003 | INTL_IDNA_VARIANT_UTS46);
