...
//should be changed later to map values when map type is supported
  ...
  override(\simplexml_import_dom(1), map(["" => "$1"]));
    ...
    expectedArguments(\Imagick::setImageAlphaChannel(), 0, \Imagick::ALPHACHANNEL_ACTIVATE,\Imagick::ALPHACHANNEL_ASSOCIATE,\Imagick::ALPHACHANNEL_BACKGROUND,\Imagick::ALPHACHANNEL_COPY,\Imagick::ALPHACHANNEL_DEACTIVATE,\Imagick::ALPHACHANNEL_DISCRETE,\Imagick::ALPHACHANNEL_DISSOCIATE,\Imagick::ALPHACHANNEL_EXTRACT,\Imagick::ALPHACHANNEL_OFF,\Imagick::ALPHACHANNEL_ON,\Imagick::ALPHACHANNEL_OPAQUE,\Imagick::ALPHACHANNEL_REMOVE,\Imagick::ALPHACHANNEL_SET,\Imagick::ALPHACHANNEL_SHAPE,\Imagick::ALPHACHANNEL_TRANSPARENT,\Imagick::ALPHACHANNEL_UNDEFINED); //todo introduce byPrefix
    ...
    expectedArguments(\json_validate(), 2, JSON_INVALID_UTF8_IGNORE);
    ...
    expectedReturnValues(\PHP_VERSION, '5.3', '5.4', '5.5', '5.6', '7.0', '7.1', '7.2', '7.3', '7.4', '8.0', '8.1', '8.2', '8.3', '8.4', '8.5');
    expectedReturnValues(\PHP_VERSION_ID, 50300, 50400, 50500, 50600, 70000, 70100, 70200, 70300, 70400, 80000, 80100, 80200, 80300, 80400, 80500);
